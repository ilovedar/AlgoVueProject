...
const api = {
	...
	_init_frame:function(){
		...
		_event(this._rHandle, env.mouse.down, e => this._frDown(e, "mouse"));
		_event(this._lHandle, env.mouse.down, e => this._frDown(e, "mouse"));
		_event(this._frame, env.mouse.down, e => this._frDown(e, "mouse"));
		if (env.touch) {
			_event(this._rHandle, env.touch.down, e => this._frDown(e, "touch"));
			_event(this._lHandle, env.touch.down, e => this._frDown(e, "touch"));
			_event(this._frame, env.touch.down, e => this._frDown(e, "touch"));
		}
	...
	_frDown:function(e, pointer){
		...
		this._resizeHandlerMove = event(document.body, env[pointer].move, e => this._frMove(e, pointer), passive);
		this._resizeHandlerUp   = event(document, env[pointer].up, e => this._frUp(e, pointer));
	},
	_frClear:function(){
	...
	_frUp:function(e, pointer){
		...
		if(this._activeHandle){
			var pos_x = (pointer === "touch") ? e.changedTouches[0].pageX : getPos(e).x;
