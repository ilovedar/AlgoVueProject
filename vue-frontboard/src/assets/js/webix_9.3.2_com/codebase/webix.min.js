...
"onAfterColumnShow",function(t){this.Zw(t)}),this.attachEvent("onSyncScroll",this.Qw),this.tx=function(t,i,e,s){if(t.row&&i.row){if(e)return this.addSelectArea(t,i,!0),!(this.qw=!0);if(!this.callEvent("onAreaDrag",[t,i,s]))return!1;this.ix||!this.qw||this.N.multiselect&&s&&s.ctrlKey||(this.removeSelectArea(),this.qw=!1,this.Gw={})}},this.attachEvent("onBeforeAreaAdd",this.nx),Yt(this.nt,St.mouse.down,function(t){return i.hx(t,"mouse")}),St.touch&&Yt(this.nt,St.touch.down,function(t){return i.hx(t,"touch")})},Qw:function(t,i,e){ne.xs(this.ox,t,i,e),ne.xs(this.ax,0,i,e),ne.xs(this.ux,0,i,e)},cx:!0,Jw:function(t){var i=this.Yw;for(var e in i){var s=i[e];if(this.getColumnIndex(s.start.column)<0)if(s.start.column==s.end.column)this.removeSelectArea(s.name);else{var n=this.columnId(t);n&&this.vx(s.name,{row:s.start.row,column:n},null,!1,!0)}else if(this.getColumnIndex(s.end.column)<0){var r=this.columnId(t-1);r&&this.vx(s.name,null,{row:s.end.row,column:r},!1,!0)}}this.refreshSelectArea()},Zw:function(t){var i=this.Gw,e=this.Yw;for(var s in i){var n=i[s];n&&(e[n.name]&&e[n.name].start.column===n.start.column&&e[n.name].start.row===n.start.row&&e[n.name].end.column===n.end.column&&e[n.name].end.row===n.end.row&&delete i[s],e[n.name]||t!==n.start.column&&t!==n.end.column?(t===n.start.column&&this.vx(n.name,{row:n.start.row,column:t},null),t===n.end.column&&this.vx(n.name,null,{row:n.end.row,column:t})):this.addSelectArea({row:n.start.row,column:t},{row:n.end.row,column:t},!0,n.name))}for(var r in e){var h=e[r],o={start:h.start,end:h.end};this.nx(o),F.extend(h,o,!0)}},_x:function(t,i,e,s){var n,r,h,o,a,u,c,f;if(i){n=this.getColumnIndex(i.start.column),r=this.getColumnIndex(i.end.column),h=this.getIndexById(i.start.row),o=this.getIndexById(i.end.row),a=this.getColumnIndex(t.column),u=this.getIndexById(t.row),c=this.getIndexById(i.init.row),f=this.getColumnIndex(i.init.column),a<n||"left"==e?"left"===e&&s.ctrl?(n=this.bx(c,n,e),r=f):"left"===e&&f<r?r--:n=a:(r<=a||"right"==e)&&("right"==e&&s.ctrl?(r=this.bx(c,r,e),n=f):"right"==e&&n<f?n++:r=a),u<h||"up"==e?"up"==e&&s.ctrl?(h=this.bx(h,f,e),o=c):"up"==e&&c<o?o--:h=u:(o<u||"down"==e)&&("down"==e&&s.ctrl?(o=this.bx(o,f,e),h=c):"down"==e&&h<c?h++:o=u);var l={row:this.getIdByIndex(h),column:this.columnId(n)},d={row:this.getIdByIndex(o),column:this.columnId(r)};this.callEvent("onBeforeBlockSelect",[l,d,!0])&&(this.vx(i.name,l,d),this.callEvent("onSelectChange",[]),this.callEvent("onAfterBlockSelect",[l,d]))}},bx:function(t,i,e){var s=this.config.columns,n=this.data.order,r=this.data.pull[n[t]],h=s[i].id,o=0;if("right"==e)for(var a=i+1;a<s.length;a++){if(r[s[a].id]){o=a;break}o=a}else if("left"==e){for(var u=i-1;0<=u;u--)if(r[s[u].id]){o=u;break}}else if("down"==e)for(var c=t+1;c<n.length;c++){if(this.getItem(n[c])[h]){o=c;break}o=c}else if("up"==e)for(var f=t-1;0<=f;f--)if(this.getItem(n[f])[h]){o=f;break}return o},vx:function(t,i,e,s,n){var r=this.Yw[t];if(!r)return!1;var h=S(r),o={start:i||r.start,end:e||r.end};this.nx(o),F.extend(r,o,!0),n||this.refreshSelectArea(),this.Xw(h),s&&this.callEvent("onSelectChange",[])},areaselect_setter:function(t){return t&&(this.Uw(),this.Uw=function(){}),this.define("blockselect",t),t},addSelectArea:function(t,i,e,s,n,r){var h,o,a,u,c;h=this.getIndexById(t.row),o=this.getIndexById(i.row),a=this.getColumnIndex(t.column),o<h&&(c=h,h=o,o=c),(u=this.getColumnIndex(i.column))<a&&(c=a,a=u,u=c),s=s||this.ix||z(),this.ix=null;var f={start:{row:this.getIdByIndex(h),column:this.columnId(a)},end:{row:this.getIdByIndex(o),column:this.columnId(u)}};if(n&&(f.css=n),(r||!1===r)&&(f.handle=r),this.Yw[s])return this.vx(s,f.start,f.end,!0);f.handle=!0,f.name=s,f.init=f.start,this.callEvent("onBeforeAreaAdd",[f])&&(this.gx=s,e||(this.removeSelectArea(),this.Gw={}),this.Yw[f.name]=f,this.wx.push(f),this.refreshSelectArea(),this.Xw(),this.callEvent("onAfterAreaAdd",[f]),this.callEvent("onSelectChange",[]))},xx:function(){var t=st("DIV");return t.className="webix_area_selection_layer",t.style.top=this.yx+"px",t},refreshSelectArea:function(){var t,i,e,s,n=null,r=null,h=null,
o=this.N.prerender;if(this.Mx){t=this.Sx(o),i=this.kx(!0===o),this.ox||(this.ox=this.xx(),this.nt.childNodes[1].appendChild(this.ox),this.ax=this.xx(),this.nt.childNodes[0].appendChild(this.ax),this.ux=this.xx(),this.nt.childNodes[2].appendChild(this.ux)),this.ox.innerHTML="",this.ax.innerHTML="",this.ux.innerHTML="";var a=this.N.leftSplit,u=this.N.rightSplit;for(e in this.Yw){s=this.Yw[e];var c=this.Cx(s,t,i);if(null!==c){var f=this.getColumnIndex(s.start.column),l=this.getColumnIndex(s.end.column);if(c.r0<=c.r1){if(this.N.topSplit&&this.N.topSplit<=void 0&&void 0<this.$x)return!1;f<a&&(r=this.Dx(c.r0,f,c.r1,Math.min(l,a-1))),c.c0<=c.c1&&(n=this.Dx(c.r0,c.c0,c.r1,c.c1)),u&&l>=this.Ix&&(h=this.Dx(c.r0,Math.max(f,this.Ix),c.r1,l)),(r||n||h)&&this.Ax(r,n,h,e,s.css,s.handle)}}else this.removeSelectArea(e)}}},Cx:function(t,i,e){var s,n,r=this.getIndexById(t.start.row),h=this.getIndexById(t.end.row),o=this.getColumnIndex(t.start.column),a=this.getColumnIndex(t.end.column);if(-1===o||-1===a)return null;if(-1===r||-1===h)return null;if(n=Math.min(e[1],h),this.N.topSplit){if((s=r)>=this.N.topSplit&&(s=Math.max(e[0]-this.N.topSplit,r)),n>=this.N.topSplit){var u=this.ut(this.getIdByIndex(h),t.end.column),c=this.ut(this.getIdByIndex(this.N.topSplit-1),t.end.column);c.top+c.height>u.top+u.height&&(n=this.N.topSplit-1)}}else s=Math.max(e[0],this.getIndexById(t.start.row));return{r0:s,r1:n,c0:Math.max(i[0],o),c1:Math.min(this.Ix?i[1]-1:i[1],a)}},Dx:function(t,i,e,s){return[this.ut(this.getIdByIndex(t),this.columnId(i)),this.ut(this.getIdByIndex(e),this.columnId(s))]},Ax:function(t,i,e,d,v,s){var n,r,h=this.Yw[d],_=0;this.N.topSplit&&(_=this.Tx(h.start,!0));var o=function(t,i,e,s,n){var r,h,o,a,u,c,f={top:1,right:1,bottom:1,left:1};for(r in s&&delete f.left,n&&delete f.right,h=e.top-i.top+e.height-1,o=e.left-i.left+e.width,f){a=i.top+_,"bottom"==r&&(a=e.top+e.height),u=i.left,"right"==r&&(u=e.left+e.width),c="top"==r||"bottom"==r,t.appendChild(st("DIV",{"class":"webix_area_selection webix_area_selection_"+r+(v?" "+v:""),style:"left:"+u+"px;top:"+a+"px;"+(c?"width:"+o+"px;":"height:"+(h-_)+"px;"),webix_area_name:d},""));var l=t.lastChild;"right"==r&&(l.style.left=u-l.offsetWidth+"px"),"bottom"==r&&(l.style.top=a-l.offsetHeight+"px"),_&&("top"==r&&(l.style.display="none"),e.height==_&&"bottom"==r&&(l.style.display="none"))}};e&&o(this.ux,e[0],e[1],!!i,!1),i&&o(this.ox,i[0],i[1],!!t,!!e),t&&o(this.ax,t[0],t[1],!1,!!i),s&&(r=e?e[1]:i?i[1]:t[1],(n=e?this.ux:i?this.ox:this.ax).appendChild(st("DIV",{"class":"webix_area_selection_handle"+(v?" "+v:""),style:"left:"+(r.left+r.width)+"px;top:"+(r.top+r.height)+"px;",webix_area_name:d},"")),_&&r.height==_&&(n.lastChild.style.display="none"))},Fx:function(s){if(s){var t=function(t){for(var i=t.childNodes,e=i.length-1;0<=e;e--)i[e].getAttribute("webix_area_name")==s&&t.removeChild(i[e])};t(this.ox),t(this.ax),t(this.ux)}},removeSelectArea:function(t){if(t&&this.Yw[t]){if(this.callEvent("onBeforeAreaRemove",[t])){for(var i in this.Xw(S(this.Yw[t]),!0),delete this.Yw[t],this.Fx(t),this.wx=[],this.Yw)this.wx.push(this.Yw[i]);this.callEvent("onAfterAreaRemove",[t])}}else for(var e in this.Yw)this.removeSelectArea(e)},hx:function(t,i){var e=mt(t.target);if(e&&-1!=e.indexOf("webix_area_selection_handle")){var s=t.target.getAttribute("webix_area_name");this.ix=s;var n=this.Yw[s],r=this.ut(n.start.row,n.start.column),h=this.ut(n.end.row,n.end.column),o=this.N.prerender,a=this.getColumnIndex(n.start.column)<this.N.leftSplit?0:this.Vx,u=this.getColumnIndex(n.end.column)<this.N.leftSplit?0:this.Vx;this.zx=[r.left+1+a-this.yr,r.top+1-(o?this.wr:0),{row:n.start.row,column:n.start.column}],this.Bx=at(this.nt),this.Hx(t),this.Rx=[h.left+1+u-this.yr,h.top+1-(o?this.wr:0)],this.Ex(!1,!1,t),ft(t),this.Px(t.target,i)}},getSelectArea:function(t){return this.Yw[t||this.gx]},getAllSelectAreas:function(){return this.Yw},nx:function(t,i){var e,s,n,r,h,o,a,u,c=t.start,f=t.end;e=h=this.jx(c.row),n=a=this.Nx(c.column),s=o=this.jx(f.row),r=u=this.Nx(f.column);var l=i||[{},{}];if(!i)for(var d=e;d<=s;d++){if(this.getItem(
this.Lx(d)).$row)return t.start.column=this.columnId(0),t.end.column=this.columnId(this.ll.length-1),this.nx(t,l)}if(this.config.spans){var v=this.getSpan();for(var _ in v)for(var p in v[_]){var b=l[0][_]=l[0][_]||0===l[0][_]?l[0][_]:this.jx(_),m=l[1][p]=l[1][p]||0===l[1][p]?l[1][p]:this.Nx(p),g=v[_][p];0<=b&&0<=m&&!(o<b||b+g[1]-1<h||m+g[0]-1<a||u<m)&&(h=Math.min(h,b),o=Math.max(o,b+g[1]-1),a=Math.min(a,m),u=Math.max(u,m+g[0]-1))}e!=h||n!=a||s!=o||r!=u?(t.start={row:this.Lx(h),column:this.Ox(a)},t.end={row:this.Lx(o),column:this.Ox(u)},this.nx(t,l)):this.Wx([e,s],[n,r],t)}},Xw:function(t,i){var e;if(t&&(e=this.getItemNode({row:t.start.row,column:t.start.column}))&&e.removeAttribute("tabindex"),!i&&this.wx.length){var s=this.getSelectedId(!0)[0];(e=this.getItemNode(s))&&e.setAttribute("tabindex","1")}},Lx:function(t){return this.data.zh?this.data.zh[t]:this.data.order[t]},jx:function(t){return(this.data.zh||this.data.order).find(t)},Wx:function(t,i,e){if(this.Co.length){for(var s=i[0],n=i[1];this.getColumnConfig(this.Co[s]).hidden&&s<n;)s++;for(;this.getColumnConfig(this.Co[n]).hidden&&s<n;)n--;s!=i[0]&&(e.start.column=this.Ox(s)),n!=i[1]&&(e.end.column=this.Ox(n))}if(this.data.zh){for(var r=t[0],h=t[1];this.data.order.find(this.data.zh[r])<0;)r++;for(;this.data.order.find(this.data.zh[h])<0;)h--;r!=t[0]&&(e.start.row=this.data.zh[r]),h!=t[1]&&(e.end.row=this.data.zh[h])}}}),gh={filterByAll:function(){var t=this,o=!1;this.data.silent(function(){var r=this;this.filter();var h=!1,t=function(e){if(!r.isColumnVisible(e))return"continue";var t=r.Io[e],i=t[2].getValue(t[0]),s=i;t[1].prepare&&(s=t[1].prepare.call(t[2],s,t[1],r)),t[1].value=i;var n=t[1].compare;if(!r.callEvent("onBeforeFilter",[e,s,t[1]]))return"continue";if(t[2].$server||o)o=!0;else{if(""===s)return"continue";n?(n=r.Ux(e,n),r.filter(k(function(t,i){return!!t&&n(t[e],i,t)},r),s,h)):r.filter(e,s,h),h=!0}};for(var i in this.Io)t(i)},this),o?this.Bo?this.Bo.filter=!0:this.loadNext(0,0,0,0,!0,!0).then(function(){return t.Po()}):(this.refresh(),this.callEvent("onAfterFilter",[]))},Ux:function(t,r){var i=this.getColumnConfig(t),h=i?i.optionslist:null;return h?("string"!=typeof h&&(h=","),function(t,i,e){if(!t)return!1;for(var s=t.toString().split(h),n=0;n<s.length;n++)if(r(s[n],i,e))return!0}):r},filterMode_setter:function(t){return F.extend(this.data.ao,t,!0)},getFilter:function(t){var i=this.Io[t];return i&&i[2].qd?i[2].qd(i[0]):i&&i[2].getInputNode?i[2].getInputNode(i[0]):null},registerFilter:function(t,i,e){this.Io[i.columnId]=[t,i,e]},collectValues:function(t,i){var e=this.getColumnConfig(t),s=i&&i.visible?null:e.collection,n={values:s?this.Bl.call(s,"id","value"):this.Bl(e.id,e.id)};return this.callEvent("onCollectValues",[t,n]),n.values},Bl:function(e,s){var n={"":!0},r=[];if(this.data.each(function(t){var i=t?t[e]:"";0===i&&(i="0"),"object"==M(i)&&(i=String(i)),i===undefined||n[i]||(n[i]=!0,r.push({id:i,value:t[s]}))},this,!0),r.length){var t="string"==typeof r[0].value?"string":"raw";r.sort(this.data.sorting.create({as:t,by:"value",dir:"asc"}))}return r},Po:function(){this.editStop&&this.editStop(),this.callEvent("onAfterFilter",[])}},wh={hover_setter:function(t){var s=this;return t&&!this.qx&&(this.Ju(),this.config.experimental=!0,this.attachEvent("onMouseMoving",function(t){if(re.active)s.Yx&&(s.Yx=s.removeRowCss(s.Yx,s.N.hover));else{var i=s.locate(t);!i&&St.isEdge&&t.relatedTarget&&(i=s.locate(t.relatedTarget));var e=i?i.row:null;s.Yx!=e&&(s.Yx&&s.removeRowCss(s.Yx,s.N.hover),s.Yx=e,s.Yx&&s.addRowCss(s.Yx,s.N.hover))}}),Yt(this.$view,"mouseout",function(t){var i=t.target;s.Yx&&document.body.contains(i)&&((t.relatedTarget?s.locate(t.relatedTarget):null)||(s.removeRowCss(s.Yx,s.N.hover),s.Yx=null))}),this.qx=1),t},select_setter:function(t){return!this.select&&t&&(F.extend(this,this.Xx.Gx,!0),!0===t?t="row":"multiselect"==t&&(t="row",this.N.multiselect=!0),this.Xx[t],F.extend(this,this.Xx[t],!0)),t},getSelectedId:function(t){return t?[]:""},getSelectedItem:function(t){return Je.getSelectedItem.call(this,t)},Xx:{Gx:{Kx:" webix_cell_select",$init:function(){
this.Jx(),this.on_click.webix_cell=k(this.Zx,this),this.Qx=this.Bc=function(){this.unselect()},this.data.attachEvent("onStoreUpdated",k(this.Vc,this)),this.data.attachEvent("onSyncApply",k(this.ty,this)),this.data.attachEvent("onClearAll",k(this.Qx,this)),this.data.attachEvent("onAfterFilter",k(this.Bc,this)),this.data.attachEvent("onIdChange",k(this.Rc,this)),this.$ready.push(Je.Ec)},Rc:function(t,i){for(var e=0;e<this.iy.length;e++)this.iy[e]==t&&(this.iy[e]=i);for(var s=0;s<this.wx.length;s++){var n=this.wx[s];n.row==t&&(t=this.ey(n),n.row=i,i=this.ey(n),n.id=i,delete this.ny[t],this.ny[i]=!0)}},Vc:function(t,i,e){"delete"==e&&this.unselect(t)},ty:function(){for(var t=this.wx.length-1;0<=t;t--){var i=this.wx[t].row;this.exists(i)||(this.wx.splice(t,1),delete this.ny[i])}},Jx:function(){this.wx=[],this.ny={},this.iy=[]},isSelected:function(t,i){var e;return e=V(i)?"object"===M(t)?this.ey(t):t:this.ey({row:t,column:i}),this.ny[e]},getSelectedId:function(t,i){var e;if(1<this.wx.length||t){if(e=[].concat(this.wx),i)for(var s=0;s<e.length;s++)e[s]=e[s].id}else if(e=this.wx[0],i&&e)return e.id;return e},hy:function(){return this.row},jo:function(t,i){var e=this.ey(t);if(null!==e){if(-1===i)return this.oy(t);if(t.id=e,t.toString=this.hy,!this.callEvent("onBeforeSelect",[t,i]))return!1;if(!this.ny[e]||!i&&1!=this.wx.length)return i||this.ay(),this.wx.push(t),this.ny[e]=!0,this.callEvent("onAfterSelect",[t,i]),this.uy(this.cy(t)),!0}},ay:function(){if(!this.wx.length)return!1;for(var t=0;t<this.wx.length;t++)if(!this.callEvent("onBeforeUnSelect",[this.wx[t]]))return!1;for(var i=0;i<this.iy.length;i++)this.data.removeMark(this.iy[i],"webix_selected",0,!0);var e=this.N.columns;if(e)for(var s=0;s<e.length;s++)e[s].$selected=null;var n=this.wx;this.Jx();for(var r=0;r<n.length;r++)this.callEvent("onAfterUnSelect",[n[r]]);return!0},unselectAll:function(){this.clearSelection()},selectAll:function(){this.selectRange()},clearSelection:function(){this.ay()&&(this.callEvent("onSelectChange",[]),this.render())},oy:function(t){var i=this.ey(t);if(!i&&this.wx.length&&(this.clearSelection(),this.callEvent("onSelectChange",[])),this.ny[i]){if(!this.callEvent("onBeforeUnSelect",[t]))return!1;for(var e=0;e<this.wx.length;e++)if(this.wx[e].id==i){this.wx.splice(e,1);break}delete this.ny[i],this.callEvent("onAfterUnSelect",[t]),this.uy(0,this.fy(t))}},ly:function(t){var i=this.getItem(t);return this.data.addMark(i.id,"webix_selected",0,{$count:0},!0)},uy:function(t){t&&this.iy.push(t),this.jc||(this.render(),this.callEvent("onSelectChange",[]))},Zx:function(t,i){var e=t.ctrlKey||t.metaKey||"touch"==this.N.multiselect,s=t.shiftKey;if(this.N.multiselect||"multiselect"==this.N.select||"area"==this.N.select||(e=s=!1),s&&this.wx.length){var n=this.wx[this.wx.length-1];this.vy(i,n)}else e&&this.ny[this.ey(i)]?this.oy(i):this.jo({row:i.row,column:i.column},e)},_y:function(t,i,e){var s=this.N.columns;if(i){for(var n=[],r=0;r<s.length;r++)s[r].$selected&&n.push(s[r]);s=n}for(var h=this.data.order,o=0,a=0;a<h.length;a++){var u=this.getItem(h[a]);if(u){var c=this.data.getMark(u.id,"webix_selected");if(c||i){for(var f=0,l=0;l<s.length;l++){var d=s[l].id;if(e||i||c[d]){if(!t)return{row:h[a],column:d};u[d]=t(u[d],h[a],d,o,f),f++}}o++}}}}},row:{Kx:" webix_row_select",ey:function(t){return t.row},select:function(t,i){t&&(t=t.toString()),this.data.exists(t),this.jo({row:t},i)},cy:function(t){return this.ly(t.row).$row=!0,t.row},unselect:function(t){this.oy({row:t})},fy:function(t){return this.data.removeMark(t.row,"webix_selected",0,!0),t.row},mapSelection:function(t){return this._y(t,!1,!0)},vy:function(t,i){return this.selectRange(t.row,i.row)},selectRange:function(t,i,e){V(e)&&(e=!0);var s=t?this.getIndexById(t):0,n=i?this.getIndexById(i):this.data.order.length-1;if(n<s){var r=s;s=n,n=r}this.jc=!0;for(var h=s;h<=n;h++){var o=this.getIdByIndex(h);if(!o){t&&this.select(t);break}this.select(o,e)}this.jc=!1,this.uy()}},cell:{ey:function(t){return t.column?t.row+"_"+t.column:null},select:function(t,i,e){this.data.exists(t),this.jo({row:t,column:i},e)},cy:function(t
){var i=this.ly(t.row);return i.$count++,i[t.column]=!0,t.row},unselect:function(t,i){this.oy({row:t,column:i})},fy:function(t){var i=this.ly(t.row);return i.$count--,i[t.column]=!1,i.$count<=0&&this.data.removeMark(t.row,"webix_selected",0,!0),t.row},mapSelection:function(t){return this._y(t,!1,!1)},vy:function(t,i){return this.selectRange(t.row,t.column,i.row,i.column)},selectRange:function(t,i,e,s,n){V(n)&&(n=!0);var r=t?this.getIndexById(t):0,h=e?this.getIndexById(e):this.data.order.length-1,o=i?this.getColumnIndex(i):0,a=s?this.getColumnIndex(s):this.ll.length-1;if(h<r){var u=r;r=h,h=u}if(a<o){var c=o;o=a,a=c}this.jc=!0;for(var f=r;f<=h;f++)for(var l=o;l<=a;l++)this.select(this.getIdByIndex(f),this.columnId(l),n);this.jc=!1,this.uy()}},column:{Kx:" webix_column_select",ey:function(t){return t.column},hy:function(){return this.column},select:function(t,i){this.jo({column:t},i)},cy:function(t){this.N.columns[this.getColumnIndex(t.column)].$selected=!0,this.jc||this.gy()},unselect:function(t){this.oy({column:t})},fy:function(t){this.N.columns[this.getColumnIndex(t.column)].$selected=null,this.gy()},mapSelection:function(t){return this._y(t,!0,!1)},vy:function(t,i){return this.selectRange(t.column,i.column)},selectRange:function(t,i,e){V(e)&&(e=!0);var s=t?this.getColumnIndex(t):0,n=i?this.getColumnIndex(i):this.ll.length-1;if(n<s){var r=s;s=n,n=r}this.jc=!0;for(var h=s;h<=n;h++)this.select(this.columnId(h),e);this.jc=!1,this.gy(),this.uy()},ty:function(){}},area:{ey:function(t){return t.row+"_"+t.column},getSelectedId:function(t){var i=this.getSelectArea(),e=[];if(i)if(!t||i.start.row==i.end.row&&i.start.column==i.end.column)e.push(i.end);else{var s=this.getIndexById(i.start.row),n=this.getIndexById(i.end.row);if(-1==s||-1==n)return e;for(var r=this.getColumnIndex(i.start.column),h=this.getColumnIndex(i.end.column),o=s;o<=n;o++)for(var a=r;a<=h;a++)e.push({row:this.getIdByIndex(o),column:this.columnId(a)})}return t?e:e[0]},unselect:function(){this.oy()},oy:function(){this.removeSelectArea(),this.callEvent("onSelectChange",[])},mapSelection:function(t){var i=this.getSelectArea();if(i)for(var e=this.getColumnIndex(i.start.column),s=this.getColumnIndex(i.end.column),n=this.getIndexById(i.start.row),r=this.getIndexById(i.end.row),h=n;h<=r;h++)for(var o=this.data.order[h],a=this.getItem(o),u=e;u<=s;u++){var c=this.ll[u].id;if(!t)return{row:o,column:c};a[c]=t(a[c],o,c,h-n,u-e)}},select:function(t,i,e){this.data.exists(t),this.jo({row:t,column:i},e)},vy:function(t,i){this._x(t,i)},jo:function(t){return this.addSelectArea(t,t,!1),!0},ty:function(){this.wx.length&&this.refreshSelectArea()}}}},xh={blockselect_setter:function(t){var i=this;return t&&this.cx&&(Yt(this.zt,St.mouse.down,function(t){return i.wy(t,"mouse")}),St.touch&&this.attachEvent("onLongTouch",function(t){return i.wy(t,"touch")}),this.cx=this.zx=this.Rx=!1,this.attachEvent("onAfterScroll",this.xy),F.extend(this,Wt,!0),this.attachEvent("onBeforeAutoScroll",function(){return this.Rx})),t},cx:!0,yy:function(t,i){for(var e=t.target;e;){if(e.getAttribute&&e.getAttribute("webixignore"))return!1;if(e==i)return!0;e=e.parentNode}return!1},wy:function(t,i){if((!this.N.subview||this==si(t.target))&&this.yy(t,this.nt)){if(t.target&&"INPUT"==t.target.tagName||this.Vv)return;this.Bx=at(this.nt);var e=ct(t);this.zx=[e.x-this.Bx.x,e.y-this.Bx.y],this.Px(t.target,i)}},Px:function(t,i){var e=this;this.My="touch"===i?(this.Sy=Gt(t,St[i].move,function(t){return e.ky(t,i)},{passive:!1}),Gt(t,St[i].up,function(t){return e.Cy(t)})):(this.Sy=Gt(this.zt,St[i].move,function(t){return e.ky(t,i)}),Gt(document,St[i].up,function(t){return e.Cy(t)}))},Cy:function(t){this.$y&&(this.Ex("select",!0,t),this.$y=rt(this.$y)),this.Sy=Xt(this.Sy),this.My=Xt(this.My),_t(document.body,"webix_noselect"),this.zx=this.Rx=!1,this.ot&&(this.ot=window.clearTimeout(this.ot))},xy:function(){this.Rx&&C(this.Ex,this,[!1,!1])},Ex:function(t,i,e){var s;this.zx[2]||(this.zx[2]=this.Dy.apply(this,this.zx)),s=this.zx[2];var n=this.Dy.apply(this,this.Rx);if(this.callEvent("onBeforeBlockSelect",[s,n,i,e])){if((
!this.tx||!1!==this.tx(s,n,i,e))&&s.row&&n.row)if("select"===t)this.ay(),this.vy(s,n);else{var r,h,o,a;if("box"===t)r=Math.min(this.zx[0],this.Rx[0]),o=Math.max(this.zx[0],this.Rx[0]),h=Math.min(this.zx[1],this.Rx[1]),a=Math.max(this.zx[1],this.Rx[1]);else{var u=this.ut(s.row,s.column),c=this.ut(n.row,n.column),f=this.getScrollState(),l=u.width,d=c.width;this.Iy&&this.zx[0]>this.Vx+this.Ay?u.left+=this.Vx+this.Ay:this.Vx?this.zx[0]>this.Vx&&(u.left<f.x?(l-=f.x-u.left,u.left=this.Vx):u.left+=this.Vx-f.x):u.left-=f.x,this.Iy&&this.Rx[0]>this.Vx+this.Ay?c.left+=this.Vx+this.Ay:this.Vx?this.Rx[0]>this.Vx&&(c.left<f.x?(d-=f.x-c.left,c.left=this.Vx):c.left+=this.Vx-f.x):c.left-=f.x,this.N.prerender&&(u.top-=this.wr,c.top-=this.wr),r=Math.min(u.left,c.left),o=Math.max(u.left+l,c.left+d),h=Math.min(u.top,c.top),a=Math.max(u.top+u.height,c.top+c.height),this.N.topSplit&&(h+=this.Tx(s)),this.ot&&(this.ot=window.clearTimeout(this.ot)),!e||this.Wo&&!this.N.prerender||(this.ot=C(this.st,this,[ct(e)],250))}var v=this.$y.style;v.left=r+"px",v.top=h+"px",v.width=o-r+"px",v.height=a-h+"px"}i&&this.callEvent("onAfterBlockSelect",[s,n])}},Hx:function(){this.$y=st("div",{"class":"webix_block_selection"},""),this.nt.appendChild(this.$y)},ky:function(t,i){if(!this.Rv&&!1!==this.zx){this.Rx||vt(document.body,"webix_noselect");var e=ct(t),s=[e.x-this.Bx.x,e.y-this.Bx.y];if(Math.abs(this.zx[0]-s[0])<5&&Math.abs(this.zx[1]-s[1])<5)return;!1===this.Rx&&this.Hx(t),this.Rx=s,this.Ex(this.config.blockselect,!1,t),"touch"===i&&ft(t)}},Dy:function(t,i){var e=!1,s=null,n=null;if(this.Iy&&t>this.Vx+this.Ay?t+=this.xr.getSize()-this.Ay-this.Vx-this.Iy:(!this.Vx||t>this.Vx)&&(t+=this.xr.getScroll()),this.N.topSplit&&this.$x>this.N.topSplit){var r=this.ut(this.getIdByIndex(this.N.topSplit-1),this.columnId(0));r.top+r.height>i&&(e=!0)}e||(i+=this.getScrollState().y),t<0&&(t=0),i<0&&(i=0);for(var h=this.N.columns,o=this.data.order,a=0,u=0;u<h.length;u++)if(t<=(a+=h[u].width)){n=h[u].id;break}n||(n=h[h.length-1].id),a=0;var c=this.data.$min||0;if(this.N.fixedRowHeight)s=o[c+Math.floor(i/this.N.rowHeight)];else for(var f=c;f<o.length;f++)if(i<=(a+=this.Ty(f))){s=o[f];break}return s||(s=o[o.length-1]),{row:s,column:n}},Tx:function(t,i){var e=0,s=this.getIndexById(t.row);if(s>=this.N.topSplit){var n=this.ut(this.getIdByIndex(s),t.column),r=this.ut(this.getIdByIndex(this.N.topSplit-1),t.column);r.top+r.height>n.top&&(e=r.top+r.height-(0<n.top||!i?n.top:0))}return e}},yh={resizeRow_setter:function(t){return this.N.scrollAlignY=!1,this.N.fixedRowHeight=!1,this.resizeColumn_setter(t)},resizeColumn_setter:function(t){var i=this;return t&&this.Fy&&(Yt(this.zt,"mousemove",function(t){return i.Vy(t)}),Yt(this.zt,"mousedown",function(t){return i.zy(t)}),Yt(this.zt,"mouseup",function(){return i.By()}),this.Fy=!1),t},Fy:!0,zy:function(t){!this.Hy||this.N.subview&&this!=si(t.target)||(this.Vv=[ct(t),this.Hy],vt(document.body,"webix_noselect"),J())},By:function(){this.Vv=!1,_t(document.body,"webix_noselect"),Z()},Ry:function(){var i=this;if(!this.Rv){var t,e=a(this.Vv[1],4),s=e[0],n=e[1],r=e[2],h=e[3],o=this.Vv[0];o="x"==s?(t=at(r).x+n-at(this.nt).x,o.x):(t=at(r).y+n-at(this.nt).y+this.ha,o.y),this.Rv=[s,h,t],new Qt.resizearea({container:this.zt,eventPos:o,start:t,dir:s,cursor:("x"==s?"col":"row")+"-resize"}).attachEvent("onResizeEnd",function(t){return i.Ey(t)}),this.Hy=!1}},Ey:function(t){if(this.Rv){var i=this.Rv[1],e=t-this.Rv[2];if("x"==this.Rv[0]){this.N.rightSplit&&i.cind>=this.Ix&&(e*=-1);var s=this.ll[i.cind],n=s.width;delete s.fillspace,delete s.adjust,this.Vo(i.cind,n+e,!0,!0),this.zo()}else{var r=this.getIdByIndex(i.rind),h=this.Py(this.getItem(r));this.setRowHeight(r,h+e)}this.By()}this.Rv=null},Vy:function(t){if(this.Hy&&this.Vv)return this.Ry();var i=this.Hy=!1,e=t.target,s=this.N,n=e.getAttribute("class")||"",r=-1!=n.indexOf("webix_cell");if(r&&s.drag)return this.jy(i);var h=-1!=n.indexOf("webix_hcell");if(r||h){var o=ut(t),a=this.Bs(e);i=this.Ny(a,o,e,s.resizeColumn,r)||r&&this.Ly(a,o,e,s.resizeRow)}this.jy(i)},Ny:function(t,i,e,s,n){if(!s||n&&s.headerOnly
)return!1;var r,h,o=e.offsetWidth;return s=s.size?s.size:3,i.x<s?(t.cind<this.Ix&&(t.cind-=t.span||1),r=this.ll[t.cind],h=["x",0,e,t]):o-i.x<s+1&&(this.N.rightSplit&&t.cind+1>=this.Ix&&t.cind++,(!this.N.rightSplit||t.cind<this.ll.length)&&(r=this.ll[t.cind],h=["x",o,e,t])),!(!r||!1===r.resize)&&(this.Hy=h,"col-resize")},Ly:function(t,i,e,s){if(!s||s.headerOnly&&0<t.cind)return!1;if(this.Rx)return!1;var n=e.offsetHeight;return s=s.size?s.size:3,i.y<s?0<t.rind&&(t.rind--,this.Hy=["y",0,e,t]):n-i.y<s+1&&(this.Hy=["y",n,e,t]),!!this.Hy&&"row-resize"},jy:function(t){this.Oy&&window.clearTimeout(this.Oy),this.Oy=C(this.Wy,this,[t],t?100:0)},Wy:function(t){this.Uy!=t&&(this.Uy=t,this.zt.style.cursor=t||"")}};w("onDataTable",function(t,i){St.touch&&(ne.$init(),i.scrollSize=0,ne.Te&&ne.limit(),t.$ready.push(t.$touch))});var Mh={$touch:function(){var t=this.N;t.scrollAlignY=!1,F.extend(this,!0===t.prerender?this.qy:this.Yy);var i="";t.autowidth||!1===t.scrollX||(i+="x"),t.autoheight||!1===t.scrollY||(i+="y"),this.nt.setAttribute("touch_scroll",i),ne.Vs(this.nt.childNodes[1].firstChild),this.Ms(0,0,"0ms")},$hasYScroll:function(){return 2<this.Gy-this.Xy},qy:{Wo:!0,Ky:function(t,i){var e=ne.Ps(this.nt.childNodes[1].firstChild);t=Math.max(0,Math.min(t,e.dx-e.px)),i=Math.max(0,Math.min(i,e.dy-e.py)),this.callEvent("onAfterScroll",[{e:-t,f:-i}])},Jy:function(){var t=ne.ms(this.nt.childNodes[1].firstChild);return{x:-t.e,y:-t.f}},$init:function(){this.attachEvent("onBeforeScroll",function(){ne.ss=this.nt.childNodes[1].firstChild,ne.ns=ne.Ps(ne.ss),ne.ys=this}),this.attachEvent("onTouchEnd",function(){ne.ys=null}),this.attachEvent("onAfterScroll",function(t){t&&(this.yr=-t.e,this.wr=-t.f,this.Ms(t.e,t.f,"0ms"))})}},Yy:{Wo:!0,Ky:function(t,i){C(function(){this.callEvent("onAfterScroll",[{e:-t,f:-i}])},this)},$scroll:{gravity:0,elastic:!1},$init:function(){this.attachEvent("onAfterColumnHide",function(){this.Ky(0,0)}),this.attachEvent("onAfterRender",function(){this.xr&&this.N.scrollX&&this.xr.Pw(),this.gr&&this.N.scrollY&&this.gr.Pw()}),this.attachEvent("onBeforeScroll",function(){ne.ss=this.nt.childNodes[1].firstChild,ne.ns=ne.Ps(ne.ss),ne.ns.dy=this.Gy,ne.ys=this}),this.attachEvent("onTouchEnd",function(){ne.ys=null}),this.attachEvent("onAfterScroll",function(t){t&&(this.wr=0,this.yr=0,this.Ms(0,0,"0ms"),this.yr=-t.e,this.wr=-t.f,this.Zy(),this.render(),this.xr&&(this.xr.N.scrollPos=-1,this.xr.scrollTo(this.yr),this.callEvent("onScrollY",[])),this.gr&&(this.gr.N.scrollPos=-1,this.gr.scrollTo(this.wr),this.callEvent("onScrollY",[])))})}},Ms:function(t,i,e){var s=this.N.prerender?0:this.wr;i+=s,ne.xs(this.nt.childNodes[1].firstChild,t,i,e),this.N.leftSplit&&ne.xs(this.nt.childNodes[0].firstChild,0,i,e),this.N.rightSplit&&ne.xs(this.nt.childNodes[2].firstChild,0,i,e),this.N.header&&ne.xs(this.k.childNodes[1].firstChild,t,0,e),this.N.footer&&ne.xs(this.Qy.childNodes[1].firstChild,t,0,e);var n="0ms"!==e;this.xr&&this.xr.$(-t,n),this.gr&&this.gr.$(-i+s,n),this.callEvent("onSyncScroll",[t,i,e])},tM:function(t,i){var e=-this.getScrollState().x;ne.xs(this.nt.childNodes[1].firstChild,e,t,i),this.N.leftSplit&&ne.xs(this.nt.childNodes[0].firstChild,0,t,i),this.N.rightSplit&&ne.xs(this.nt.childNodes[2].firstChild,0,t,i),this.callEvent("onSyncScroll",[e,t,i])},iM:function(t,i){var e=this.N.prerender?-this.getScrollState().y:0;ne.xs(this.nt.childNodes[1].firstChild,t,e,i),this.N.header&&ne.xs(this.k.childNodes[1].firstChild,t,0,i),this.N.footer&&ne.xs(this.Qy.childNodes[1].firstChild,t,0,i),this.callEvent("onSyncScroll",[t,e,i])},Fs:function(t){this.N.prerender||(t.f-=this.wr)}},Sh={$init:function(){this.data.attachEvent("onStoreUpdated",k(function(t){t||this.eM()},this)),this.attachEvent("onStructureLoad",this.eM),this.attachEvent("onStructureUpdate",this.sM),this.attachEvent("onColumnResize",function(t,i,e,s){s&&this.sM()}),this.attachEvent("onResize",this.sM)},eM:function(){for(var t=!1,i=this.ll,e=0;e<i.length;e++)i[e].adjust&&("header"==i[e].adjust||this.count())&&(t=this.nM(e,i[e].adjust,!0)||t);t&&(this.zo(!0),this.sM())},sM:function(){
var t=this.N.columns,i=[],e=0;if(t&&!this.N.autowidth)for(var s=0;s<t.length;s++){var n=t[s].fillspace;n&&(e+=1*(i[s]=n)||1)}e&&this.rM(i,e)},rM:function(t,i){var e=this.N.columns;if(e){var s=this.xe-this.hM,n=!1;if(0<s){for(var r=0;r<e.length;r++)t[r]||(s-=e[r].width||this.N.columnWidth);for(var h=0;h<t.length;h++)if(t[h]){var o=Math.min(s,Math.round(s*t[h]/i));n=this.Vo(h,o,!0)||n,s-=e[h].width,i-=t[h]}n&&this.zo(!0)}}},oM:function(t,i){var e=this.N.columns[t],s=e.minWidth||this.N.minColumnWidth;if("header"!=i){var n=this.data.order.length;e.adjustBatch&&e.adjustBatch<n&&(n=e.adjustBatch);for(var r=this.data.order.slice(0,n),h=0;h<n;h++)r[h]=r[h]?this.aM(this.getItem(r[h]),e,0):"";s=Math.max(s,pt(r,"webix_table_cell webix_cell").width)}if("data"!=i){for(var o=0;o<e.header.length;o++){var a=e.header[o];if(a){var u=0;if(a.rotate)for(var c=0;c<(a.rowspan||1);c++)u+=this.dl[c];var f="webix_table_cell webix_cell "+(a.css||"")+(a.rotate?"webix_measure_rotate":""),l=pt([a.text],f,u);s=Math.max(s,a.rotate?l.height:l.width)}}e.sort&&(s+=10)}return s+=St.isIE?te.layoutPadding.space:0,Math.min(s,e.maxWidth||this.N.maxColumnWidth||1e5)},nM:function(t,i,e){if(0<=t){var s=this.oM(t,i);return this.Vo(t,s,e)}},adjustColumn:function(t,i){this.nM(this.getColumnIndex(t),i)},adjustRowHeight:function(t,i){if(t)this.uM(t);else{for(var e={},s=this.N.columns,n=0;n<s.length;n++)this.uM(s[n].id,e);this.data.each(function(t){t.$height=e[t.id]})}i||this.refresh()},uM:function(t,e){var i,s=this.getColumnConfig(t),n=st("DIV",{"class":"webix_table_cell webix_measure_size webix_cell"},"");n.style.cssText="width:"+s.width+"px; height:1px; visibility:hidden; position:absolute; top:0px; left:0px; overflow:hidden;",this.$view.appendChild(n),n.offsetHeight<1&&(i=this.$view.cloneNode(!0),document.body.appendChild(i),i.appendChild(n)),this.data.each(function(t){var i;n.innerHTML=this.aM(t,s,0),i=Math.max(n.scrollHeight,this.N.rowHeight,this.N.minRowHeight||0),i=Math.min(i,this.N.maxRowHeight||1e5),e?e[t.id]=Math.max(i,e[t.id]||0):t.$height=i},this),n=rt(n),i&&rt(i)}},kh={math_setter:function(t){return t&&this.cM(),t},fM:"$",cM:function(){St.strict||(this.data.attachEvent("onStoreUpdated",k(this.lM,this)),this.data.attachEvent("onStoreLoad",k(this.dM,this)),this.attachEvent("onStructureLoad",this.dM))},lM:function(t,i,e){if(t&&"paint"!=e)if("delete"==e)for(var s=0;s<this.ll.length;s++)this.vM(i,this.ll[s].id);else{"add"==e&&this._M(i);for(var n=0;n<this.ll.length;n++)this.pM={},this.bM(t,this.ll[n].id);this.pM={}}},bM:function(t,i){var e,s=this.getItem(t);if((e=s[this.fM+i]||s[i])&&0<e.length&&"="===e.toString().substr(0,1)?(s[this.fM+i]=e,s[i]=this.mM(e,t,i)):("undefined"!=typeof s[this.fM+i]&&delete s[this.fM+i],this.vM(s,i)),"undefined"!=typeof s.depends&&"undefined"!=typeof s.depends[i])for(var n in s.depends[i]){var r=s.depends[i][n][0]+"__"+s.depends[i][n][1];"undefined"==typeof this.pM[r]&&(this.pM[r]=!0,this.bM(s.depends[i][n][0],s.depends[i][n][1]))}},gM:function(t,i){var e=this.getItem(t);"undefined"!=typeof e[this.fM+i]&&(e[i]=e[this.fM+i])},dM:function(){if(this.ll&&this.count()){this._M();for(var t=0;t<this.ll.length;t++){var i=this.columnId(t);this.data.each(function(t){this.pM={},this.bM(t.id,i)},this)}this.pM={}}},_M:function(t){for(var i=0;i<this.ll.length;i++)if(this.ll[i].math){var e=this.columnId(i),s="="+this.ll[i].math;s=s.replace(/\$c/g,"#$c#"),t?(t[e]=this.wM(s,t.id,e),delete t[this.fM+e],this.vM(t,e)):this.data.each(function(t){t[e]=this.wM(s,t.id,e),delete t[this.fM+e],this.vM(t,e)},this)}},wM:function(t,i,e){return Lt(t)({$r:i,$c:e})},xM:function(t,i){var e;if(!this.exists(t))return"#out_of_range";var s=(e=this.getItem(t))[this.fM+i]||e[i]||0;return"="!==(s=s.toString()).substring(0,1)?s:("undefined"==typeof e[this.fM+i]&&(e[this.fM+i]=e[i]),e[i]=this.mM(s,t,i,!0),e[i])},mM:function(t,i,e,s){if(!0===s){if(this.yM(i,e))return"#selfreference"}else this.MM();this.SM(i,e);var n=this.getItem(i);t=t.substring(1);var r=this.kM(t),h=this.CM(t,i);t=r?(t=this.$M(t,h),this.DM(t,r)):this.$M(t,h,!0);var o=this.IM(t);if(!1!==o)return o;this.AM(i
,e),this.vM(n,e);for(var a=0;a<h.length;a++)this.TM([i,e],h[a]);return!1!==(o=this.IM(t))?o:t?(t=this.FM(t.replace(/\$r/g,n.id)),!1!==(o=this.IM(t))?o:t):t},kM:function(t){return t.replace(/\[[^)]*?\]/g,"").match(/(\+|-|\*|\/)/g)},CM:function(t,i){var e=t.match(/\[([^\]]+),([^\]]+)\]/g);null===e&&(e=[]);for(var s=0;s<e.length;s++){var n=e[s],r=n;(n=(n=n.substr(1,n.length-2)).split(","))[0]=this.VM(n[0]),n[1]=this.VM(n[1]),":"===n[0].substr(0,1)&&(n[0]=this.getIdByIndex(n[0].substr(1))),"$r"===n[0]&&(n[0]=i),":"===n[1].substr(0,1)&&(n[1]=this.columnId(n[1].substr(1))),n[2]=r,e[s]=n}return e},$M:function(t,i,e){var s="(",n=")";e&&(s=n="");for(var r=0;r<i.length;r++){var h=i[r],o=this.xM(h[0],h[1]);isNaN(o)&&(o='"'+o+'"'),t=t.replace(h[2],s+o+n)}return t},DM:function(t,i){for(var e=[],s=0;s<i.length;s++){var n=i[s],r=this.zM(t,n);e.push(r[0]),t=r[1]}e.push(t);for(var h=0;h<e.length;h++){var o=this.VM(e[h]);e[h]=o}for(var a="",u=0;u<e.length-1;u++)a+=e[u]+i[u];return a+=e[e.length-1]},FM:function(t){var i;try{i=_(t)}catch(e){i=""}return i.toString()},zM:function(t,i){var e=t.indexOf(i);return[t.substr(0,e),t.substr(e+1)]},VM:function(t){return t=(t=t.replace(/^ */g,"")).replace(/ *$/g,"")},MM:function(){this.BM=[]},SM:function(t,i){this.BM[t+"__"+i]=!0},AM:function(t,i){"undefined"!=typeof this.BM[t+"__"+i]&&delete this.BM[t+"__"+i]},yM:function(t,i){return"undefined"!=typeof this.BM[t+"__"+i]},TM:function(t,i){var e=this.getItem(i[0]);"undefined"==typeof e.depends&&(e.depends={}),"undefined"==typeof e.depends[i[1]]&&(e.depends[i[1]]={}),e.depends[i[1]][t[0]+"__"+t[1]]=t,"undefined"==typeof(e=this.getItem(t[0])).triggers&&(e.triggers={}),"undefined"==typeof e.triggers[t[1]]&&(e.triggers[t[1]]={}),e.triggers[t[1]][i[0]+"__"+i[1]]=i},vM:function(t,i){if(t&&"undefined"!=typeof t.triggers)for(var e in t.triggers[i]){var s=t.triggers[i][e],n=this.getItem(s[0]);n&&delete n.depends[s[1]][t.id+"__"+i]}},IM:function(t){var i=t.match(/#\w+/);return null!==i&&0<i.length&&i[0]}},Ch={headermenu_setter:function(t){return t&&(t.data&&(this.HM=!0),t=this.RM(t)),t},RM:function(n){var t={view:"contextmenu",template:"<span class='webix_icon webix_list_icon {common.hidden()}'></span> &nbsp; #value#",type:{hidden:function(t){return t.hidden?"wxi-eye-slash":"wxi-eye"}},on:{onMenuItemClick:k(function(t){var i=si(this.N.headermenu),e=i.getItem(t).hidden;i.getItem(t).hidden=!e,i.refresh(t),i.$blockRender=!0;var s={spans:"object"==M(n)&&n.spans};return e?this.showColumn(t,s):this.hideColumn(t,s),i.$blockRender=!1},this)},data:[]};"object"==M(n)&&F.extend(t,n,!0);var i=Qt(t);return i.attachTo(this.k),this.Ht.push(i),this.attachEvent("onStructureLoad",this.EM),this.attachEvent("onStructureUpdate",this.EM),this.RM=function(t){return t},i.N.id},EM:function(){var t=si(this.N.headermenu),i=this.To;if(!t.$blockRender){if(this.HM)return t.data.each(function(t){t.hidden=!!i[t.id]}),void t.refresh();var e=[],s=this.Co;s.length||(s=this.ll);for(var n=0;n<s.length;n++){var r=this.getColumnConfig(s[n].id||s[n]),h=r.header[0],o=!!i[r.id];!1!==r.headermenu&&h&&e.push({id:r.id,value:o?h.text:h.groupText||h.text,hidden:o})}e.length&&t.data.importData(e)}}};yn.headerMenu={getValue:function(){},setValue:function(){},refresh:function(t,i){t.N.headermenu||(t.define("headermenu",!0),t.EM()),i.onclick=function(){si(t.config.headermenu).show(i)}},render:function(){return"<span class='webix_icon wxi-columns' role='button' tabindex='0' aria-label='"+B.aria.headermenu+"'>"}};var $h={Ha:function(t){return this.getColumnConfig(t.column).editor},getEditor:function(t,i){return t?(1==arguments.length&&(i=t.column,t=t.row),(this.ka[t]||{})[i]):this.Ni},Ya:function(t){for(var i in this.ka){var e=this.ka[i];for(var s in e)"$count"!=s&&t.call(this,e[s])}},Ra:function(t,i,e){var s=t.row,n=t.column,r=i.config=this.getColumnConfig(n);!1!==e&&this.showCell(s,n);var h=i.render();i.$inline&&(h=this.Ia(t)),i.node=h;var o,a=this.getItem(s),u=r.editFormat;return this.N.editMath&&(o=a["$"+n]),V(o=o||a[n])&&(o=""),i.setValue(u?u(o):o,a),i.value=a[n],this.Na(t,i),i.$inline||(i.PM=this.La(t,h,!0)),
i.afterRender&&i.afterRender(),this.N.liveValidation&&(Yt(i.node,"keyup",this.jM(t,this)),this.validateEditor(t)),h},jM:function(t,i){return function(){i.validateEditor(t)}},Ga:function(t){var i=this.getColumnConfig(t.column).editParse,e=t.getValue();return i?i(e):e},za:function(t,i,e){var s=e?{}:this.getItem(t.row);return s[t.column]=i,this.N.editMath&&(s["$"+t.column]=null),s},Na:function(t,i){var e=this.ka[t.row]=this.ka[t.row]||{};e.$count=(e.$count||0)+1,i.row=t.row,i.column=t.column,this.Ni=e[t.column]=i,this.Fi++,this.NM=this.getScrollState()},Wa:function(t){this.Ni==t&&(this.Ni=0),t.destroy&&t.destroy();var i=this.ka[t.row];delete i[t.column],i.$count--,i.$count||delete this.ka[t.row],this.Fi--},Aa:function(t,i){var e=this.ka[t];if(e)for(var s in this.ka[i]=e,delete this.ka[t],e)"$count"!=s&&(e[s].row=i)},Oa:function(t){var i,e,s,n,r,h=this.getColumnConfig(t.column),o=0;if(h&&h.node&&h.attached){if(s=this.getIndexById(t.row),this.vl&&this.getSpan(t.row,t.column))for(e=0;e<3;e++)for(i=this.LM[e],n=0;!o&&n<i.childNodes.length;n++)(r=i.childNodes[n]).getAttribute("row")==s&&r.getAttribute("column")==this.getColumnIndex(t.column)&&(o=r);!o&&s>=h.OM-this.N.topSplit&&s<h.WM&&(o=h.node.childNodes[s-h.OM+this.N.topSplit])}return o},editCell:function(t,i,e,s){return i=i||this.N.columns[0].id,ze.edit.call(this,{row:t,column:i},e,s)},editRow:function(i){i&&i.row&&(i=i.row);var e=!1;this.eachColumn(function(t){this.edit({row:i,column:t},e,!e),e=!0})},editColumn:function(i){i&&i.column&&(i=i.column);var e=!1;this.eachRow(function(t){this.edit({row:t,column:i},e,!e),e=!0})},eachRow:function(t,i){var e=this.data.order;i&&(e=this.data.zh||e);for(var s=0;s<e.length;s++)t.call(this,e[s])},eachColumn:function(t,i){var e=this.Co;if(i&&e.length)for(var s=0;s<e.length;s++){var n=this.getColumnConfig(e[s]);t.call(this,n.id,n)}else for(var r=[].concat(this.ll),h=0;h<r.length;h++){var o=r[h];t.call(this,o.id,o)}},Ka:function(t){if(this.getSelectedId&&1==this.getSelectedId(!0).length)return this.jo(t),!1},Ti:function(t,i){if(this.N.editable&&!this.Fi){if(i.target&&"INPUT"==i.target.tagName)return!0;var e=this.getSelectedId(!0);if(1==e.length){var s=e[0];return"row"==this.N.select&&(s.column=this.N.columns[i.shiftKey?0:this.N.columns.length-1].id),this.editNext(t,s),!1}}return!0},Xa:function(t,i,e){var s=this.getIndexById(t.row),n=this.getColumnIndex(t.column),r=this.data.order,h=this.ll;if(e)for(var o=s;o<r.length;o++){for(var a=n+1;a<h.length;a++){var u={row:r[o],column:h[a].id};if(i.call(this,u)&&(!this.UM||!this.UM(t,u)))return u.toString=this.hy,u}n=-1}else for(var c=s;0<=c;c--){for(var f=n-1;0<=f;f--){var l={row:r[c],column:h[f].id};if(i.call(this,l))return l.toString=this.hy,l}n=h.length}return null},qM:function(){if(this.Fi){var t=this.nt.childNodes[1].firstChild.scrollTop;t&&(this.gr.scrollTo(this.getScrollState().y+t),this.nt.childNodes[1].firstChild.scrollTop=0)}},YM:function(){if(this.Fi){var t=this.nt.childNodes[1],i=t.scrollTop,e=t.scrollLeft;if(this.GM)return this.GM=!1;this.N.prerender&&this.gr.scrollTo(i),this.xr.scrollTo(e),this.Wo&&(i&&(this.nt.childNodes[1].scrollTop=0),e&&(this.nt.childNodes[1].scrollLeft=0),this.GM=i||e)}},Fa:function(){var t=this;this.attachEvent("onScrollY",this.XM),this.attachEvent("onScrollX",this.XM),this.attachEvent("onScrollY",this.Ca),this.attachEvent("onColumnResize",function(){this.editStop()}),this.attachEvent("onAfterFilter",function(){this.editStop()}),this.attachEvent("onRowResize",function(){this.editStop()}),this.attachEvent("onAfterScroll",function(){this.N.topSplit&&this.editStop()}),this.nt.childNodes[1].onscroll=function(){return t.YM()},this.N.prerender||(this.nt.childNodes[1].firstChild.onscroll=function(){return t.qM()})},XM:function(){if(this.Fi){var t=this.NM;this.NM=this.getScrollState();var h=this.NM.y-t.y;this.Ya(function(t){if(t.getPopup){var i=this.getItemNode(t),e=!1;if(this.N.prerender){var s=t.PM,n=s.top-this.wr,r=s.left-this.yr;e=n<0||n+s.height>this.Xy||r<0||r+s.width>this.$width-this.KM}!i||e?t.getPopup().show({x:-1e4,y:-1e4}):t.getPopup().show(i)}
this.N.prerender||t.linkInput||t.$inline||(t.node.top-=h,t.node.style.top=t.node.top+"px")})}}},Dh={$init:function(){this.JM(),this.attachEvent("onStructureLoad",this.ZM)},JM:function(){this.To={},this.Co=T(),this.Fo=[0,0,0]},ZM:function(){for(var t=this.ll,i=0;i<t.length;i++)t[i].header&&this.QM(t,t[i].header),t[i].footer&&this.QM(t,t[i].footer);for(var e=t.length-1;0<=e;e--)t[e].hidden?this.hideColumn(t[e].id,{},!0,!0):t[e].batch&&this.config.visibleBatch&&t[e].batch!=this.config.visibleBatch&&this.hideColumn(t[e].id,{},!0,!0)},QM:function(t,i){for(var e=0;e<i.length;e++){var s=i[e];s&&s.colspan&&!s.$colspan&&(s.$colspan=s.colspan)}},moveColumn:function(t,i){var e=this.getColumnIndex(t);if(e==i||-1==e)return!1;var s,n=this.Co,r=this.N.columns,h=r.splice(e,1)[0];n.length&&(s=n.find(t),n.removeAt(s)),this.tS(e,s,-1);var o,a=i-(e<i?1:0);if(x.insertAt.call(r,h,a),n.length){var u=r[a-1];o=u&&u.id?n.find(u.id)+1:0,n.insertAt(h.id,o)}this.tS(a,o,1),this.iS()},eS:function(t,i){if(!t.length){for(var e=0;e<i.length;e++)t[e]=i[e].id;this.Fo=[this.N.leftSplit,this.Ix,this.N.rightSplit]}},isColumnVisible:function(t){return!this.To[t]},hideColumn:function(t,i,e,s){var n,r=this.N.columns,h=this.Co,o=this.To,a=1;if(i=i||{},!1!==s){var u=this.getColumnIndex(t);if(-1==u||!this.callEvent("onBeforeColumnHide",[t]))return;if(this.eS(h,r),i.spans)for(var c=r[u].header,f=0;f<c.length;f++)c[f]&&(a=Math.max(a,c[f].colspan||1));this.sS(u,a,-1);for(var l=u+a-1;u<=l;l--)this.nS(u),(o[(n=r.splice(u,1)[0]).id]=n).OM=-1,n.hidden=!0,delete this.rS[n.id];this.callEvent("onAfterColumnHide",[t])}else{if(!(n=o[t])||!this.callEvent("onBeforeColumnShow",[t]))return;for(var d=null,v=0,_=0;_<h.length;_++){if(h[_]==t){v=_;break}o[h[_]]||(d=h[_])}if(i.spans)for(var p=n.header,b=0;b<p.length;b++)p[b]&&(p[b].colspan=p[b].$colspan||p[b].colspan,a=Math.max(a,p[b].colspan||1));for(var m=d?this.getColumnIndex(d)+1:0,g=v+a-1;v<=g;g--){var w=o[h[g]];w?(x.insertAt.call(r,w,m),delete w.hidden,delete o[w.id],this.rS[w.id]=w):a--}this.sS(v,a,1,!0),this.callEvent("onAfterColumnShow",[t])}n.header&&this.hS(n,!1!==s?0:1,"header"),n.footer&&this.hS(n,!1!==s?0:1,"footer"),h.length===r.length&&this.JM(),e||this.iS()},showColumn:function(t,i,e){return this.hideColumn(t,i,e,!1)},sS:function(t,i,e,s){var n=a(s?this.Fo:[this.N.leftSplit,this.Ix],2),r=n[0],h=n[1];t<r&&(this.N.leftSplit+=e*i),h<=t?this.N.rightSplit+=e*i:this.Ix+=e*i},tS:function(t,i,e){0<=t&&(t<this.N.leftSplit&&(this.N.leftSplit+=e),this.N.rightSplit&&t>=this.Ix?this.N.rightSplit+=e:this.Ix+=e),this.Co.length&&0<=i&&(i<this.Fo[0]&&(this.Fo[0]+=e),this.Fo[2]&&i>=this.Fo[1]?this.Fo[2]+=e:this.Fo[1]+=e)},hS:function(t,i,e){for(var s=t[e].length-1;0<=s;s--)for(var n,r=this.Co,h=!1,o=0,a=0;a<r.length;a++){var u=this.getColumnConfig(r[a]),c=u[e][s];this.isColumnVisible(r[a])?(h&&0<o&&n&&0<n.colspan?n=c=u[e][s]=n:c&&c.$colspan&&o<=0&&(o=c.colspan=c.$colspan,n=c),h=null):(c&&c.$colspan&&o<=0&&(o=c.colspan=c.$colspan,h=n=c),n&&0<o&&n.colspan--),o--}},refreshColumns:function(t){this.oS=!0,t&&(this.JM(),this.Io={}),this.rS={};for(var i=0;i<this.ll.length;i++){var e=this.ll[i];(this.rS[e.id]=e).attached=e.node=null}for(var s=0;s<3;s++)this.k.childNodes[s].innerHTML="",this.nt.childNodes[s].firstChild.innerHTML="";this.ll=this.config.columns=t||this.config.columns,this.Ix=this.ll.length-(this.config.rightSplit||0),this.Ao=0,this.aS(),this.Cr(),this.callEvent("onStructureUpdate"),this.render(),this.oS=!1},iS:function(){this.Ao=0,this.callEvent("onStructureUpdate"),this.uS(),this.render()},showColumnBatch:function(r,h,t){var o=void 0!==h;h=!1!==h;var a=[];this.eachColumn(function(t,i){if(i.batch){var e=this.To[i.id];h||(e=!e),i.batch==r&&e?this.hideColumn(i.id,{spans:!0},!0,!h):o||i.batch==r||e||this.hideColumn(i.id,{spans:!0},!0,h)}if(o&&h)for(var s=i.header,n=0;n<s.length;n++)s[n]&&s[n].batch&&s[n].closed&&a.push(s[n].batch)},!0);for(var i=0;i<a.length;i++)a[i]!=r&&this.showColumnBatch(a[i],!1,!0);t||this.iS()},Nx:function(t){if(this.Co.length){for(var i=0;i<this.Co.length;i++)if(this.Co[i]==t)return i;return-1}
return this.getColumnIndex(t)},Ox:function(t){return this.Co.length?this.Co[t]:this.columnId(t)}},Ih={$init:function(t){this.attachEvent("onAfterScroll",this.Cu),this.attachEvent("onFocus",function(){vt(this.$view,"webix_dtable_focused")}),this.attachEvent("onBlur",function(){_t(this.$view,"webix_dtable_focused")}),"column"!=t.select&&(this.open||this.cS)&&this.attachEvent("onEnter",function(){var t=this.getSelectedId(!0);if(!(1!=t.length||this.getEditor&&this.getEditor())){var i=this.getItemNode(t[0]);t=t[0].row,("row"==this.config.select||i.querySelector(".webix_tree_open")||i.querySelector(".webix_tree_close"))&&(this.isBranchOpen(t)?this.close(t):this.open(t))}})},Cu:function(){if(!this.fS()){var t=this.it.querySelector(".webix_cell");t&&t.setAttribute("tabindex","0")}},fS:function(){for(var t=this.getSelectedId(!0),i=0;i<t.length;i++)if(t[i].column&&this.isColumnVisible(t[i].column))return this.getItemNode(t[i]);return null},moveSelection:function(t,i,e){if(this.lS(),!this.N.disabled){i=i||{};var s=this.getSelectedId(!0),n=s.length-1,r=!(!this.N.multiselect&&!this.N.areaselect)&&i.shift;if(1<s.length&&"cell"!==this.N.select&&(s=s.sort(k(function(t,i){return this.getIndexById(t.row)>this.getIndexById(i.row)||this.getColumnIndex(t.column)>this.getColumnIndex(i.column)?1:-1},this)),"up"!=t&&"left"!=t&&"top"!=t&&"pgup"!=t||(n=0)),n<0&&this.count()){if("down"==t||"right"==t)t="top";else{if("up"!=t&&"left"!=t)return;t="bottom"}n=0,s=[{row:1,column:1}]}if(0<=n){var h=s[n].row,o=s[n].column;if("top"==t||"bottom"==t)h&&("top"==t?h=this.data.getFirstId():"bottom"==t&&(h=this.data.getLastId())),o&&(n=0,"bottom"==t&&(n=this.config.columns.length-1),o=this.columnId(n));else if("up"==t||"down"==t||"pgup"==t||"pgdown"==t){if(h){var a=this.getIndexById(h),u=1;"pgup"!=t&&"pgdown"!=t||(u=this.yc?this.yc.config.size:Math.round(this.Xy/this.N.rowHeight)),"up"==t||"pgup"==t?a-=u:"down"!=t&&"pgdown"!=t||(a+=u),a<0&&(a=0),a>=this.data.order.length&&(a=this.data.order.length-1),!(h=this.getIdByIndex(a))&&this.N.pager&&this.showItemByIndex(a)}}else{if("right"!=t&&"left"!=t)return;if(o&&"row"!=this.config.select){var c=this.getColumnIndex(o);"right"==t?c++:"left"==t&&c--,c<0&&(c=0),c>=this.config.columns.length&&(c=this.config.columns.length-1),o=this.columnId(c)}else{if((this.open||this.cS)&&"right"==t)return this.open?this.open(h):this.openSub(h);if((this.close||this.cS)&&"left"==t)return this.close?this.close(h):this.closeSub(h)}}if(h){this.showCell(h,o),this.select||(F.extend(this,this.Xx.Gx,!0),this.N.select=this.open||this.cS?"row":"cell",F.extend(this,this.Xx[this.N.select],!0));var f={row:h,column:o};if(r&&"area"==this.N.select){var l=this.wx[this.wx.length-1];this._x(f,l,t,i)}else this.jo(f,r);if(!this.N.clipboard&&!1!==e){var d=this.getItemNode(f);d&&d.focus()}}}return!1}}},Ah={Qo:function(t){for(var i=0;i<this.ll.length;i++){var e=this.ll[i],s=this.getItemNode({row:t,cind:i});s?s.parentNode.insertBefore(re.dn[i],s):e.node.appendChild(re.dn[i])}},sa:function(){var t=[],i=this.ll.length,e=document.createElement("div");e.className="webix_drop_area",e.style.height=this.N.rowHeight+"px",e.innerHTML=this.$dropHTML();for(var s=0;s<i;s++)t.push(e.cloneNode(!0));return t}},Th={drag_setter:function(t){return this.attachEvent("onBeforeDrag",function(t){return this.dS(t.source)}),this.attachEvent("onBeforeDragIn",function(t){var i=this.dS(t.target);return!i&&re.dn&&(rt(re.dn),this.ra=re.dn=null),i}),$e.drag_setter.call(this,t),"order"!=t&&"move"!=t||F.extend(this,Ah,!0),t},Zo:function(t,i,e){var s=re.Gs;this.N.prerender||e||(t=[s.start]);for(var n=0;n<t.length;n++){for(var r=0;r<this.ll.length;r++){var h=this.getItemNode({row:t[n],cind:r});h&&vt(h,i)}this.data.addMark(t[n],i,1,1,!0)}},Jo:function(t,i,e){var s=re.Gs;this.N.prerender||e||(t=[s.start]);for(var n=0;n<t.length;n++){for(var r=0;r<this.ll.length;r++){var h=this.getItemNode({row:t[n],cind:r});h&&_t(h,i)}this.data.removeMark(t[n],i,1,!0)}},dS:function(t){var i,e,s=!1;if(this.N.topSplit&&t)for(I(t)||(t=[t]),i=0;!s&&i<t.length;i++)s=0<=(e=this.getIndexById(t[i]))&&e<this.N.topSplit
;return!s},tt:function(t){for(var i="<div class='webix_dd_drag' style='width:"+(this.xe-this.hM)+"px;'>",e=this.N.columns,s=0;s<e.length;s++){var n=this.aM(t,e[s]);i+="<div style='width:"+e[s].width+"px;'>"+n+"</div>"}return i+"</div>"},getHeaderNode:function(t,i){return this.vS(t,i,this.k)},getFooterNode:function(t,i){return this.vS(t,i,this.Qy)},vS:function(t,i,e){if(this.isColumnVisible(t)){var s=this.getColumnIndex(t),n=this.N.leftSplit>s?0:this.Ix<=s?2:1;i=i||0;return e.childNodes[n].querySelector("div[".concat("column",'="').concat(s,'"][').concat("row",'="').concat(i,'"]'))}return null},getItemNode:function(t){if(t&&!t.header){var i=t.row||t,e="number"==typeof t.rind?t.rind:this.getIndexById(i),s=this.kx(),n=s[0]-this.N.topSplit;if(e<n&&e>s[1])return;var r=this.Sx(),h=this.N.leftSplit?0:r[0],o="number"==typeof t.cind;if((t.column||o)&&(h=o?t.cind:this.getColumnIndex(t.column))<this.Ix&&h>=this.N.leftSplit&&(h<r[0]||h>r[1]))return;var a=this.N.columns[h];if(a&&a.attached&&a.node){if("$webix-drop"===i)return re.dn[h];for(var u=e<this.N.topSplit||this.N.prerender?e:e-n,c=a.node.childNodes,f=Math.min(c.length,u+1),l=0;l<f;l++)"webix_drop_area"===c[l].className&&u++;return c[u]}}},_S:function(t){var i=t.target.nodeName;return"INPUT"!=i&&"TEXTAREA"!=i},dragColumn_setter:function(t){var h;return"order"==t?h={$drag:k(function(t,i,e){if(!this._S(i)||this.Vv)return!1;var s=this.locate(i);if(!s||!this.callEvent("onBeforeColumnDrag",[s.column,i]))return!1;re.Gs={from:h,start:s,custom:"column_dnd"};var n=this.getColumnConfig(s.column);if("touch"===e){var r=this.getHeaderNode(s.column,s.rind);this.pS={x:ct(i).x-at(r).x}}else this.pS=ut(i);return this.bS=n.width,this.Lo=!0,"<div class='webix_dd_drag_column' style='width:"+n.width+"px'>"+(n.header[0].text||"&nbsp;")+"</div>"},this),$dragPos:k(function(t,i,e){var s=this,n=re.getContext(),r=at(this.$view);e.style.display="none";var h=document.elementFromPoint(t.x,r.y+this.N.headerRowHeight/2),o=h?this.locate(h):null,a=n.start.column;if(o&&o.column!=a&&(!this.mS||o.column!=this.gS)&&"column_dnd"==n.custom&&si(h)==this){if(!this.callEvent("onBeforeColumnDropOrder",[a,o.column,i]))return;var u=this.getColumnIndex(a),c=this.getColumnIndex(o.column);i.touches&&(this.wS=i.target,this.wS.style.display="none",this.$view.parentNode.appendChild(this.wS)),this.moveColumn(a,c+(u<c?1:0)),this.gS=o.column,this.mS=!0}if(o&&o.column==a&&(this.mS=!1),e.style.display="block",t.x=t.x-this.pS.x,t.y=r.y,t.x<r.x)t.x=r.x;else{var f=r.x+this.$view.offsetWidth-this.hM-this.bS;t.x>f&&(t.x=f)}re.rn=!0,this.ot&&(this.ot=window.clearTimeout(this.ot)),!1!==this.N.dragscroll&&(this.ot=C(function(t){return s.at(t)},this,[ct(i)],250))},this),$dragDestroy:k(function(t,i){this.Lo=null,this.ot&&(this.ot=window.clearTimeout(this.ot)),rt(i),this.wS&&rt(this.wS);var e=re.getContext().start;this.callEvent("onAfterColumnDropOrder",[e.column,this.gS,t])},this),$drop:function(){}}:t&&(h={Oo:!0,$drag:k(function(t,i){if(!this._S(i)||this.Vv)return!1;var e=this.locate(i);if(!e||!this.callEvent("onBeforeColumnDrag",[e.column,i]))return!1;re.Gs={from:h,start:e,custom:"column_dnd"};for(var s=this.getColumnConfig(e.column).header,n="&nbsp;",r=0;r<s.length;r++)if(s[r]){n=s[r].text;break}return this.Lo=!0,"<div class='webix_dd_drag_column'>"+n+"</div>"},this),$drop:k(function(t,i,e){var s=e;e.touches&&this.xS&&(s=this.xS);var n=this.locate(s);if(!n)return!1;var r=re.getContext().start.column;if(r!=n.column){if(!this.callEvent("onBeforeColumnDrop",[r,n.column,e]))return;var h=this.getColumnIndex(r),o=this.getColumnIndex(n.column);this.moveColumn(r,o+(h<o?1:0)),this.callEvent("onAfterColumnDrop",[r,n.column,e])}},this),$dragIn:k(function(t,i,e){var s=this,n=re.getContext();if("column_dnd"!=n.custom||n.from!=h)return!1;for(var r=e.target;-1==(r.className||"").indexOf("webix_hcell");)if(!(r=r.parentNode))return;return this.ot&&(this.ot=window.clearTimeout(this.ot)),!1!==this.N.dragscroll&&(this.ot=C(function(t){return s.at(t)},this,[ct(e)],250)),r!=this.xS&&(this.xS&&_t(this.xS,"webix_dd_over_column"),vt(r,"webix_dd_over_column")),
this.xS=r},this),$dragDestroy:k(function(t,i){this.Lo=null,this.ot&&(this.ot=window.clearTimeout(this.ot)),this.xS&&_t(this.xS,"webix_dd_over_column"),rt(i)},this)}),t&&(re.addDrag(this.k,h),re.addDrop(this.k,h,!0),this.attachEvent("onDestruct",function(){return re.unlink(h)}),this.st||F.extend(this,Wt,!0)),t}},Fh={hr:function(t,i){if(t.scroll&&!i)return!0;t.header=V(t.header)?!!this.config.header:t.header,t.footer=V(t.footer)?!!this.config.footer:t.footer,t.xCorrection=t.xCorrection||0},Xp:function(t,i){for(var e=-1,s=0;e<0&&s<t.length;s++)i(t[s])&&(e=s);return e},yS:function(e,c,f){var l={},d=0;return e.forEach(k(function(t,o){var i=t[0],a=[],u=i.length;i.forEach(k(function(t,i){for(var e=c[i+d],s=0;s<e[f].length;s++){var n=e[f][s];if(n||l[o]&&l[o][s]){if(n=S(n||{text:""}),l[o]&&l[o][s]&&0===i&&(n.colspan=l[o][s],l[o][s]=0),n.colspan){var r=Math.min(n.colspan,u-i);l[o+1]=l[o+1]||{},l[o+1][s]=n.colspan-r,n.colspan=r}n.rowspan&&1===u&&(n.height=(n.height||this.config.headerRowHeight)*n.rowspan,n.rowspan=null);var h={txt:n.rotate?this.getHeaderNode(e.id,s).innerHTML:n.text||(n.contentId?this.getHeaderContent(n.contentId).getValue():""),className:"webix_hcell webix_"+f+"_cell "+(n.css||""),style:{height:(n.height||this.config.headerRowHeight)+"px",width:n.colspan?"auto":e.width+"px"},span:n.colspan||n.rowspan?{colspan:n.colspan||1,rowspan:n.rowspan||1}:null};a[s]=a[s]||[],a[s][i]=h}}},this)),e[o]="header"==f?a.concat(t):t.concat(a),d+=u},this)),e},or:function(v,t,_){var p=this.config.columns,b=this.getSelectedId(!0),m="page"==v.fit?Infinity:this.ur(v),g=0,w=0,x=[],y=0,M=[];return _=_||0+v.xCorrection,t=t||[],this.eachRow(k(function(i){for(var t=0,e=this.getItem(i),s=this.getIndexById(i),n=[],r=!1,h=_;h<p.length;h++){var o=p[h].id,a=this.getColumnIndex(o)-_;if(p[h]){if(t+=p[h].width,0===s&&M.push(p[h].width),m<t&&_<h){y=h;break}if("selection"!==v.data||"selection"==v.data&&-1!==this.Xp(b,function(t){return t.column==o&&t.row==i})){var u;if(this.getSpan&&(u=this.getSpan(i,o)),u&&this.getColumnIndex(o)===_){var c=this.getColumnIndex(u[1]);c<_&&(u[2]=u[2]-(_-c),u[4]=u[4]?u[4]:e[u[1]]?this.getText(i,u[1]):null,u[1]=o)}if(!u||u&&u[0]==i&&u[1]==o){var f=u&&u[4]?u[4]:this.rS[o]?this.getText(i,o):"",l=this.getCss(i,o)+" "+(p[h].css||"")+(u?" webix_dtable_span "+(u[5]||""):""),d={height:u&&1<u[3]?"auto":(e.$height||this.config.rowHeight)+"px",width:u&&1<u[2]?"auto":p[h].width+"px"};n.push({txt:f,className:l,style:d,span:u?{colspan:u[2],spanStart:this.getColumnIndex(u[1]),rowspan:u[3]}:null}),(f||0===f)&&(g=Math.max(a+1,g),w=Math.max(s+1,w)),r=r||!!f}else u&&(n.push({$inspan:!0}),g=Math.max(a+1,g),w=Math.max(s+1,w))}}}v.skiprows&&!r||x.push(n)},this)),w&&g&&(v.trim&&(x.length=w,x=x.map(function(t){for(var i=t.length-1;0<=i;i--)if(t[i].span&&t[i].span.colspan){t[i].span.colspan=Math.min(t[i].span.colspan,t.length-i);break}return t.length=g,t})),t.push(x)),y?this.or(v,t,y):(v.footer&&(t=this.yS(t,p,"footer")),v.header&&(t=this.yS(t,p,"header")),"page"==v.fit&&this.MS(t,M,g,v)),t},MS:function(t,i,e,s){e&&s.trim&&(i.length=e);for(var n=0,r=0;r<i.length;r++)n+=i[r];n>this.ur(s)&&t[0]&&t[0].forEach(function(t){for(var i=0;i<t.length;i++)t[i]&&t[i].style&&t[i].style.width&&(t[i].style.width="auto")})},ar:function(n,r){var h=st("div");return n.forEach(k(function(t,i){var e=st("table",{"class":"webix_table_print "+this.$view.className+(r.borderless?" borderless":""),style:"border-collapse:collapse",id:this.$view.getAttribute("id")});if(t.forEach(function(t){var s=st("tr");t.forEach(function(t){if(!t.$inspan){var i=st("td");for(var e in i.innerHTML=t.txt,i.className=t.className,t.style)i.style[e]=t.style[e];t.span&&(i.colSpan=t.span.colspan,i.rowSpan=t.span.rowspan),s.appendChild(i)}}),e.appendChild(s)}),h.appendChild(e),i+1<n.length){var s=st("DIV",{"class":"webix_print_pagebreak"});h.appendChild(s)}},this)),h}},Vh={$exportView:function(t){this.isBranchOpen&&F.extend(t,{filterHTML:!0});var i=t.export_mode;if("pdf"!=i&&"excel"!=i||t.dataOnly||!t.styles)return this;t.dataOnly=!0,t.heights=V(t.heights)?"all":t.heights;var e="pdf"==i?Ps(this,t
):Gs(this,t);return e[0].styles=this.SS(t),delete t.dataOnly,e},SS:function(t){var u=t.export_mode,c=this.config.columns,f=[];return this.kS||(this.kS={}),this.kS[u]||(this.kS[u]={}),t.docHeader&&"excel"==u&&(f=[{0:this.CS(t.docHeader.css,u)},{0:{}}]),!1!==t.header&&(f=this.$S(t,"header",f,u)),this.data.each(function(t){for(var i={},e=0;e<c.length;e++){var s=this.getCss(t.id,c[e].id),n=c[e].node.className,r="",h=null,o=null;if(this.vl&&(h=this.getSpan(t.id,c[e].id))?(o=this.getSpanNode({row:h[0],column:h[1]}),r="webix_dtable_span "+(h[5]||"")):o=this.getItemNode({row:t.id,column:c[e].id}),!o){o=st("div",{"class":s,style:"visibility:hidden"});var a=c[e].node;c[e].attached||(a=st("div",{"class":n,style:"visibility:hidden"}),this.nt.appendChild(a)),a.appendChild(o)}i[e]=this.DS(o,[s,n,r].join(":"),u)}f[f.length]=i},this),!1!==t.footer&&this.config.footer&&(f=this.$S(t,"footer",f,u)),t.docFooter&&"excel"==u&&(f=f.concat([{0:{}},{0:this.CS(t.docFooter.css,u)}])),f},$S:function(t,i,e,s){for(var n=this.config.columns,r=[],h=0;h<n[0][i].length;h++){for(var o={},a=0;a<n.length;a++){var u=n[a][i][h];if(u){var c=u.colspan?n[a+u.colspan-1].id:n[a].id,f="header"==i?this.getHeaderNode(c,h):this.getFooterNode(c,h);if(f){var l=[f.className,u.css||"",i];o[a]=this.DS(f,l.join(":"),s),(u.colspan||u.rowspan)&&r.push([h,a,{colspan:u.colspan-1||0,rowspan:u.rowspan-1||0},o[a]])}}else for(var d=0;d<r.length;d++){var v=r[d][2],_=r[d][1],p=r[d][0];_+v.colspan>=a&&p+v.rowspan>=h&&(o[a]=r[d][3])}}e[e.length]=o}return e},IS:function(t,i,e){return"0px"==t["border-".concat(e,"-width")]?null:Ze.rgbToHex(t["border-".concat(e,"-color")])||i},DS:function(t,i,e){if(this.kS[e][i])return this.kS[e][i];var s=this.AS(t),n=Ze.rgbToHex(s["background-color"])||"FFFFFF",r={backgroundColor:n,fontSize:.75*s["font-size"].replace("px",""),bold:"normal"!=s["font-weight"]&&400!=s["font-weight"],italic:"italic"==s["font-style"],underline:"line-through"==s["text-decoration-line"],strikethrough:"underline"==s["text-decoration-line"],color:Ze.rgbToHex(s.color),textAlign:s["text-align"],whiteSpace:"normal"==s["white-space"],borderRightColor:this.IS(s,n,"right"),borderLeftColor:this.IS(s,n,"left"),borderBottomColor:this.IS(s,n,"bottom"),borderTopColor:this.IS(s,n,"top")},h="pdf"==e?r:this.TS(s,t,r);return this.kS[e][i]=h},CS:function(t,i){t=F.extend(t||{},{visibility:"hidden","white-space":"nowrap","text-align":"left"});var e="";for(var s in t)e+=s+":"+t[s]+";";var n=st("div",{style:e});this.nt.appendChild(n);var r=this.DS(n,e,i);return rt(n),r},TS:function(t,i,e){var s=i.firstChild&&i.firstChild.className&&-1!==i.firstChild.className.indexOf("webix_rotate");return{font:{name:t["font-family"].replace(/,.*$/,""),sz:e.fontSize,color:{rgb:e.color},bold:e.bold,underline:e.underline,italic:e.italic,strike:e.strikethrough},alignment:{horizontal:e.textAlign,vertical:t.height==t["line-height"]?"center":"top",wrapText:e.wrapText,textRotation:s?90:null},fill:{fgColor:{rgb:e.backgroundColor}},border:{right:e.borderRightColor?{style:"thin",color:{rgb:e.borderRightColor}}:null,bottom:e.borderBottomColor?{style:"thin",color:{rgb:e.borderBottomColor}}:null,left:e.borderLeftColor?{style:"thin",color:{rgb:e.borderLeftColor}}:null,top:e.borderTopColor?{style:"thin",color:{rgb:e.borderTopColor}}:null}}},AS:function(t){return window.getComputedStyle?window.getComputedStyle(t):t.currentStyle}},zh={subrow_setter:function(t){return!!t&&(this.FS(),this.N.fixedRowHeight=!1,Lt(t))},subview_setter:function(t){return t&&(this.N.subrow=this.subrow_setter("<div></div>")),t},defaults:{subRowHeight:35},VS:function(){this.data.each(function(t){t&&(t.$sub=this.N.subrow(t,this.type))},this),this.zS()},zS:function(t){if("auto"===this.N.subRowHeight&&this.xe&&this.BS(),t&&this.N.subview)for(var i in this.cS){var e=si(this.cS[i]);e.N.hidden||e.adjust()}},HS:function(t){var i=this.getItem(t);i.$sub=this.N.subrow(i,this.type),"auto"===this.N.subRowHeight&&this.BS(i.id,i.$sub)},$init:function(){this.FS=o(function(){var t="#"+this.RS+" .webix_cell.webix_dtable_subview { line-height:normal;}";this.N.fixedRowHeight&&(
t+="#"+this.RS+" .webix_column .webix_cell { white-space: nowrap;}"),it(t),this.cS={},this.attachEvent("onSubViewRender",this.ES),this.data.attachEvent("onStoreUpdated",k(function(t,i,e){t?"update"==e||"add"==e?this.HS(t):"delete"==e&&i.$subContent&&(si(i.$subContent).destructor(),delete this.cS[i.$subContent]):this.VS()},this)),this.attachEvent("onResize",function(t,i,e){e!=t&&this.zS(!0)})}),this.type.subrow=function(t){return t.$sub?t.$subopen?"<div class='webix_tree_open webix_sub_open'></div>":"<div class='webix_tree_close webix_sub_close'></div>":"<div class='webix_tree_none'></div>"},this.on_click.webix_sub_open=function(t,i){return this.closeSub(i),!1},this.on_click.webix_sub_close=function(t,i){return this.openSub(i),!1}},openSub:function(t){var i=this.getItem(t);if(!i.$subopen){i.$row=this.N.subrow,i.$subHeight=i.$subHeight||this.N.subRowHeight,i.$subopen=!0;var e=this.cS[i.$subContent];e&&(e.repaintMe=!0),this.refresh(t),this.callEvent("onSubViewOpen",[t])}},getSubView:function(t){var i=this.getItem(t);if(i){var e=this.cS[i.$subContent];if(e)return si(e)}return null},resizeSubView:function(t){var i=this.getSubView(t);i&&this.PS(this.getItem(t),i)},PS:function(t,i){var e=i.$getSize(0,0)[2],s=t.$subHeight||this.N.subRowHeight;2<Math.abs(e-(s||0))&&(t.$subHeight=e,this.refresh(t.id))},jS:function(t){var i=t.$width;if(t.Nl){var e=t.ci.length-t.Yl;t.Ol?i-=t.tu.left+t.tu.right+2:i-=t.eu*(e-1)+t.tu.left+t.tu.right+2*e}return 0<i},ES:function(n,t){var i,e=this.cS[n.$subContent];if(e)t.firstChild.appendChild(e),i=si(n.$subContent),this.jS(i)||i.adjust(),e.repaintMe&&(delete e.repaintMe,i.config.hidden=!1,i.Ce());else{var s,r=this.N.subview;(i="function"==typeof r?r.call(this,n,t.firstChild):((s=S(r)).$scope=this.$scope,Qt(s,t.firstChild))).getMasterView=k(function(){return this},this),n.$subContent=i.config.id,this.cS[n.$subContent]=i.$view,this.Ht.push(i),i.attachEvent("onResize",k(function(t,i,e,s){i&&i!=s&&this.refresh(n.id)},this)),this.callEvent("onSubViewCreate",[i,n])}this.PS(n,i||si(e))},BS:function(i,e){var t,s=st("DIV",{"class":"webix_measure_size webix_cell webix_dtable_subrow"},"");s.style.cssText="width:"+this.xe+"px; height:auto; visibility:hidden; position:absolute; top:0px; left:0px; overflow:hidden;",this.$view.appendChild(s),s.offsetHeight<1&&(t=this.$view.cloneNode(!0),document.body.appendChild(t),t.appendChild(s)),this.data.each(function(t){(t&&!i||t.id==i&&t.$sub)&&(s.innerHTML=e||this.N.subrow(t,this.type),t.$subHeight=s.offsetHeight)},this),s=rt(s),t&&rt(t)},closeSub:function(t){var i=this.getItem(t);if(i.$subopen){i.$row=!1,i.$subopen=!1;var e=this.cS[i.$subContent];e&&(si(e).config.hidden=!0),this.refresh(t),this.callEvent("onSubViewClose",[t])}}},Bh={spans_setter:function(t){return t&&!this.vl&&this.NS(),t},NS:function(){this.vl={},this.LM=[],this.data.attachEvent("onStoreLoad",k(function(t,i){i&&i.spans&&this.addSpan(i.spans)},this)),this.data.attachEvent("onClearAll",k(function(){this.vl={}},this)),this.attachEvent("onSyncScroll",function(t,i,e){for(var s=0;s<3;s++)ne.xs(this.LM[s],1==s?t:0,i,e)}),this.attachEvent("onScrollY",this.LS),this.attachEvent("onScrollX",this.LS),this.attachEvent("onAfterRender",this.OS),this.attachEvent("onColumnResize",this.OS),this.attachEvent("onSelectChange",this.WS)},addSpan:function(t,i,e,s,n,r){if("object"!=M(t))s=s||1,e=e||1,this.vl[t]||(this.vl[t]={}),this.vl[t][i]=[e,s,n,r];else for(var h=0;h<t.length;h++)this.addSpan.apply(this,t[h])},removeSpan:function(t,i){arguments.length||(this.vl={});var e=this.vl[t];e&&delete e[i]},getSpan:function(t,i){if(!t)return this.vl;var e,s,n,r,h,o=this.vl;for(t in e=this.getIndexById(t),n=this.getColumnIndex(i),o)for(i in o[t])if(h=o[t][i],s=this.getIndexById(t),0<=(r=this.getColumnIndex(i))&&0<=s&&!(e>s+h[1]-1||e<s||n>r+h[0]-1||n<r))return[t,i].concat(h);return null},OS:function(){var t,i,e=this.ll.length-this.N.rightSplit;for(rt(this.LM),i=0;i<3;i++)t=this.LM[i]=st("DIV",{"class":"webix_span_layer"}),this.nt.childNodes[i].appendChild(t);this.LS(),this.N.leftSplit&&this.US(this.LM[0],0,this.N.leftSplit),
this.N.rightSplit&&this.US(this.LM[2],e,this.ll.length),this.US(this.LM[1],this.N.leftSplit,e),this.N.topSplit&&!St.touch&&this.qS()},YS:function(){for(var t,i=0,e=0,s=0,n=0;i<this.N.leftSplit;)e+=this.ll[i].width,i++;for(t=(i=this.ll.length-1)-this.N.rightSplit;t<=i;)n+=this.ll[i].width,i--;for(i=this.N.leftSplit;i<this.ll.length-this.N.rightSplit;i++)s+=this.ll[i].width;return[e,s,n]},qS:function(){for(var t=3;t<6;t++)this.LM[t]=st("DIV",{"class":"webix_span_layer_top"}),this.nt.childNodes[t-3].appendChild(this.LM[t]);var i=this.YS();this.N.leftSplit&&(this.LM[3].style.width=i[0]+"px",this.US(this.LM[3],0,this.N.leftSplit,!0));var e=this.ll.length-this.N.rightSplit;this.N.rightSplit&&(this.LM[5].style.width=i[2]+"px",this.US(this.LM[5],e,this.ll.length,!0)),this.LM[4].style.width=i[1]+"px",this.US(this.LM[4],this.N.leftSplit,e,!0)},US:function(t,i,e,s){for(var n,r=0,h=this.data.$min||0,o=this.data.$max||(this.data.zh?this.data.zh.length:this.data.order.length),a=h;a<o;a++){var u=this.data.zh?this.data.zh[a]:this.data.order[a];if(u){var c=this.vl[u];if(c&&(!s||a<this.N.topSplit))for(var f=i;f<e;f++)c[n=this.Co.length?this.Co[f]:this.ll[f].id]&&this.GS(t,a,f,c,r,i,u,n);(!this.data.zh||-1<this.data.order.find(u))&&(r+=this.Py(this.getItem(u)))}else r+=this.N.rowHeight}},WS:function(){for(var t=this.config.select,i="cell"==t||"column"==t,e=this.getSelectedId(!0),s=[],n=this.XS||[],r=z()+"",h=!1,o=0;o<e.length;o++){var a=this.vl[e[o]];!a||i&&!a[e[o].column]||(a.$selected&&a.$selected.id==e[o].id||(h=!0),a.$selected=e[o],a.$time=r,s.push(e[o].id))}for(var u=0;u<n.length;u++){var c=this.vl[n[u]];c&&c.$time!==r&&(delete c.$selected,h=!0)}this.XS=[].concat(e),h&&this.OS()},KS:function(t,i){for(var e,s=0,n=t;n<i;n++)s+=(e=this.Co.length?this.getColumnConfig(this.Co[n]):this.ll[n])&&!e.hidden?e.width:0;return s},JS:function(t,i){for(var e=0,s=this.data.zh||this.data.order,n=t;n<i;n++){var r=this.getItem(s[n]);(!this.data.zh||-1<this.data.order.find(r.id))&&(e+=r?this.Py(r):this.N.rowHeight)}return e},GS:function(t,i,e,s,n,r,h,o){var a=s[o],u=this.KS(e,e+a[0]);if(!u)return!1;var c=this.JS(i,i+a[1]);if(!c)return!1;var f=a[2]||this.getText(h,o),l="";if(!s.$selected||"row"!==this.N.select&&s.$selected.column!==o||(l="webix_selected "),this.data.zh){for(;this.getIndexById(h)<0;)i++,h=this.data.zh[i];i=this.getIndexById(h)}var d="";i+a[1]==this.N.topSplit&&(d+=" webix_last_topcell"),e+a[0]==this.N.leftSplit&&(d+=" webix_last_rightcell");var v={column:e,row:i,"class":l+"webix_cell webix_table_cell webix_dtable_span "+(a[3]||"")+d,"aria-colindex":e+1,"aria-rowindex":i+1};1<a[0]&&(v["aria-colspan"]=a[0]),1<a[1]&&(v["aria-rowspan"]=a[1]);var _=st("DIV",v,""+f);_.style.top=n+"px",_.style.left=this.KS(r,e)+"px",_.style.width=u+"px",_.style.height=c+"px",t.appendChild(_)},LS:function(){if(!this.N.prerender)for(var t=this.getScrollState(),i=0;i<3;i++)this.LM[i].style.top="-"+(t.y||0)+"px"},UM:function(t,i){var e,s,n=!1;return this.vl&&(e=this.getSpan(t.row,t.column),s=this.getSpan(i.row,i.column),e&&s&&e[0]==s[0]&&e[1]==s[1]&&(n=!0)),n},getSpanNode:function(t){for(var i=this.LM,e=this.getIndexById(t.row),s=this.getColumnIndex(t.column),n=0;n<i.length;n++)for(var r=i[n].childNodes,h=0;h<r.length;h++)if(r[h].getAttribute("row")==e&&r[h].getAttribute("column")==s)return r[h];return null}},Hh={name:"datatable",defaults:{leftSplit:0,rightSplit:0,topSplit:0,columnWidth:100,sort:!0,prerender:!1,autoheight:!1,autowidth:!1,header:!0,fixedRowHeight:!0,scrollAlignY:!0,scrollX:!0,scrollY:!0,datafetch:50,navigation:!0},$skin:function(){this.defaults.rowHeight=te.rowHeight,this.defaults.minRowHeight=te.rowHeight-6,this.defaults.headerRowHeight=te.barHeight-2*te.borderWidth,this.defaults.minColumnWidth=2*te.dataPadding+te.borderWidth},on_click:{webix_excel_filter:function(){return!1},webix_richfilter:function(){return!1},webix_table_checkbox:function(t,i){i=this.locate(t);var e=this.getItem(i.row),s=this.getColumnConfig(i.column),n=t.target,r=("checkbox"==n.type?n.checked:e[i.column]!=s.checkValue)?s.checkValue:s.uncheckValue,h={};return h[i.column]=r,
this.updateItem(i.row,h,this.N.checkboxRefresh?"update":"save"),this.callEvent("onCheck",[i.row,i.column,r]),!1},webix_table_radio:function(t){var e=this.locate(t),i=this.getItem(e.row),s=this.getColumnConfig(e.column);return this.eachRow(function(t){var i=this.data.pull[t];i&&i[e.column]==s.checkValue&&(i[e.column]=s.uncheckValue)}),i[e.column]=s.checkValue,this.callEvent("onCheck",[e.row,e.column,!0]),this.refresh(),!1}},on_dblclick:{webix_table_checkbox:function(){return this.on_click.webix_table_checkbox.apply(this,arguments)}},on_context:{},$init:function(t){this.on_click=F.extend({},this.on_click);this.qi.innerHTML="<div class='webix_ss_header' section='header'><div class='webix_hs_left'></div><div class='webix_hs_center'></div><div class='webix_hs_right'></div></div><div class='webix_ss_body'><div class='webix_ss_left'><div class='webix_ss_center_scroll'></div></div><div class='webix_ss_center'><div class='webix_ss_center_scroll' role='rowgroup'></div></div><div class='webix_ss_right'><div class='webix_ss_center_scroll'></div></div></div><div class='webix_ss_hscroll' role='scrollbar' aria-orientation='horizontal'></div><div class='webix_ss_footer' section='footer'><div class='webix_hs_left'></div><div class='webix_hs_center'></div><div class='webix_hs_right'></div></div><div class='webix_ss_vscroll_header'></div><div class='webix_ss_vscroll' role='scrollbar' aria-orientation='vertical'></div><div class='webix_ss_vscroll_footer'></div>",this.RS=this.qi.id=this.name+z(),this.qi.className+=" webix_dtable",this.it=this.qi,this.k=this.qi.firstChild,this.nt=this.k.nextSibling,this.Qy=this.nt.nextSibling.nextSibling,this.zt.setAttribute("role","grid"),t.editable||this.zt.setAttribute("aria-readonly","true"),this.data.provideApi(this,!0),this.data.attachEvent("onParse",k(this.ZS,this)),this.$ready.push(this.QS),this.ll=[],this.dl=[],this._l=[],this.tk=[],this.Ro={},this.Io={},this.ik={},this.ek=[],this.ha=this.sk=0,this.Ht=[],this.data.attachEvent("onServerConfig",k(this.nk,this)),this.data.attachEvent("onServerOptions",k(this.rk,this)),this.attachEvent("onViewShow",function(){this.c_(),this.hk()}),this.data.attachEvent("onClearAll",k(function(t){t||(this.yr=this.wr=0,this.xr&&this.xr.reset(),this.gr&&this.gr.reset(),this.ak(0))},this)),this.attachEvent("onDestruct",this.uk),this.attachEvent("onKeyPress",this.De),this.attachEvent("onScrollY",this.ck),g("onDataTable",[this,t])},fk:function(){this.KM=this.hM=St.scrollSize;var t=this.N.headerRowHeight+1;it("#"+this.RS+" .webix_cell { height:"+this.N.rowHeight+"px; line-height:"+(this.N.rowLineHeight||this.N.rowHeight)+"px;"+(this.N.fixedRowHeight?"":"white-space:normal;")+" }"),it("#"+this.RS+" .webix_hcell { height:"+t+"px; line-height:"+t+"px;}"),this.fk=function(){}},QS:function(){var t=this;this.data.attachEvent("onStoreLoad",function(){return t.hk(!0)}),this.data.attachEvent("onSyncApply",function(){return t.hk(!0)}),this.data.attachEvent("onStoreUpdated",k(function(){return this.render.apply(this,arguments)},this)),this.data.attachEvent("onStoreUpdated",k(this.lk,this)),this.render()},refresh:function(){this.render()},lS:function(){var t=this;clearTimeout(this.dk),this.dk=C(function(){t.dk=0,V(t.vk)||(t.ak(t.vk),delete t.vk),t.render()})},render:function(t,i,e){if("save"!=e&&!this.dk){if(!this.ll.length){var s=this.N.columns;if(!s||!s.length){if(!this.N.autoConfig||!this.data.order.length||this.Co.length)return;this.Ao=0,this._k()}this.aS()}if(!this.isVisible(this.N.id)||this.$blockRender)return this.fk();var n=this.config.experimental&&!this.N.subview;return!t||-1==i||"paint"!=e&&"update"!=e||n?(this.pk&&(clearTimeout(this.pk),this.pk=0),this.callEvent("onBeforeRender",[this.data])?(this.fk(),this.Ao||this.uS(),this.xe&&(n&&("paint"==e||"update"==e)&&t?this.bk(t):this.mk(!0,!0)),t&&"update"==e||(this.Gy=this.gk(),this.wk()),this.zt.setAttribute("aria-colcount",Math.max(this.Co.length,this.ll.length)),this.zt.setAttribute("aria-rowcount",this.data.count()),this.callEvent("onAfterRender",[this.data]),!0):void 0):(this.pk&&clearTimeout(this.pk),void(this.pk&&this.xk!=t?(
this.xk=null,this.pk=C(function(){this.render()},this)):(this.xk=t,this.pk=C(function(){this.render(t,-1,e)},this))))}},getColumns:function(t){var i=this.Co;if(t&&i.length){for(var e=[],s=0;s<i.length;s++)e.push(this.getColumnConfig(i[s]));return e}return $(this.ll)},getColumnConfig:function(t){return this.rS[t]||this.To[t]},rk:function(t){for(var i in t){var e=this.getColumnConfig(i),s=new $r({data:t[i]});this.Ht.push(s),this.Lu(s,e)}},nk:function(t){this.Bu(),t.columns&&this.Ao&&this.refreshColumns(t.columns)},aS:function(){if(this.N.columns){this.rS={},this.ll=this.N.columns,this.Ix=this.ll.length-(this.config.rightSplit||0);for(var t=0;t<this.ll.length;t++)this.yk(this.ll[t]);this.Mk("header",this.dl),this.Mk("footer",this._l),this.callEvent("onStructureLoad",[])}},yk:function(t){V((this.rS[t.id]=t).header)&&(t.header=t.id);var i=t.cssFormat;if(i&&(t.cssFormat=c(i,this.$scope)),t.width=this.Sk(t.width||this.N.columnWidth,t),"string"==typeof t.format&&(t.format=B[t.format]||window[t.format]),t.numberFormat){var e=t.numberFormat;"string"==typeof e&&(t.numberFormat=e=sn.getConfig(e)),t.format=sn.numToStr(e),t.editFormat=t.editFormat||function(t){return sn.format(t,e)},t.editParse=t.editParse||function(t){return sn.parse(t,e)}}V(t.checkValue)&&(t.checkValue=1),V(t.uncheckValue)&&(t.uncheckValue=0),t.css&&"object"==M(t.css)&&(t.css=tt(t.css));var s=t.template;s&&("string"==typeof s&&(s=s.replace(/#\$value#/g,"#"+t.id+"#")),t.template=Lt(s))},kk:function(){this.uS()},uk:function(){for(var t=0;t<this.ll.length;t++)delete this.ll[t].attached,delete this.ll[t].node},uS:function(){this.Ix=this.ll.length-(this.config.rightSplit||0);for(var t=this.Ck=0;t<this.ll.length;t++){if(!this.ll[t].node){var i=st("DIV");i.style.width=this.ll[t].width+"px",this.ll[t].node=i}t>=this.N.leftSplit&&t<this.Ix&&(this.Ck+=this.ll[t].width)}var e=[];if(this.N.rightSplit){var s=this.ll.length-this.N.rightSplit;e[s]=" webix_first",e[s-1]=" webix_last"}if(this.N.leftSplit){var n=this.N.leftSplit;e[n]=" webix_first",e[n-1]=" webix_last"}e[0]=(e[0]||"")+" webix_first webix_select_mark";var r=this.ll.length-1;e[r]=(e[r]||"")+" webix_last";for(var h=0;h<this.ll.length;h++){var o=this.ll[h].node;o.setAttribute("column",h),o.className="webix_column "+(this.ll[h].css||"")+(e[h]||"")}this.$k(),this.Dk(),this.Ik(),this.gy(),this.Ao=!0},Dk:function(){for(var t=0,i=0;i<this.ll.length;i++){var e=this.ll[i];i!=this.N.leftSplit&&i!=this.Ix||(t=0),e.node&&(e.node.style.left=t+"px",(this.N.leftSplit||this.N.rightSplit)&&(rt(e.node),e.attached=!1)),t+=e.width}},gy:function(){this.Ak||(this.Ak=0),this.ha=this.sk=0,this.N.header&&(this.Tk(this.k,0,1),this.Mk("header",this.dl),this.ha=this.dl.Fk,this.Vk(this.k,"header",this.dl)),this.N.footer&&(this.Tk(this.Qy,0,1),this.Mk("footer",this._l),this.sk=this._l.Fk,this.Vk(this.Qy,"footer",this._l)),this.refreshHeaderContent(!1,!1),this.zk();for(var t=0;t<this.ek.length;t++){var i=this.ek[t];this.Bk(i,this.ik[i])}},Hk:function(t,i,e){var s=0,n=t.colspan||1,r="webix_hcell "+(t.css||"");if(t.rotate)r+=" webix_measure_rotate";else for(var h=0;h<n;h++)s+=this.ll[e+h]?this.ll[e+h].width:this.config.columnWidth;var o=pt([t.text],r,s);return t.rotate?o.width:o.height},Mk:function(t,i){for(var e=0,s=i.length=0;s<this.ll.length;s++){var n=this.ll[s][t]||"";I(n)||(n=[n]);for(var r=0;r<n.length;r++)"object"!=M(n[r])&&(n[r]={text:n[r]}),n[r]&&n[r].height&&(i[r]=Math.max(i[r]||0,n[r].height)),n[r]&&n[r].autoheight&&(i[r]=Math.max(i[r]||0,this.Hk(n[r],this.ll[s],s))),n[r]&&n[r].css&&"object"===M(n[r].css)&&(n[r].css=tt(n[r].css));e=Math.max(e,n.length),this.ll[s][t]=n}for(var h=(i.Fk=e)-1;0<=h;h--)i[h]=i[h]||this.N.headerRowHeight,i.Fk+=1*i[h];for(var o=0;o<this.ll.length;o++)for(var a=this.ll[o][t],u=0;u<a.length;u++){if(a[u]&&a[u].rowspan)for(var c=1;c<a[u].rowspan;c++)a[u+c]=null;if(a[u]&&a[u].colspan)for(var f=1;f<a[u].colspan;f++)this.ll[o+f][t][u]=null}for(var l=0;l<this.ll.length;l++){var d=this.ll[l][t];if(d.length<e){var v=d.length-1;d[v].rowspan=e-d.length+1;for(var _=v+1;_<e;_++)d[_]=null}}return e},Rk:function(t,i){
return t.querySelector("DIV[".concat("active_id",'="').concat(i,'"]'))},getHeaderContent:function(t){var i=this.Rk(this.k,t);if(i||(i=this.Rk(this.Qy,t)),i){var e=this.Ro[t],s=yn[e.content],n={type:s,getValue:function(t){return s.getValue(i,t)},setValue:function(t){return s.setValue(i,t)}};return s.getHelper&&F.extend(n,s.getHelper(i,e)),n}},Ek:function(t,i){return"<div class='".concat(i,"' style='height:").concat(t,"px;'></div>")},Pk:function(t,i,e,s,n){if(t==i)return"";for(var r="",h='<div style="background:inherit;width:'.concat(e,'px;">'),o=this.ll[0][s].length,a=0,u=t;u<i;u++){var c=0,f=this.ll[u].width,l=u==t?"position:static;":"position:absolute;top:".concat(c,"px;left:").concat(a,"px;");h+='<div class="webix_hcolumn" style="'.concat(l,"width:").concat(f,'px;overflow:hidden;">');for(var d=0;d<o;d++){var v=this.ll[u][s][d],_=n[d],p="webix_hcell";if(this.ll[u].$selected&&(p+=" webix_sel_hcell"),u==t&&(p+=" webix_first"),u==i-1&&(p+=" webix_last"),d==o-1&&(p+=" webix_last_row"),v){v.content&&(v.contentId=v.contentId||z(),v.columnId=this.ll[u].id,v.format=this.ll[u].format,yn[v.content],v.content,v.text=yn[v.content].render(this,v),this.Ro[v.contentId]=v,this.jk=!0),v.css&&(p+=" "+v.css);var b="<div row='"+d+"'column='"+(v.colspan?v.colspan-1+u:u)+"'",m="";v.contentId&&(b+=" active_id='"+v.contentId+"'");var g=!1,w=_;if(v.colspan&&1<v.colspan||v.rowspan&&1<v.rowspan){var x=this.Nk(this.ll,u,v.colspan)||f;(w=this.Lk(n,d,v.rowspan))<=0&&(w=_),h+=this.Ek(_+1,p),v.colspan&&u+v.colspan>=i&&(p+=" webix_last"),v.rowspan&&d+v.rowspan>=o&&(p+=" webix_last_row"),p+=" webix_span",g=!0,m=" colspan='".concat(v.colspan||1,"' rowspan='").concat(v.rowspan||1,"' style='position:absolute;top:").concat(c,"px;left:").concat(a,"px;line-height:").concat(w+1,"px;width:").concat(x,"px;height:").concat(w+1,"px;'")}else _!=this.N.headerRowHeight&&(m=" style='line-height:".concat(_+1,"px;height:").concat(_+1,"px;'"));b+=' class="'+p+'"',b+=" "+m+">";var y=""===v.text?"&nbsp;":v.text;v.rotate&&(y="<div class='webix_rotate' style='width:"+(w-10)+"px;transform-origin:center "+(w-15)/2+"px;'>"+y+"</div>"),b+=y+"</div>",g?r+=b:h+=b,c+=_+1}else h+=this.Ek(_+1,p),c+=_+1}a+=f,h+="</div>"}return h+r+"</div>"},Lk:function(t,i,e){var s=-1;for(e+=i;i<e;i++)s+=t[i]+1;return s},Nk:function(t,i,e){var s=0;for(e+=i;i<e;i++)s+=t[i].width;return s},showItemByIndex:function(t,i){var e=this.N.pager;if(e&&t>=this.N.topSplit){var s=Math.floor(t/e.size);s!=e.page&&si(e.id).select(s)}var n=this.getScrollState();if(t>=this.N.topSplit||this.N.prerender&&-1!=t){var r=this.kx();if(t<r[0]+1||t>=r[1]-1){var h=this.Ok(e?this.data.$min:0,t),o=this.Xy+1,a=this.Ty(t);if(t<r[0]+1)h=Math.max(0,h)-this.Wk();else if(o<h+a){h+=a-o;for(var u=t;0<u&&0<o;u--)o-=this.Ty(u);0<t&&o&&(h+=this.Ty(t+1))}else h=n.y;n.y=h}}if(-1!=i){if(i<this.N.leftSplit||i>=this.Ix)return this.scrollTo(n.x,n.y);var c=this.Sx();if(i<c[0]+1||i>=c[1]-1){for(var f=0,l=this.N.leftSplit;l<i;l++)f+=this.ll[l].width;var d=this.ll[i].width;i<c[0]+1||(f+d>this.Ay?f+=d-this.Ay:f=n.x),n.x=f}}this.scrollTo(n.x,n.y)},showCell:function(t,i){if(!i||!t){var e=this.getSelectedId(!0);1==e.length&&(i=i||e[0].column,t=t||e[0].row)}i=i?this.getColumnIndex(i):-1,t=t?this.getIndexById(t):-1,this.showItemByIndex(t,i)},scrollTo:function(t,i){if(this.xr){if(this.Ky)return this.Ky(t,i);null!==t&&this.xr.scrollTo(t),null!==i&&this.gr.scrollTo(i)}},getScrollState:function(){if(this.Jy)return this.Jy();var t=this.yx?0:this.Uk||0;return{x:this.yr||0,y:this.wr+t}},showItem:function(t){this.showItemByIndex(this.getIndexById(t),-1)},Vk:function(t,i,e){var s=this,n=t.childNodes;n[0].innerHTML=this.Pk(0,this.N.leftSplit,this.Vx,i,e),n[1].innerHTML=this.Pk(this.N.leftSplit,this.Ix,this.Ck,i,e),n[2].innerHTML=this.Pk(this.Ix,this.ll.length,this.Iy,i,e);var r=this.getScrollState().x;St.touch?ne.xs(n[1].firstChild,-r,0,"0ms"):n[1].scrollLeft=r,n[1].onscroll=function(){return s.qk()}},qk:function(){var t=this.k.childNodes[1].scrollLeft;if(this.GM)return this.GM=!1;this.xr.scrollTo(t),this.Wo&&(t&&(this.k.childNodes[1].scrollLeft=0),this.GM=t)},
lk:function(){this.refreshHeaderContent(!0,!0)},hk:function(t){this.refreshHeaderContent(!1,!0,null,t)},refreshHeaderContent:function(t,i,e,s){this.N.header&&(i&&this.Tk(this.k,t,1,e,s),this.Tk(this.k,t,0,e,s)),this.N.footer&&(i&&this.Tk(this.Qy,t,1,e,s),this.Tk(this.Qy,t,0,e,s))},refreshFilter:function(t){this.refreshHeaderContent(!1,!0,t)},Tk:function(t,i,e,s,n){if(this.jk&&t)for(var r=t.querySelectorAll("".concat("DIV","[").concat("active_id","]")),h=0;h<r.length;h++){var o=r[h].getAttribute("active_id");if(o){var a=this.Ro[o];if(s&&s!=a.columnId)continue;var u=yn[a.content];e?u.getValue&&(a.value=u.getValue(r[h])):i&&!u.trackCells||n&&this.getColumnConfig(a.columnId).collection||u.refresh(this,r[h],a)}}},headerContent:[],Yk:function(t,i,e){this.hM?(t.style.height=Math.max(i,1)-1+"px",t.style.width=(this.Ix?0:e)+this.hM-1+"px"):t.style.display="none"},zk:function(){this.N.header&&this.Yk(this.Gk,this.ha,this.Ak),this.N.footer&&this.Yk(this.Xk,this.sk,this.Ak)},Cr:function(){var t=!(this.N.autowidth||!1===this.N.scrollX),i=!(this.N.autoheight||!1===this.N.scrollY);this.KM=t?St.scrollSize:0,this.hM=i?St.scrollSize:0,this.xr&&(this.xr.N.scrollSize=this.KM,this.xr.N.scrollVisible=t),this.gr&&(this.gr.N.scrollSize=this.hM,this.gr.N.scrollVisible=i)},$k:function(){this.wr=0,this.yr=0;var t=!(this.N.autowidth||!1===this.N.scrollX),i=!(this.N.autoheight||!1===this.N.scrollY);if(t||(this.KM=0),i||(this.hM=0),this.xr||(this.xr=Qt({view:"vscroll",container:this.Qy.previousSibling,scrollWidth:this.Ck,scrollSize:this.KM,scrollVisible:t}),this.KM||St.$customScroll||(this.xr.zt.style.position="absolute"),this.xr.attachEvent("onScroll",k(this.Kk,this))),!this.gr){this.Gk=this.Qy.nextSibling;var e=this.Gk.nextSibling;this.Xk=e.nextSibling,this.gr=Qt({view:"vscroll",container:e,scrollHeight:100,scroll:"y",scrollSize:this.hM,scrollVisible:i}),this.gr.activeArea(this.nt),this.xr.activeArea(this.nt,!0),this.gr.attachEvent("onScroll",k(this.Jk,this))}this.xe&&this.callEvent("onResize",[this.xe,this.Me]),St.$customScroll&&be.enable(this),this.$k=function(){}},columnId:function(t){return this.ll[t]&&this.ll[t].id},getColumnIndex:function(t){for(var i=0;i<this.ll.length;i++)if(this.ll[i].id==t)return i;return-1},Zk:function(t,i){var e,s=0,n=0,r=0,h=0,o=0;for(e=0;e<this.ll.length&&(this.Ix!=e&&this.N.leftSplit!=e||(s=0,o++),this.ll[e].id!=i);e++)s+=this.ll[e].width;for(n+=this.ll[e].width,e=0;e<this.data.order.length&&this.data.order[e]!=t;e++)h+=this.Ty(e);return r+=this.Ty(e),[s,n,h-this.wr,r,this.nt.childNodes[o]]},hy:function(){return this.row},locate:function(t,i){if(this!=si(t))return null;for(t=t.target||t;t&&t.getAttribute&&t!==this.$view;){var e=mt(t).toString(),s=null;if(-1!=e.indexOf("webix_cell")&&(s=this.Bs(t))&&(s.row=this.data.order[s.rind]),-1!=e.indexOf("webix_hcell")&&(s=this.Bs(t))&&(s.header=!0),-1!=e.indexOf("webix_drop_area")&&(s=this.Bs(t))&&(s.row=s.rind="$webix-drop"),s)return i?s.header?null:s.row:(s.column=this.ll[s.cind].id,s.toString=this.hy,s);t=t.parentNode}return null},Bs:function(t){var i=t.parentNode;if(!i)return null;var e=1*(t.getAttribute("column")||i.getAttribute("column")),s=t.getAttribute("aria-rowindex");return{rind:t.getAttribute("row")||(s?s-1:0),cind:e,span:1*(t.getAttribute("colspan")||i.getAttribute("colspan"))}},Zy:function(){for(var t=-this.Ay,i=0;i<this.ll.length;i++)t+=this.ll[i].width;this.yr=Math.min(this.yr,Math.max(0,t))},zo:function(t){this.Ao&&(this.Zy(),this.Dk(),this.Ik(),this.gy(),this.wk(),t||this.mk(!1,!1))},setColumnWidth:function(t,i,e){return this.Vo(this.getColumnIndex(t),i,e)},Vo:function(t,i,e,s){if(!(isNaN(i)||t<0)){var n=this.ll[t];i=this.Sk(i,n);var r=n.width;return r!=i&&(t>=this.N.leftSplit&&t<this.Ix&&(this.Ck+=i-r),n.width=i,!!n.node&&(n.node.style.width=i+"px",e||this.zo(),this.callEvent("onColumnResize",[n.id,i,r,!!s]),!0))}},Sk:function(t,i){return t=Math.max(t,i.minWidth||this.N.minColumnWidth||0),t=Math.min(t,i.maxWidth||this.N.maxColumnWidth||1e5)},Py:function(t){return(t.$height||this.N.rowHeight)+(t.$subopen?t.$subHeight:0)},Ty:function(t){
var i=this.data.order[t];return i?this.Py(this.data.pull[i]):this.N.rowHeight},Ok:function(t,i){if(this.N.fixedRowHeight)return Math.max(i-t,0)*this.N.rowHeight;for(var e=0;t<i;t++)e+=this.Ty(t);return e},ut:function(t,i,e){t.row&&(i=t.column,t=t.row);var s=this.getColumnConfig(i).width,n=this.getItem(t).$height||this.N.rowHeight;if(this.config.spans&&e){var r=this.getSpan(t,i);if(r){var h=this.getSpanNode({row:r[0],column:r[1]});s=h.offsetWidth,n=h.offsetHeight}}for(var o=0,a=0,u=0;u<this.ll.length;u++){u!=this.N.leftSplit&&u!=this.Ix||(o=0);var c=this.ll[u];if(c.id==i){var f=u<this.N.leftSplit?0:u>=this.Ix?2:1;a=this.nt.childNodes[f].firstChild;break}o+=c.width}var l,d=this.getIndexById(t);if(d<this.N.topSplit)l=this.Ok(0,d);else{var v=this.$x||0;l=this.Ok(v,d)+(this.yx||0)+(v<=d?this.Wk():0)}return{parent:a,top:l,left:o,width:s,height:n}},Wk:function(){return this.N.topSplit?this.Ok(0,this.N.topSplit):0},gk:function(){var t=this.N.pager,i=0,e=this.data.order.length;return t&&(i=t.size*t.page,e=Math.min(e,i+t.size),t.level&&(i=this.data.$min,e=this.data.$max)),this.Ok(i,e)},setRowHeight:function(t,i){if(!isNaN(i)){i=Math.max(i,this.N.minRowHeight||0),i=Math.min(i,this.N.maxRowHeight||1e5);var e=this.getItem(t),s=e.$height||this.N.rowHeight;s!=i&&(e.$height=i,this.config.fixedRowHeight=!1,this.render(),this.callEvent("onRowResize",[t,i,s]))}},Jk:function(t){var i=this.wr!==t;if(this.wr=t,this.N.prerender)if(St.touch)this.tM(-t,"0ms");else for(var e=this.nt.childNodes,s=0;s<e.length;s++)e[s].scrollTop=t;else this.mk();St.$customScroll&&be.Cr(this.nt),i&&(this.callEvent("onScrollY",[]),this.callEvent("onAfterScroll",[]))},ak:function(t){if(this.yr=t,St.touch)return this.iM(-t,"0ms");this.nt.childNodes[1].scrollLeft=t,this.N.header&&(this.k.childNodes[1].scrollLeft=t),this.N.footer&&(this.Qy.childNodes[1].scrollLeft=t)},Kk:function(t){var i=this.yr!==t;this.dk?this.vk=t:this.ak(t),this.N.prerender||this.mk(!0),St.$customScroll&&be.Cr(this.nt),i&&(this.callEvent("onScrollX",[]),this.callEvent("onAfterScroll",[]))},Sx:function(t){if(t)return[0,this.ll.length];for(var i=this.yr,e=this.N.leftSplit;0<i&&this.ll.length-1>e;)i-=this.ll[e].width,e++;var s=e;for(i&&0<e&&e--,i+=this.Ay;0<i&&s<this.Ix;)i-=this.ll[s].width,s++;return[e,s]},getVisibleCount:function(){return Math.floor(this.Xy/this.config.rowHeight)},kx:function(t){var i=this.wr,e=0,s=this.count(),n=this.N.pager;n&&(e=n.page*n.size,s=Math.min(s,e+n.size),n.level&&(e=this.data.$min,s=this.data.$max));var r=e+this.N.topSplit;if(t||this.N.autoheight)return[r,s,0];var h=this.N.fixedRowHeight?this.N.rowHeight:0;if(h){var o=Math.ceil(i/h);i-=o*h,r+=o}else for(;0<i;)i-=this.Ty(r),r++;var a=0<r&&i?-(this.Ty(r-1)+i):0,u=r;if(i&&r--,i+=(this.Xy||this.Me)-this.Wk(),h){var c=Math.ceil(i/h);i-=c*h,u+=c}else for(;0<i&&u<s;)i-=this.Ty(u),u++;return s<u&&(u=s),[r,u,a]},bk:function(t){var i=this.getItem(t),e=this.getIndexById(t),s=this.kx(!0===this.N.prerender),n=this.N.topSplit,r="";if(n<=e){if(e<s[0]||e>=s[1])return;e-=s[0]-n}else r=e==n-1?" webix_topcell webix_last_topcell":" webix_topcell";for(var h=this.Sx(),o=0;o<this.ll.length;o++){var a=this.ll[o];if(o<this.Ix&&o>=this.N.leftSplit&&(o<h[0]||o>h[1])&&(a.OM=-999),a.attached&&a.node){var u=a.node.childNodes[e];if(!u)continue;var c=this.aM(i,this.ll[o],0);u.innerHTML=c,u.className=this.Qk(this.ll[o],c,i,t)+r}}},mk:function(t,i){if(this.ll.length&&!this.dk){i&&this.tC();var e=this.Sx(this.N.prerender),s=this.kx(!0===this.N.prerender);if(t){for(var n=this.N.leftSplit;n<e[0];n++)this.nS(n,i);for(var r=e[1];r<this.Ix;r++)this.nS(r,i)}this.Mx=[];for(var h=0;h<this.N.leftSplit;h++)this.iC(h,s,i);for(var o=e[0];o<e[1];o++)this.iC(o,s,i,o==e[0]);for(var a=this.Ix;a<this.ll.length;a++)this.iC(a,s,i);this.eC(s[0],s[1],i),this.sC(s)}},nC:function(t,i){this.rC=t,this.hC=i,rt(this.tk),this.tk=[]},ck:function(){if(this.oC&&!this.Wo&&this.N.prerender){var t=this.getScrollState();this.oC.style.top="-"+(t.y||0)+"px"}},eC:function(t,i,e){if(this.oC&&(this.oC.style.top=this.yx+"px"),e||t!=this.rC||i!=this.hC){if(this.nC(t,i),this.aC){this.aC=!1;for(
var s=0;s<this.Mx.length;s++){var n,r=this.Mx[s],h=this.getItem(r.id);n="function"==typeof h.$row?h.$row.call(this,h,this.type):this.aM(h,this.getColumnConfig(h.$row),s);var o=this.tk[s]=st("DIV",null,n);o.className="webix_cell "+(h.$sub?"webix_dtable_sub"+(this.N.subview?"view":"row"):"webix_dtable_colrow"+(h.$row?" webix_topcell"+(this.data.getMark(h.id,"webix_selected")?" webix_selected":""):"")),o.setAttribute("column",0),o.setAttribute("row",r.index);var a=h.$height||this.N.rowHeight;h.$subopen?o.style.height=h.$subHeight+"px":o.style.height=a+"px",o.style.paddingRight=St.scrollSize+"px";var u=this.Mx[s].index<this.config.topSplit?-this.yx:0;o.style.top=u+r.top+(h.$subopen?a-1:0)+"px",this.oC||(this.oC=st("DIV"),this.oC.style.position="relative",this.oC.style.top=this.yx+"px",this.nt.appendChild(this.oC),this.attachEvent("onSyncScroll",function(t,i,e){ne.xs(this.oC,0,i,e)})),this.oC.appendChild(o),this.N.subview&&this.callEvent("onSubViewRender",[h,o])}}}else if(this.config.topSplit)for(var c=0;c<this.Mx.length;c++){var f=this.tk[c];this.Mx[c].index<this.config.topSplit&&(f.style.top=this.Mx[c].top-this.yx+"px")}},sC:function(t){var i=this.N.pager,e=this.N.datafetch,s=!this.uC||t[0]>=this.uC;if(this.uC=t[0],this.cC){if(i&&(!e||e>=i.size)&&this.fC([0,i.size*i.page],Math.max(e,i.size),!0))return this.cC=null;this.fl(this.cC,s),this.cC=null}else this.N.loadahead&&this.fC(t,this.N.loadahead,s)},fC:function(t,i,e){var s=t[1],n=s+i;e||(s=t[0]-i,n=t[0]),s<0&&(s=0),n=Math.min(n,this.data.order.length-1);for(var r=!1,h=s;h<n;h++)this.data.order[h]||(r?(r.last=h,r.count=h-s):r={start:h,count:n-s});if(r)return this.fl(r,e),!0},fl:function(t,i){var e=Math.max(t.count,this.N.datafetch||this.N.loadahead||0),s=i?t.start:t.last-e+1;this.Mo(t.count,t.start)||this.loadNext(e,s)},lC:function(t){if(St.isSafari){var i,e,s,n,r=[this.xr,this.gr];for(i=0;i<2;i++)(n=r[i])&&n.Ww&&n.Ww.parentNode==t&&(e=n.Ww);e&&(this.dC&&rt(this.dC),s=(this.dC=e).cloneNode(!0),e.parentNode.insertBefore(s,e),this.dC.style.display="none",this.nt.appendChild(this.dC))}},nS:function(t){var i=this.ll[t];this.lC(i.node),rt(i.node),i.attached=!1},tC:function(){for(var t=0;t<this.ll.length;t++)this.ll[t].OM=-1;this.tk.length&&(rt(this.tk),this.tk=[])},getText:function(t,i){return this.aM(this.getItem(t),this.getColumnConfig(i),0)},getCss:function(t,i){var e=this.getItem(t);return this.Qk(this.getColumnConfig(i),e[i],e,t)},Qk:function(t,i,e,s){var n="webix_cell";if(t.cssFormat){var r=t.cssFormat(i,e,s,t.id);r&&("object"==M(r)?n+=" "+tt(r):n+=" "+r)}var h=e.$css;h&&("object"==M(h)&&(e.$css=h=tt(h)),n+=" "+h);var o=this.data.Vh[s];if(o&&(o.$css&&(n+=" "+o.$css),o.$cellCss)){var a=o.$cellCss[t.id];a&&(n+=" "+a)}if(e.$cellCss){var u=e.$cellCss[t.id];u&&("object"==M(u)&&(u=tt(u)),n+=" "+u)}var c=this.data.getMark(e.id,"webix_selected");return(c&&(c.$row||c[t.id])||t.$selected)&&(n+=this.Kx),n},aM:function(t,i,e){return t?((s=t[i.id])!==undefined&&null!==s||(s=""),i.format&&(s=i.format(s)),i.template&&(s=i.template(t,this.type,s,i,e)),s):"";var s},type:{checkbox:function(t,i,e,s){return"<input class='webix_table_checkbox' type='checkbox' "+(e==s.checkValue?'checked="true"':"")+">"},radio:function(t,i,e,s){return"<input class='webix_table_radio' type='radio' "+(e==s.checkValue?'checked="true"':"")+">"},editIcon:function(){return"<span class='webix_icon wxi-pencil'></span>"},trashIcon:function(){return"<span class='webix_icon wxi-trash'></span>"}},type_setter:function(t){return this.types&&this.types[t]?(this.type=l(this.types[t]),this.type.css&&(this.qi.className+=" "+this.type.css)):Kt(this,t),this.type.on_click&&F.extend(this.on_click,this.type.on_click),t},iC:function(t,i,e,s){var n=this.ll[t];if(!n.attached){var r=t<this.N.leftSplit?0:t>=this.Ix?2:1;this.nt.childNodes[r].firstChild.appendChild(n.node),n.attached=!0,n.split=r}if(this.$x=i[0],this.yx=0,this.Uk=i[2],this.N.scrollAlignY?i[1]==this.data.order.length||this.data.$pagesize&&i[1]%this.data.$pagesize==0?n.node.style.top=(this.yx=i[2])+"px":n.vC&&(n.node.style.top="0px"):(this.yx=i[2],n.node.style.top=i[2]+"px"),
!(e||n.OM!=i[0]||n.WM!=i[1]||this.N.topSplit&&n.yx!=this.yx))return 0;for(var h="",o=this.N.columns[t],a={row:this.N.rowHeight,total:0,single:s},u=0;u<this.N.topSplit;u++)h+=this._C(u,o,i,a,-this.yx,t);this.cC=null;for(var c=Math.max(i[0],this.N.topSplit);c<i[1];c++)h+=this._C(c,o,i,a,-1,t);return this.lC(n.node),n.node.innerHTML=h,n.OM=i[0],n.WM=i[1],n.vC=i[2],n.yx=this.yx,1},_C:function(t,i,e,s,n,r){var h=this.data.order[t],o=this.data.getItem(h),a="";if(o){var u=" role='gridcell' aria-rowindex='"+(t+1)+"' aria-colindex='"+(this.getColumnIndex(i.id)+1)+"'"+(o.$count||o.$sub?" aria-expanded='"+(o.open||o.$subopen?"true":"false")+"'":"")+(o.$level?" aria-level='"+o.$level+"'":"");if(s.single&&o.$row&&(this.aC=!0,this.Mx.push({top:s.total,id:o.id,index:t}),!o.$sub)){var c=o.$height||s.row;return s.total+=c,"<div"+u+" class='webix_cell' style='height:"+c+"px;'></div>"}var f=this.aM(o,i,t),l=this.Qk(i,f,o,h),d=" aria-selected='true' tabindex='0'";if(-1!==l.indexOf("select"))if(-1!==l.indexOf("row"))this.Sx()[0]===r&&(u+=d);else-1!==l.indexOf("col")?t===e[0]&&(u+=d):u+=d;var v=!!o.$subopen,_=v?"margin-bottom:"+o.$subHeight+"px;":"";0<=n&&(0<n&&(_+="top:"+n+"px;'"),l="webix_topcell "+l,t==this.N.topSplit-1&&(l="webix_last_topcell "+l)),o.$height?(a="<div"+u+" class='"+l+"' style='height:"+o.$height+"px;"+_+"'>"+f+"</div>",s.total+=o.$height-s.row):a="<div"+u+" class='"+l+"'"+(_?" style='"+_+"'":"")+">"+f+"</div>",v&&(s.total+=o.$subHeight)}else a="<div role='gridcell' class='webix_cell'></div>",this.cC?this.cC.last=t:this.cC={start:t,count:e[1]-t};return s.total+=s.row,a},wk:function(){if(this.ll.length&&!isNaN(1*this.Me)){var t=this.Gy+(this.KM?this.KM:0);if(!this.N.autoheight&&!this.N.yCount||!this.resize()){this.gr.sizeTo(this.Me,this.ha,this.sk),this.gr.define("scrollHeight",t),this.Xy=Math.max(0,this.Me-this.KM-this.ha-this.sk);for(var i=0;i<3;i++)this.nt.childNodes[i].style.height=this.Xy+"px",this.N.prerender?this.nt.childNodes[i].firstChild.style.height=this.Gy+"px":this.nt.childNodes[i].firstChild.style.height=this.Xy+"px";this.k.style.height=this.ha+"px"}}},Ik:function(){if(this.ll.length){var t=0;for(this.Vx=0,this.Iy=0,this.Ay=0;t<this.N.leftSplit;)this.Vx+=this.ll[t].width,t++;for(t=this.ll.length-1;t>=this.Ix;)this.Iy+=this.ll[t].width,t--;if(this.xe&&(!this.N.autowidth||!this.resize())){this.Ay=this.xe-this.Iy-this.Vx-this.hM,this.nt.childNodes[1].firstChild.style.width=this.Ck+"px",this.nt.childNodes[0].style.width=this.Vx+"px",this.nt.childNodes[1].style.width=this.Ay+"px",this.nt.childNodes[2].style.width=this.Iy+"px",this.k.childNodes[0].style.width=this.Vx+"px",this.k.childNodes[1].style.width=this.Ay+"px",this.k.childNodes[2].style.width=this.Iy+"px",this.Qy.childNodes[0].style.width=this.Vx+"px",this.Qy.childNodes[1].style.width=this.Ay+"px",this.Qy.childNodes[2].style.width=this.Iy+"px";var i=this.Ay-this.Ck;i<0&&(i=0),i!=this.Ak&&(this.Ak=i,this.zk()),this.xr.sizeTo(this.xe-this.hM),this.xr.define("scrollWidth",this.Ck+this.Vx+this.Iy)}}},$getSize:function(t,i){if((this.N.autoheight||this.N.yCount)&&this.N.columns){var e=(this.N.yCount||0)*this.N.rowHeight;e||(e=this.isVisible()?this.Gy:this.count()*this.N.rowHeight),this.N.height=Math.max(e+(this.KM?this.KM:0)-1,this.N.minHeight||0)+this.ha+this.sk}this.N.autowidth&&this.N.columns&&(this.N.width=Math.max(this.Ck+this.Vx+this.Iy+this.hM,this.N.minWidth||0));var s=this.Vx+this.Iy+this.hM,n=Gi.api.$getSize.call(this,t,i);return n[0]=Math.max(n[0]||s),n},c_:function(){if(this.xr){var t=this.getScrollState();this.xr.config.scrollPos=this.gr.config.scrollPos=-1,this.scrollTo(t.x,t.y)}},$setSize:function(){var t=this.xe,i=this.Me;Gi.api.$setSize.apply(this,arguments)&&(this.Ao&&(this.callEvent("onResize",[this.xe,this.Me,t,i]),this.Ik(),this.wk()),this.render())},pC:function(t,i){var e=this.getColumnConfig(t);if(this.N.sort&&e.sort){var s="asc";this.Do[e.id]?s="asc"==this.Do[e.id].dir?"desc":"asc":this.ik[e.id]&&(s="asc"==this.ik[e.id].getAttribute("webix_sort_dir")?"desc":"asc"),this.Ho(e.id,s,e.sort,i.ctrlKey||i.metaKey)}},markSorting:function(t,i,e){if(
i=i||"asc",!e)for(var s in this.ek=[],this.ik)if(s!==t){var n=this.ik[s].parentNode;n&&(n.removeAttribute("aria-sort"),n.removeAttribute("tabindex")),rt(this.ik[s]),delete this.ik[s]}else this.ek.push(s),this.ik[s].firstChild.innerHTML="1";if(t){if(this.ik[t])this.ik[t].className="webix_ss_sort_".concat(i);else{var r=st("div",{webix_sort_dir:i,"class":"webix_ss_sort_".concat(i)},'<div class="webix_ss_sort_num">'.concat(this.ek.length+1,"</div>"));this.Bk(t,r,i),this.ik[t]=r,this.ek.push(t)}var h=this.ik[this.ek[0]];switch(this.ek.length){case 1:vt(h,"webix_ss_sort_single");break;case 2:_t(h,"webix_ss_sort_single")}}},Bk:function(t,i,e){e=e||i.getAttribute("webix_sort_dir");var s=this.bC(this.getColumnIndex(t));s&&("absolute"!=s.style.position&&(s.style.position="relative"),s.appendChild(i),s.setAttribute("aria-sort",e+"ending"),s.setAttribute("tabindex","0"))},scroll_setter:function(t){return"string"==typeof t?(this.N.scrollX=-1!=t.indexOf("x"),this.N.scrollY=-1!=t.indexOf("y"),t):this.N.scrollX=this.N.scrollY=t},bC:function(t){for(var i=this.k.querySelectorAll("div[".concat("column",'="').concat(t,'"]')),e=null,s=0;s<i.length;s++){var n=i[s].getAttribute("active_id");if(n&&!yn[this.Ro[n].content].$icon)return null;if(i[s].innerHTML&&(e=i[s],(i[s].colSpan||0)<2))return e}return e},$o:[],Do:{},Ho:function(t,i,e,s){var n=this;i=i||"asc",(s="multi"===this.N.sort&&s)||(this.$o=[],this.Do={});var r=this.getColumnConfig(t),h="function"==typeof r.sort?{as:r.sort,dir:i}:{by:r.id,dir:i,as:r.sort};if(this.Do[r.id]||this.$o.push(r.id),this.Do[r.id]=h,"server"==e){var o=[r.id,i,e];1<this.$o.length&&(o=[this.$o.map(function(t){return n.Do[t]})]),this.callEvent("onBeforeSort",o),this.Bo?this.Bo.$params=o:this.loadNext(0,0,0,0,!0,!0).then(function(){return n.Eo(o)})}else{if("text"==e){var a="$text_"+r.id;this.data.each(function(t){t[a]=this.getText(t.id,r.id)},this),h.as="string",h.by=a}1<this.$o.length?this.data.sort(this.$o.map(function(t){return n.Do[t]})):this.data.sort(h)}this.markSorting(r.id,h.dir,s)},Eo:function(t){this.callEvent("onAfterSort",t)},mC:function(t,i,e,s){var n;if(t.length)for(n=0;n<t.length;n++)if(!1===c(t[n],this.$scope).call(this,i,e,s))return!1},sc:function(t,i,e,s){var n=t.target;if(!this.N.subview||this==si(n)){for(var r="",h=[],o=!1,a=null;n&&n.parentNode&&this.zt&&n!=this.zt.parentNode;){if((r=mt(n))&&i)for(var u=(r=r.toString().split(" ")).length-1;0<=u;u--)i[r[u]]&&h.push(i[r[u]]);if(n.parentNode.getAttribute&&!a){var c=n.parentNode.getAttribute("column")||n.getAttribute("column");if(c){var f=this.nt.contains(n);if(!this.ll[c])return;if(o=!0,f){var l=n.parentNode.getAttribute("row")||n.getAttribute("row");if(!l){if(n.getAttribute("column"))return;if((l=Q(n))>=this.N.topSplit)(this.N.pager||!this.N.prerender&&!this.N.autoheight)&&(l+=this.ll[c].OM-this.N.topSplit)}this.Yu=a={row:this.data.order[l],column:this.ll[c].id},a.toString=this.hy}else this.Yu=a={column:this.ll[c].id};if(!1===this.mC(h,t,a,n))return;if(f)this.callEvent("on"+e,[a,t,n])&&s&&this.callEvent("on"+s,[a,t,n]);else if("ItemClick"==e){this.k.contains(n)&&this.callEvent("onHeaderClick",[a,t,n])&&this.pC(a.column,t)}h=[]}}n=n.parentNode}return this.mC(h,t,a,this.$view),o}},ze:function(t,i){var e=this.locate(i);if(!e)return null;var s,n=ni.Lt;if(e.header){for(var r,h=i.target,o=h,a=e.cind-(e.span?e.span-1:0),u=-1;o&&!r;)r=(o=o.parentNode).getAttribute("section");for(;h&&u<0;){var c=h.getAttribute("row");c&&(u=c),h=h.parentNode}var f=this.ll[a][r][u];if(!f.tooltip)return null;n.type.template=Lt(!0===f.tooltip?"#text#":f.tooltip),s=f}else{var l=n.type.column=this.getColumnConfig(e.column);if(!l.tooltip&&l.tooltip!==undefined)return null;if(!0===l.tooltip||!l.tooltip&&V(this.N.tooltip.template))s=this.getText(e.row,e.column).toString();else if(l.tooltip){var d=i.target.getAttribute("webix_area");n.type.template=d?function(t,i){var e=t[l.id];return Lt(l.tooltip).call(this,t,i,e[d],d)}:Lt(l.tooltip)}else n.type.template=Lt(this.N.tooltip.template)}return s!==undefined?s:this.getItem(e.row)},$tooltipOut:function(){return ni.Yt(),
delete ni.Lt.type.column,null},showOverlay:function(t){if(!this.gC){var i=st("DIV",{"class":"webix_overlay"},"");this.nt.appendChild(i),this.gC=i}this.gC.innerHTML=t},hideOverlay:function(){this.gC&&(rt(this.gC),this.gC=null)},mapCells:function(t,i,e,s,n,r){if(null===t&&0<this.data.order.length&&(t=this.data.order[0]),null===i&&(i=this.columnId(0)),null===e&&(e=this.data.order.length),null===s&&(s=this.N.columns.length),this.exists(t)&&(t=this.getIndexById(t),null!==(i=this.getColumnIndex(i))))for(var h=0;h<e&&t+h<this.data.order.length;h++){var o=t+h,a=this.data.order[o];if(a)for(var u=this.getItem(a),c=0;c<s&&i+c<this.N.columns.length;c++){var f=i+c,l=this.columnId(f),d=n(u[l],a,l,h,c);r||(u[l]=d)}}},ZS:function(t,i){!this.N.columns&&t.getConfig&&this.define("columns",t.getConfig(i))},_k:function(){var t=this.getItem(this.getFirstId()),i=this.N.columns=[];for(var e in t)"id"!=e&&"$"!=e[0]&&i.push({id:e,header:e[0].toUpperCase()+e.substr(1),sort:"string",editor:"text"});i.length&&(i[0].fillspace=!0),"undefined"==typeof this.N.select&&this.define("select","row")}},Rh={api:Hh,view:F.protoUI(Hh,mh,Ce,ps,ge,ze,Le,Ye,pe,Fh,$s,{clearValidation:function(){for(var t in this.data.Vh)this.wC(t);this.data.clearMark("webix_invalid",!0)},lh:function(t,i){for(var e in this.wC(t),i)this.addCellCss(t,e,"webix_invalid_cell");this.addCss(t,"webix_invalid")},uh:function(t){this.wC(t),this.removeCss(t,"webix_invalid")},wC:function(t){var i=this.data.getMark(t,"$cellCss");if(i)for(var e in i)i[e]=i[e].replace("webix_invalid_cell","").replace("  "," ")},addRowCss:function(t,i,e){this.addCss(t,i,e)},removeRowCss:function(t,i,e){this.removeCss(t,i,e)},addCellCss:function(t,i,e,s){var n=this.data.getMark(t,"$cellCss"),r=n||{},h=r[i]||"";r[i]=h.replace(e,"").replace("  "," ")+" "+e,n||this.data.addMark(t,"$cellCss",!1,r,!0),s||this.refresh(t)},removeCellCss:function(t,i,e,s){var n=this.data.getMark(t,"$cellCss");if(n){var r=n[i]||"";r&&(n[i]=r.replace(e,"").replace("  "," ")),s||this.refresh(t)}}},Vh,$e,Th,Ih,Dh,$h,kh,Ch,Sh,Mh,yh,zh,xh,wh,gh,{topSplit_setter:function(t){return this.data&&(this.data.$freeze=t),t},freezeRow:function(t,i){var e=this.N.topSplit;if(!this.N.pager&&this.Ao){if(t){var s=this.data.order,n=this.data.zh;t=t.toString(),e=this.xC(t,i,s,e),n&&this.xC(t,i,n,e,!0)}else i||(e=0);this.define("topSplit",e),this.refresh()}},xC:function(t,i,e,s,n){var r=this.data.pull[t]?e.find(t):-1;if(i&&s<=r){n||s++;for(var h=r;s<=h;h--)e[h]=e[h-1];e[s-1]=t}if(!i&&r<s){n||s--;for(var o=r;o<s;o++)e[o]=e[o+1];e[s]=t}return s}},Bh,Ji,Ee,me,ke,We,Oe,Gi.view,p,Hi)},Eh={name:"excelviewer",$init:function(){var t=this;this.$ready.push(function(){this.N.toolbar&&si(this.N.toolbar).attachEvent("onExcelSheetSelect",k(this.showSheet,this))}),this.data.attachEvent("onClearAll",function(){delete t.yC})},defaults:{datatype:"excel"},$onLoad:function(t){if(t.sheets){this.MC=t,this.N.toolbar&&si(this.N.toolbar).setSheets(t.names);var i=t.names[0];return this.showSheet(i.id||i),!0}return!1},$exportView:function(t){var i=t.export_mode;if("pdf"!=i&&"excel"!=i||t.dataOnly)return this;!0===t.sheets?t.sheets=this.getSheets().map(function(t){return t.id||t}):t.sheets&&t.sheets.length?"string"==typeof t.sheets&&(t.sheets=[t.sheets]):t.sheets=[this.yC],t.dataOnly=!0,t.heights=V(t.heights)&&t.styles?"all":t.heights;for(var e=[],s=this.yC,n=0;n<t.sheets.length;n++){var r=t.sheets[n],h=r.id||r,o=r.options?F.extend(S(r.options),t):S(t);o.name||(o.name=h),this.showSheet(h),h!=s&&(o.At=!0),"pdf"==i&&V(o.textBefore)&&(o.textBefore=o.name);var a="pdf"==i?Ps(this,o):Gs(this,o);o.styles&&(a[0].styles=this.SS(o)),"pdf"==i&&t.autowidth&&Ws(o,t),e=e.concat(a)}return this.showSheet(s),delete t.dataOnly,e},showSheet:function(t){if(t!=this.yC){this.clearAll();var i=this.data.driver.sheetToArray(this.MC.sheets[t],{spans:this.N.spans}),e=this.N.excelHeader,s={},n={};if(i.sizes)for(var r=0;r<i.sizes.length;r++)"column"==i.sizes[r][0]?s[i.sizes[r][1]]=Math.round(i.sizes[r][2]):"row"==i.sizes[r][0]&&(n[i.sizes[r][1]]=Math.round(i.sizes[r][2]));if(e)if(!0===e){e=i.data.splice(0,1)[0];for(
var h=0;h<e.length;h++)e[h]={header:e[h],id:"data"+h,width:s[h],adjust:!s[h],editor:"text",sort:"string"}}else e=S(e);else{e=S(i.data[0]);for(var o=0;o<e.length;o++)e[o]={header:"ABCDEFGHIJKLMNOPQRSTUVWXYZ"[o],id:"data"+o,width:s[o],adjust:!s[o],editor:"text",sort:"string"}}this.config.columns=e,this.refreshColumns(),this.parse(i,this.N.datatype),this.yC=t;var a=this.SC(i.spans),u=this.kC(n),c=this.CC(i.styles,a);(a||u||c)&&this.refresh()}},getSheets:function(){return this.MC.names},$C:function(t,i,e,s){for(var n=!1,r=0;r<t.length;r++)if(t[r][0]===i&&t[r][1]===e){t[r][5]=tt(this.DC(s)),this.addSpan(t[r][0],t[r][1],t[r][2],t[r][3],t[r][4],t[r][5]),n=!0;break}return n},CC:function(t,i){var e=0;if(t&&t.length){for(var s=0;s<t.length;s++){var n=t[s][0]-(this.config.excelHeader?1:0);if(0<=n){var r=this.getIdByIndex(n);if(this.exists(r)){var h=this.getItem(r),o=this.columnId(t[s][1]);o&&(i.length&&this.$C(i,r,o,t[s][2])||(h.$cellCss=h.$cellCss||{},h.$cellCss[o]=this.DC(t[s][2])),e++)}}}return e}return!1},IC:function(t){return 8===(t=t||"000000").length&&(t=t.substring(2)),"#"+t},DC:function(t){var i={};if(t.fill&&t.fill.fgColor&&(i["background-color"]=this.IC(t.fill.fgColor.rgb)),t.font){var e=t.font;e.name&&(i["font-family"]=e.name),e.sz&&(i["font-size"]=e.sz/.75+"px"),e.color&&e.color.rgb&&(i.color=this.IC(e.color.rgb)),e.bold&&(i["font-weight"]="bold"),e.underline&&(i["text-decoration"]="underline"),e.italic&&(i["font-style"]="italic"),e.strike&&(i["text-decoration"]="line-through")}if(t.alignment){var s=t.alignment;s.vertical&&"center"==s.vertical&&(i.display="flex",i["justify-content"]="flex-start",i["align-items"]="center"),s.vertical&&"bottom"==s.vertical&&(i.display="flex",i["justify-content"]="flex-end",i["align-items"]="flex-end"),s.horizontal&&(!s.vertical||"center"!=s.vertical&&"bottom"!=s.vertical?i["text-align"]=s.horizontal:i["justify-content"]="center"),s.wrapText&&(i["white-space"]="normal")}if(t.border){var n=t.border;n.top&&(i["border-top"]="1px solid "+this.IC(n.top.color.rgb)),n.bottom&&(i["border-bottom"]="1px solid "+this.IC(n.bottom.color.rgb)+" !important"),n.left&&(i["border-left"]="1px solid "+this.IC(n.left.color.rgb)),n.right&&(i["border-right"]="1px solid "+this.IC(n.right.color.rgb)+" !important")}return i},kC:function(t){var i=0;for(var e in t){var s=this.config.excelHeader?e-1:e;if(0<=s){var n=this.getIdByIndex(s);this.exists(n)&&(this.getItem(n).$height=t[e],i++)}}return this.config.fixedRowHeight=!i,i},SC:function(t){var i=[];if(this.N.spans&&t&&t.length){this.vl={};for(var e=0;e<t.length;e++)this.config.excelHeader&&t[e][0]--,0<=t[e][0]&&(t[e][0]=this.getIdByIndex(t[e][0]),t[e][1]="data"+t[e][1],i.push(t[e]));return this.addSpan(i),i}return!1}},Ph=(F.protoUI(Eh,Rh.view),{name:"pdfbar",reset:function(){this.setPage(0),this.setValues(0,"auto")},$init:function(t){this.$view.className+=" pdf_bar",t.cols=[{view:"button",type:"icon",css:"webix_transparent",icon:"wxi-angle-left",width:35,click:function(){this.getParentView().Dw("prev")}},{view:"text",width:70,value:"0",on:{onBlur:function(){this.getParentView().Dw(this.getValue())},onKeyPress:function(t){13===t&&this.getParentView().Dw(this.getValue())}}},{template:B.PDFviewer.of+" #limit#",width:70,data:{limit:0},borderless:!0},{view:"button",type:"icon",css:"webix_transparent",icon:"wxi-angle-right",width:35,click:function(){this.getParentView().Dw("next")}},{},{view:"button",type:"icon",css:"webix_transparent",icon:"wxi-minus",width:35,click:function(){this.getParentView().zoom("out")}},{view:"richselect",options:[],maxWidth:195,suggest:{padding:0,css:"pdf_opt_list",borderless:!0,body:{type:{height:25},scroll:!1,yCount:13}},on:{onChange:function(){this.getParentView().setMasterScale(this.getValue())}}},{view:"button",type:"icon",css:"webix_transparent",icon:"wxi-plus",width:35,click:function(){this.getParentView().zoom("in")}},{view:"button",type:"icon",css:"webix_transparent",icon:"wxi-download",width:35,click:function(){this.getParentView().download()}}],this.$ready.push(this.AC)},AC:function(){var t=this.getChildViews()[6].getPopup().getBody(
);t.clearAll(),t.parse([{id:"auto",value:B.PDFviewer.automaticZoom},{id:"page-actual",value:B.PDFviewer.actualSize},{id:"page-fit",value:B.PDFviewer.pageFit},{id:"page-width",value:B.PDFviewer.pageWidth},{id:"page-height",value:B.PDFviewer.pageHeight},{id:"0.5",value:"50%"},{id:"0.75",value:"75%"},{id:"1",value:"100%"},{id:"1.25",value:"125%"},{id:"1.5",value:"150%"},{id:"2",value:"200%"},{id:"3",value:"300%"},{id:"4",value:"400%"}]);var i=0;t.data.each(function(t){i=Math.max(pt(t.value,"webixbutton").width,i)}),this.getChildViews()[6].define("width",i+20),this.getChildViews()[6].resize()},Dw:function(t){this.setMasterPage(t),this.setPage(this.$master.$pageNum)},setScale:function(t){var i=this.getChildViews()[6];i.blockEvent(),i.getPopup().getList().exists(t)?i.setValue(t):(i.setValue(""),i.getInputNode().innerHTML=(100*t).toFixed(0)+"%"),i.unblockEvent()},setMasterScale:function(t){this.$master&&this.$master.setScale(t)},setMasterPage:function(t){this.$master&&("prev"===t?this.$master.prevPage():"next"===t?this.$master.nextPage():isNaN(parseInt(t))||this.$master.renderPage(parseInt(t)))},zoom:function(t){this.$master&&("out"===t?this.$master.zoomOut():"in"===t&&this.$master.zoomIn())},setPage:function(t){this.getChildViews()[1].setValue(t,"auto")},setValues:function(t,i){this.getChildViews()[2].data.limit=t,this.getChildViews()[2].refresh(),this.setScale(i)},download:function(){this.$master&&this.$master.download()}}),jh=(F.protoUI(Ph,nr.view),{name:"pdfviewer",defaults:{scale:"auto"},$init:function(t){this.$view.className+=" webix_pdf";var i=document.createElement("DIV");i.className="canvas_wrapper";var e=document.createElement("canvas");this.TC=this.$view,this.Tt=this.$view.appendChild(i),this.Pe=this.Tt.appendChild(e),this.$pdfDoc=null,this.$pageNum=0,this.$numPages=0,this.FC=!1,this.VC=null,this.zC=this.Pe.getContext("2d"),this.BC=.1,this.HC=t.scaleDelta||1.1,this.RC=t.minScale||.25,this.EC=t.maxScale||10,this.PC=1.25,this.jC=40,this.NC=10,this.Ht=[],this.$ready.push(this.LC)},toolbar_setter:function(t){if("string"==typeof t){var i=si(t);return i&&(i.$master=this,i.refresh()),this.attachEvent("onDocumentReady",function(){i?(i.setPage(this.$pageNum),i.setValues(this.$numPages,this.N.scale)):this.toolbar_setter(t)}),t}},LC:function(){delete this.N.datatype,this.attachEvent("onScaleChange",function(t){this.N.toolbar&&si(this.N.toolbar).setScale&&si(this.N.toolbar).setScale(t)}),this.attachEvent("onPageRender",function(t){this.N.toolbar&&si(this.N.toolbar).setPage&&si(this.N.toolbar).setPage(t)}),St.touch&&(this.OC=!1,Yt(this.zt,St.touch.down,this.WC,{bind:this}),this.attachEvent("onSwipeY",function(t,i){if(!this.OC){var e=this.$view.clientHeight,s=this.$view.scrollHeight,n=this.$view.offsetHeight,r=this.$view.scrollTop,h=i.y-t.y;if(e===s||h<0&&s-n<r||0<h&&0===r){var o=this.$pageNum+(0<h?-1:1);0<o&&o<=this.$numPages&&(this.$pageNum=o,this.UC(this.$pageNum),this.$view.scrollTop=0<h?s:0)}}})),Yt(this.$view,"wheel",function(t){t.ctrlKey&&(ft(t),t.wheelDelta<0?this.zoomOut():this.zoomIn())},{bind:this,passive:!1})},qC:function(t){var i=a(t,2),e=i[0],s=i[1];return Math.sqrt(Math.pow(e.pageX-s.pageX,2)+Math.pow(e.pageY-s.pageY,2))},WC:function(t){var i=this;2===t.touches.length&&(this.OC=this.qC(t.touches),this.YC=[Gt(document.body,St.touch.move,function(t){return i.GC(t)},{passive:!1}),Gt(document,St.touch.up,this.XC,{bind:this})],ft(t))},GC:function(t){if(1<t.touches.length){var i=this.qC(t.touches);150<Math.abs(i-this.OC)&&(i>this.OC?this.zoomIn():this.zoomOut(),this.OC=i),ft(t)}},XC:function(){Xt(this.YC[0]),Xt(this.YC[1]),this.YC=this.OC=!1},$onLoad:function(t){return window.PDFJS?this.KC(t):Dt([St.cdn+"/extras/pdfjs/compatibility.min.js",St.cdn+"/extras/pdfjs/pdf.min.js"],function(){PDFJS.workerSrc=St.cdn+"/extras/pdfjs/pdf.worker.min.js",this.KC(t)},this),!0},KC:function(t){if(t.name){var i=new FileReader;i.onload=k(function(t){this.KC({data:t.target.result})},this),i.readAsArrayBuffer(t)}else this.JC({data:t.data})},JC:function(i){var e=this;return PDFJS.getDocument({data:i.data,password:i.password}).then(function(t){
e.clear(),e.$pdfDoc=t,e.$numPages=e.$pdfDoc.numPages,e.$pageNum=1,e.ZC(e.$pageNum).then(function(){e.callEvent("onDocumentReady")})},function(t){"PasswordException"==t.name&&e.QC(i)})},getPopup:function(){var e=this;return this.t$||(this.t$=Qt({view:"window",position:"center",modal:!0,head:B.PDFviewer.enterPassword,body:{view:"form",elements:[{view:"text",name:"password",type:"password",invalidMessage:B.PDFviewer.passwordError,required:!0},{cols:[{view:"button",value:B.message.cancel,hotkey:"esc",click:function(){e.getPopup().hide()}},{view:"button",css:"webix_primary",value:B.message.ok,hotkey:"enter",click:function(){var t=e.getPopup(),i=t.getBody();i.validate()?(e.JC({data:e.i$,password:i.getValues().password}),t.hide()):i.focus()}}]}]},on:{onHide:function(){var t=e.getPopup().getBody();t.clear("auto"),t.clearValidation(),delete e.i$}}}),this.Ht.push(this.t$)),this.t$},QC:function(t){var i=this.getPopup(),e=i.getBody();this.i$=t.data,t.password&&(e.markInvalid("password"),e.setValues({password:t.password},!1,"auto")),i.show(),e.focus()},e$:function(t,i){var e=t.getViewport(i);return this.Pe.height=e.height,this.Pe.width=e.width,this.Tt.style.width=e.width+"px",this.Tt.style.height=e.height+"px",e},ZC:function(t){var n=this;return this.FC=!0,this.$pdfDoc.getPage(t).then(function(t){var i=isNaN(parseFloat(n.N.scale))?n.BC:n.N.scale,e=n.e$(t,i);i!==n.N.scale&&(i=n.s$(n.N.scale),e=n.e$(t,i),n.N.scale=i);var s={canvasContext:n.zC,viewport:e};return t.cleanupAfterRender=!0,t.render(s).promise.then(function(){n.callEvent("onPageRender",[n.$pageNum]),n.FC=!1,null!==n.VC&&(n.ZC(n.VC),n.VC=null)})})},UC:function(t){this.FC?this.VC=t:this.ZC(t)},renderPage:function(t){!this.$pdfDoc||t<=0||t>this.$numPages||(this.$pageNum=t,this.UC(this.$pageNum))},prevPage:function(){this.$pageNum<=1||(this.$pageNum--,this.UC(this.$pageNum))},nextPage:function(){this.$pageNum>=this.$numPages||(this.$pageNum++,this.UC(this.$pageNum))},zoomIn:function(){var t=this.N.scale;t=(t*this.HC).toFixed(2),t=Math.ceil(10*t)/10,t=Math.min(this.EC,t),this.setScale(t)},zoomOut:function(){var t=this.N.scale;t=(t/this.HC).toFixed(2),t=Math.floor(10*t)/10,t=Math.max(this.RC,t),this.setScale(t)},s$:function(t){if(!isNaN(parseFloat(t)))return t;isNaN(parseFloat(this.N.scale))&&(this.N.scale=this.BC);var i=1,e=((this.TC.clientWidth-this.jC)*this.N.scale/this.Pe.clientWidth).toFixed(2),s=((this.TC.clientHeight-this.NC)*this.N.scale/this.Pe.clientHeight).toFixed(2);switch(t){case"page-actual":i=1;break;case"page-width":i=e;break;case"page-height":i=s;break;case"page-fit":i=Math.min(e,s);break;case"auto":var n=this.TC.clientWidth>this.TC.clientHeight?Math.min(s,e):e;i=Math.min(this.PC,n)}return i},setScale:function(t){if(isNaN(parseFloat(t))){var i=this.s$(t);this.n$(i)}else this.n$(t)},n$:function(t){this.N.scale=t,this.renderPage(this.$pageNum),this.callEvent("onScaleChange",[t])},download:function(){if(this.$pdfDoc){var i=(this.N.downloadName||"document")+".pdf";this.$pdfDoc.getData().then(function(t){bt(PDFJS.createBlob(t,"application/pdf"),i)})}},clear:function(){this.$pdfDoc&&(this.zC.clearRect(0,0,this.Pe.width,this.Pe.height),this.Tt.style.height=this.Tt.style.width=this.Pe.width=this.Pe.height=0,this.N.scale="auto",this.$pageNum=this.$numPages=0,this.$pdfDoc.transport.startCleanup(),this.$pdfDoc.destroy(),this.$pdfDoc=null,this.N.toolbar&&si(this.N.toolbar)&&si(this.N.toolbar).reset())}}),Nh=(F.protoUI(jh,p,Ft,Gi.view),{name:"video",$init:function(t){t.id||(t.id=z()),this.$ready.push(this.r$)},r$:function(){var t=this.N;if(this.qi=st("video",{"class":"webix_view_video",style:"width:100%;height:100%;",autobuffer:"autobuffer"},""),t.poster&&(this.qi.poster=t.poster),t.src){"object"!=M(t.src)&&(t.src=[t.src]);for(var i=0;i<t.src.length;i++)this.qi.innerHTML+=' <source src="'+t.src[i]+'">'}t.controls&&(this.qi.controls=!0),t.autoplay&&(this.qi.autoplay=!0),this.zt.appendChild(this.qi)},getVideo:function(){return this.qi},defaults:{src:"",controls:!0}}),Lh=(F.protoUI(Nh,Gi.view),{name:"gage",defaults:{value:0,minRange:0,maxRange:100,minWidth:250,minHeight:200,
smoothFlow:!0,scale:3,stroke:7},$init:function(){this.$ready.push(k(this.h$,this)),this.attachEvent("onDestruct",function(){this.o$=this.a$=this.u$=null})},$setSize:function(t,i){Gi.api.$setSize.call(this,t,i)&&this.c$()},c$:function(){this.f$=this.config.value;var t=this.$view.querySelector(".webix_gage_curves"),i=this.$view.querySelector(".webix_gage_info"),e=this.config.scale,s=Math.min(this.$width,this.$height),n=s/100*this.config.stroke,r=s/e;t.setAttribute("r",r),t.setAttribute("strokeDasharray",Math.round(Math.PI*r)),t.style.r=r,t.style.strokeDasharray=Math.round(Math.PI*r),t.style["stroke-width"]=n+"px",i.setAttribute("style","width: "+Math.round(2*r)+"px;"),this.u$.setAttribute("style","height: "+Math.round(r+n)+"px;"),this.o$.setAttribute("r",r),this.o$.setAttribute("style","stroke-dasharray: "+Math.round(this.gradientLength*Math.PI*r)+", 1900; stroke-width:"+n+"px"),this.l$(r),this.d$()},xg:function(t){return Math.min(Math.max(t,this.N.minRange),this.N.maxRange)},l$:function(t){var i=this.$width,e=Math.min(this.$width,this.$height)/100*this.config.stroke;this.a$.style.transformOrigin=i/2+"px 0 0",this.a$.setAttribute("y1","0"),this.a$.setAttribute("x1",Math.round(i)/2+e),this.a$.setAttribute("y2","0"),this.a$.setAttribute("x2",Math.round((i+e)/2+t))},d$:function(){var t=this.config.value,i=this.$view.querySelector(".webix_gage_value"),e=this.xg(t)-this.config.minRange,s=Math.round(180*e/(this.config.maxRange-this.config.minRange)),n=Math.min(this.$width,this.$height);this.$view.style.fontSize=Math.floor(n/8)+"px",i.innerHTML=t,this.o$.style.stroke=this.color,this.o$.setAttribute("stroke",this.color),this.a$.setAttribute("transform","rotate("+s+" "+this.$width/2+" 0)"),this.a$.style.transform="rotate("+s+"deg)"},v$:function(){this.config.minRange,this.config.maxRange,this.gradientLength=(this.xg(this.config.value)-this.config.minRange)/(this.config.maxRange-this.config.minRange);var t=this.config.color;this.color=t?"function"==typeof t?t.call(this,this.config.value):t:"hsl("+(120-Math.round(120*this.gradientLength))+", 100%, 50%)",!0===this.config.animation?this.defaultColor="hsl(125, 100%, 50%)":this.defaultColor="hsl("+(120-Math.round(120*this.gradientLength))+", 100%, 50%)"},h$:function(){var t=this.config.smoothFlow&&St.svganimation&&!St.isEdge;this.gradientLength=0,this.v$(),this.$view.innerHTML='<div class="webix_gage_box"><div>\n\t\t\t<div class="webix_gage_label"><span>'.concat(this.config.label||"",'</span></div>\n\t\t\t<svg class="webix_gage_body" style="height:300px; position: relative;">\n\t\t\t\t<circle class="webix_gage_curves" r="0" cx="50%" cy="0" stroke="#EEEEEE" fill="none"></circle>\n\t\t\t\t<circle class="webix_gage_gradient').concat(t?" webix_gage_animated":"",'" r="0" stroke=').concat(this.defaultColor,' cx="50%" cy="0" fill="none" style="stroke-dasharray: 0, 1900;"></circle>\n\t\t\t\t<line class="webix_gage_gradient_point').concat(t?" webix_gage_gradient_point_animated":"",'" x1="0" x2="0" y1="0" y2="0" style="stroke:#B0B0B0; stroke-width:4;"></line>\n\t\t\t</svg>\n\t\t\t<div class="webix_gage_info">\n\t\t\t\t<div class="webix_gage_min_range">').concat(this.config.minRange,'</div>\n\t\t\t\t<div class="webix_gage_max_range">').concat(this.config.maxRange,'</div>\n\t\t\t\t<div class="webix_gage_placeholder">\n\t\t\t\t\t<div class="webix_gage_value">').concat(this.config.value,'</div>\n\t\t\t\t\t<div class="webix_gage_range_info">').concat(this.config.placeholder||"","</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div></div>"),this.o$=this.$view.querySelector(".webix_gage_gradient"),this.a$=this.$view.querySelector(".webix_gage_gradient_point"),this.u$=this.$view.querySelector(".webix_gage_body")},refresh:function(){var t=this.config.value;this.config.smoothFlow&&t!=this.f$&&(this.config.value=this.f$),this.h$(),this.c$(),this.f$!=t&&this.zt.parentNode.clientHeight&&this.setValue(t)},setValue:function(t){this.config.value=t,this.v$(),this.c$()},getValue:function(){return this.config.value}}),Oh=(F.protoUI(Lh,p,Gi.view),{name:"barcode",defaults:{type:"ean13",height:160,width:220,paddingY:10,
paddingX:20,textHeight:20,color:"#000",ariaLabel:"bars"},$init:function(){this.$view.className+=" webix_barcode",this.types||(this.types={"default":this.type},this.type.name="default")},type:{},render:function(){this.isVisible(this.N.id)&&(this.canvas&&this.canvas.clearCanvas(!0),this.$view.innerHTML="",this._$())},_$:function(){this.canvas=new Zi({container:this.$view,name:this.name,title:this.N.ariaLabel,width:this.$width,height:this.$height}),this.p$()},p$:function(){var t,i,e,s,n=this.N.value,r=this.N.type;if(!r||!this.types[r]||!n)return!1;if(s=(t=this.type.encode(n)).length,i=this.canvas.getCanvas(),s){var h=(this.$width-2*this.config.paddingX)/s,o=0;for(e=0;e<s;e++){parseInt(t.charAt(e),10)?(o++,e==s-1&&this.b$(i,e+1,h,o,s)):o&&(this.b$(i,e,h,o,s),o=0)}this.m$(n,h)}},b$:function(t,i,e,s,n){var r,h,o,a;h=parseInt(i*e+this.config.paddingX,10),r=parseInt(h-s*e,10),o=this.config.paddingY,a=this.$height-this.config.paddingY-this.config.textHeight,this.g$()&&(i<4||n-4<i||i<n/2+2&&n/2-2<i)&&(a+=this.config.textHeight/2),t.fillStyle=this.config.color,t.beginPath(),t.moveTo(r,o),t.lineTo(h,o),t.lineTo(h,a),t.lineTo(r,a),t.lineTo(r,o),t.fill()},m$:function(t,i){var e,s,n;if(this.type.template&&(t=this.type.template(t)),this.g$()){if(this.type.firstDigit&&(this.canvas.renderTextAt(!0,"left",this.config.paddingX,this.$height-this.config.paddingY,t.charAt(0)),t=t.slice(1)),s=t.length,this.type.lastDigit&&s--,s){var r=(this.$width-2*this.config.paddingX-11*i)/s;for(e=0;e<s;e++)n=this.config.paddingX+e*r+(e<s/2?3:8)*i+r/2,this.canvas.renderTextAt(!0,!0,n,this.$height-this.config.paddingY,t.charAt(e));this.type.lastDigit&&(n=this.config.paddingX+s*r+11*i,this.canvas.renderTextAt(!0,!1,n,this.$height-this.config.paddingY,t.charAt(s)))}}else this.canvas.renderTextAt(!0,!0,this.$width/2,this.$height-this.config.paddingY,t)},setValue:function(t){this.N.value=t,this.render()},getValue:function(){var t=this.N.value;return this.type.template?this.type.template(t):t},type_setter:function(t){return this.types[t]?(this.type=l(this.types[t]),this.type.css&&(this.qi.className+=" "+this.type.css)):this.customize(t),t},g$:function(){var t=this.config.type;return 0===t.indexOf("ean")||-1!=t.indexOf("upcA")},$setSize:function(t,i){Gi.api.$setSize.call(this,t,i)&&this.render()}}),Wh=F.protoUI(Oh,Gi.view);Kt(Wh,{name:"upcA",firstDigit:!0,lastDigit:!0,encode:function(t){return t.length<12&&(t="0"+t),Uh.encode(t)},template:function(t){return t.replace(/[^0-9]/g,"").substring(0,11)+this.checksum(t)},checksum:function(t){return t.length<12&&(t="0"+t),Uh.checksum(t)}}),Kt(Wh,{name:"ean8",encodings:[["0001101","1110010"],["0011001","1100110"],["0010011","1101100"],["0111101","1000010"],["0100011","1011100"],["0110001","1001110"],["0101111","1010000"],["0111011","1000100"],["0110111","1001000"],["0001011","1110100"]],encode:function(t){var i,e;if(7!=(t=t.replace(/[^0-9]/g,"").substring(0,7)).length)return"";for(t+=this.checksum(t),i="101",e=0;e<4;e++)i+=this.encodings[parseInt(t.charAt(e),10)][0];for(i+="01010",e=4;e<8;e++)i+=this.encodings[parseInt(t.charAt(e),10)][1];return i+="101"},template:function(t){return t.replace(/[^0-9]/g,"").substring(0,7)+this.checksum(t)},checksum:function(t){t=t.substring(0,7);var i,e=!0,s=0;for(i=0;i<7;i++)s+=(e?3:1)*parseInt(t.charAt(i),10),e=!e;return((10-s%10)%10).toString()}});var Uh={name:"ean13",firstDigit:!0,encodings:[["0001101","0100111","1110010","000000"],["0011001","0110011","1100110","001011"],["0010011","0011011","1101100","001101"],["0111101","0100001","1000010","001110"],["0100011","0011101","1011100","010011"],["0110001","0111001","1001110","011001"],["0101111","0000101","1010000","011100"],["0111011","0010001","1000100","010101"],["0110111","0001001","1001000","010110"],["0001011","0010111","1110100","011010"]],encode:function(t){var i,e,s;if(12!=(t=t.replace(/[^0-9]/g,"").substring(0,12)).length)return"";for(t+=this.checksum(t),i="101",e=this.encodings[parseInt(t.charAt(0),10)][3],s=1;s<7;s++)i+=this.encodings[parseInt(t.charAt(s),10)][parseInt(e.charAt(s-1),10)];for(i+="01010",s=7;s<13;s++
)i+=this.encodings[parseInt(t.charAt(s),10)][2];return i+="101"},template:function(t){return t.replace(/[^0-9]/g,"").substring(0,12)+this.checksum(t)},checksum:function(t){var i,e=!1,s=0;for(t=t.substring(0,12),i=0;i<12;i++)s+=(e?3:1)*parseInt(t.charAt(i),10),e=!e;return((10-s%10)%10).toString()}};Kt(Wh,Uh);var qh,Yh,Gh,Xh,Kh={name:"bullet",defaults:{color:"#394646",marker:!1,layout:"x",barWidth:40,flowTime:500,labelWidth:150,minRange:0,maxRange:100,stroke:8,value:0,smoothFlow:!0,tickSize:10,bands:[{value:100,color:"#5be5d6"},{value:80,color:"#fff07e"},{value:60,color:"#fd8b8c"}],scale:{step:10}},label_setter:Lt,placeholder_setter:Lt,$init:function(t){var i="undefined"!=typeof t.tickSize?t.tickSize:this.defaults.tickSize;t&&(t.layout&&"x"!==t.layout||!V(t.height)||(t.height=!1===t.scale?60:i?76+i:74),"y"===t.layout&&V(t.width)&&(t.width=!1===t.scale?60:i?87+i:87))},scale_setter:function(t){return t&&(t.step=t.step||10,t.template=Lt(t.template||"#value#")),t},$setSize:function(t,i){Gi.api.$setSize.call(this,t,i)&&(this.h$("y"===this.N.layout?i:t),(this.N.value||0===this.N.value)&&this.d$(0,this.N.value))},xg:function(t){return Math.min(Math.max(t,this.N.minRange),this.N.maxRange)-this.N.minRange},w$:function(t){var i;this.x$=t-(this.cs||t),this.cs=t,(1e3<(i=this.N.flowTime>this.x$?this.N.flowTime/this.x$:this.N.flowTime)||i<5)&&(i=30);var e=(this.N.value-this.y$)/i;this.M$+=e,Math.abs(this.M$-this.N.value)<Math.abs(e)&&(this.M$=this.N.value),this.M$!=this.N.value?this.S$=requestAnimationFrame(this.w$.bind(this)):(cancelAnimationFrame(this.S$),this.S$=null),this.k$.setAttribute("width",Math.floor(this.xg(this.M$)*this.C$)),this.k$.style.fill=this["if"]()},d$:function(t,i){this.y$=this.M$=t,this.N.value=this.f$=i,!0===this.isVisible()&&!0===this.N.smoothFlow&&window.requestAnimationFrame?this.S$||(this.S$=requestAnimationFrame(this.w$.bind(this))):(this.k$.setAttribute("width",Math.floor(this.xg(i)*this.C$)),this.k$.style.fill=this["if"]())},"if":function(){var t=this.N.color;return"function"==typeof t?t(this.f$):t},D$:function(t,i,e){for(var s=0;s<i.length;s++)t.setAttribute(i[s],e[s])},I$:function(t,i,e){var s=document.createElementNS("http://www.w3.org/2000/svg",t);return i&&this.D$(s,i,e),s},A$:function(t){var i=this.I$(t[0],t[1],t[2]),e=t[3];if(e)for(var s=0;s<e.length;s++)i.appendChild(this.A$(e[s]));return i},T$:function(){var t="d"+z(),i=this.I$("svg",["class"],["webix_bullet_graph_svg"]),e=this.I$("g"),s=this.I$("g"),n=this.I$("rect",["x","y","width","height","class","style"],[this.F$,this.V$,100,this.N.stroke,"webix_bullet_value","filter:url(#"+t+");fill:"+this["if"]()]),r=this.I$("rect",["x","y","width","height","fill"],[0,5,3,this.N.barWidth-10,"rgba(0,0,0,0.5)"]),h=this.I$("g",["stroke","stroke-width","fill"],["#8b94ac","2","none"]),o=this.I$("text",["text-anchor","stroke","fill"],["end","none","#8b94ac"]),a="y"==this.N.layout?"50%":this.F$-10,u="y"==this.N.layout?11:17,c=this.I$("tspan",["x","y","class"],[a,u,"webix_bullet_header"]),f=this.I$("tspan",["x","y","class"],[a,u+17,"webix_bullet_subheader"]),l=this.I$("text",["text-anchor","stroke","class","fill"],["middle","none","webix_bullet_scale","#8b94ac"]),d=this.A$(["filter",["id","x","y","width","height"],[t,"0","-150%","110%","400%"],[["feOffset",["in","dx","dy"],["SourceAlpha",0,0]],["feGaussianBlur",["stdDeviation"],["2"]],["feComponentTransfer",0,0,[["feFuncA",["type","slope"],["linear","0.5"]]]],["feMerge",0,0,[["feMergeNode"],["feMergeNode",["in"],["SourceGraphic"]]]]]]);i.appendChild(d);var v=document.createElement("div");e.appendChild(s),!1!==this.N.marker&&(r.setAttribute("x",this.F$+this.xg(this.N.marker)*this.C$-2),e.appendChild(r)),e.appendChild(n),o.appendChild(c),o.appendChild(f),i.appendChild(o);var _="y"===this.N.layout,p=this.N.tickSize;if(this.N.scale){for(var b=this.F$,m=this.N.minRange;m<=this.N.maxRange;m+=this.N.scale.step){var g=Math.max(m-this.N.minRange,0),w=Math.floor(g*this.C$-(g?.1:-1)),x=_?(this.$width-this.N.barWidth)/2+(p?2-p:4):w+b,y=_?this.z$+b-w+6:this.N.barWidth+(p?16+p:14),M=_?-4:this.N.barWidth+3+p,S=_?"end":"middle",
k=this.I$("tspan",["x","y","text-anchor"],[x,y,S]),C=this.I$("line",["x1","y1","x2","y2","stroke-width"],[w+b,M,w+b,M-p,1]);v.innerHTML=this.N.scale.template({value:m}),k.appendChild(v.childNodes[0]),l.appendChild(k),h.appendChild(C)}e.appendChild(h),i.appendChild(l)}for(var $=0;$<this.N.bands.length;$++){var D=this.N.bands[$],I=this.I$("path"),A=this.xg(D.value)*this.C$;I.setAttribute("d","M "+this.F$+",0 l "+A+",0 l 0,"+this.N.barWidth+" l -"+A+",0 z"),I.setAttribute("fill",D.color),s.appendChild(I)}if(i.appendChild(e),"y"===this.N.layout){var T=this.N.scale?this.$width/2-10:0,F=this.$height+this.F$-28;e.setAttribute("transform","translate("+T+", "+F+") rotate(270)"),o.setAttribute("text-anchor","middle"),o.childNodes[0].setAttribute("x","55%"),o.childNodes[1].setAttribute("x","55%"),l.setAttribute("text-anchor","right")}return i.setAttribute("viewBox","0 0 "+this.$width+" "+this.$height),i},h$:function(t){this.config.minRange,this.config.maxRange,t=t||("x"==this.N.layout?this.$width:this.$height);var i=this.$view;i.innerHTML="";var e=this.N,s=e.label&&e.label(e)||e.placeholder&&e.placeholder(e);this.F$=s?e.labelHeight||e.labelWidth:7,this.V$=Math.floor((this.N.barWidth-this.N.stroke)/2),this.z$=t-this.F$-30,this.C$=this.z$/(this.N.maxRange-this.N.minRange);var n=this.T$();n.setAttribute("height",this.$height),n.setAttribute("width",this.$width),i.appendChild(n),this.k$=i.querySelector(".webix_bullet_value");var r=this.N.label;r&&(this.$view.querySelector(".webix_bullet_header").textContent=r(this.N));var h=this.N.placeholder;h&&(this.$view.querySelector(".webix_bullet_subheader").textContent=h(this.N))},refresh:function(){this.h$(),this.d$(this.f$,this.N.value)},setValue:function(t){this.N.value!=t&&this.d$(this.N.value,t)},getValue:function(){return this.N.value}},Jh=(F.protoUI(Kh,Gi.view),{name:"geochart",defaults:{chart:{displayMode:"auto",region:"world",resolution:"countries"}},$init:function(t){this.$view.innerHTML="<div class='webix_map_content' style='width:100%;height:100%'></div>",this.qi=this.$view.firstChild,this.B$=b.defer(),t.chart=F.extend(t.chart||{},this.defaults.chart),this.data.provideApi(this,!0),this.$ready.push(this.render),this.data.attachEvent("onClearAll",k(this.H$,this)),this.data.attachEvent("onStoreUpdated",k(this.R$,this))},getMap:function(t){return t?this.B$:this.wu},E$:function(t){return k(function(){"function"==typeof t&&t(),qh=qh||window.google,this.P$()},this)},render:function(){"undefined"==typeof window.google||"undefined"==typeof window.google.charts?(Yh||((Yh=document.createElement("script")).type="text/javascript",Yh.src="//www.gstatic.com/charts/loader.js",document.getElementsByTagName("head")[0].appendChild(Yh)),Yh.onload=this.E$(Yh.onload)):this.E$()()},P$:function(){qh.visualization&&qh.visualization.GeoChart?(this.wu=new qh.visualization.GeoChart(this.qi),this.j$(),this.B$.resolve(this.wu)):(qh.charts.load("current",{packages:["geochart"],mapsApiKey:this.N.key}),qh.charts.setOnLoadCallback(k(function(){this.P$()},this)))},$onLoad:function(t){return!this.wu&&(this.B$.then(k(function(){this.parse(t,this.N.datatype)},this)),!0)},R$:function(){if(this.wu){var n=this.ll&&this.ll.length?this.ll:this.N$(),r=[];if(this.data.each(function(t){for(var i=[],e=0;e<n.length;e++){var s=t[n[e].label];"number"==n[e].type?s*=1:"tooltip"==n[e].role&&(s=this.N.tooltip(t)),i.push(s)}r.push(i)},this),n.length){for(var t=new qh.visualization.DataTable,i=0;i<n.length;i++)t.addColumn(n[i]);t.addRows(r);var e=new qh.visualization.DataView(t);this.wu.draw(e,this.N.chart)}else this.wu.draw(qh.visualization.arrayToDataTable([["",""]]),{})}else this.wu||this.B$.then(k(this.R$,this))},setDisplayMode:function(t){this.N.chart.displayMode=t,this.refresh()},setRegion:function(t){this.N.chart.region=t,this.refresh()},refresh:function(){this.wu.clearChart(),this.R$()},tooltip_setter:function(t){var i=this.N.chart.tooltip;return this.N.chart.tooltip=F.extend(i||{},{isHtml:!0}),Lt(t)},$setSize:function(t,i){Gi.api.$setSize.apply(this,arguments)&&this.wu&&(F.extend(this.N,{width:t,height:i}),this.refresh())},
H$:function(){this.ll=null,this.R$()},L$:function(t,i){if(!t||V(t[i]))return"string";var e=M(t[i]);return"string"!=e||isNaN(1*t[i])||(e="number"),e},N$:function(){var t=this.N.columns||[],i=this.data.pull[this.data.order[0]];if(!t.length&&i)for(var e in i)"id"!==e&&t.push(e);for(var s=0;s<t.length;s++)"object"!==M(t[s])&&(t[s]={type:this.L$(i,t[s]),label:t[s]});return this.N.tooltip&&t.push({type:"string",role:"tooltip",p:{html:!0}}),this.ll=t},j$:function(){qh.visualization.events.addListener(this.wu,"error",k(function(){this.callEvent("onMapError",arguments)},this)),qh.visualization.events.addListener(this.wu,"ready",k(function(){this.callEvent("onMapReady",arguments)},this)),qh.visualization.events.addListener(this.wu,"regionClick",k(function(){this.callEvent("onRegionClick",arguments)},this)),qh.visualization.events.addListener(this.wu,"select",k(function(){var t=this.wu.getSelection()[0],i=t||this.O$;if(i){var e=this.data.order[i.row];this.O$=i,this.callEvent("onItemClick",[e,!!t])}},this))}}),Zh=(F.protoUI(Jh,ke,p,Gi.view),{name:"google-map",$init:function(){this.$view.innerHTML="<div class='webix_map_content' style='width:100%;height:100%'></div>",this.qi=this.$view.firstChild,this.B$=b.defer(),this.data.provideApi(this,!0),this.$ready.push(this.render)},getMap:function(t){return t?this.B$:this.wu},E$:function(t){return k(function(){"function"==typeof t&&t(),Gh=Gh||window.google,this.P$.call(this)},this)},render:function(){if("undefined"==typeof window.google||"undefined"==typeof window.google.maps){if(!Xh){(Xh=document.createElement("script")).type="text/javascript";var t=this.N,i=t.src||"//maps.google.com/maps/api/js";i+=-1===i.indexOf("?")?"?":"&",t.key&&(i+="&key="+t.key),t.libraries&&(i+="&libraries="+t.libraries),Xh.src=i,document.getElementsByTagName("head")[0].appendChild(Xh)}Xh.onload=this.E$(Xh.onload)}else this.E$()()},P$:function(){var t=this.config;this.isVisible(t.id)&&(this.wu=new Gh.maps.Map(this.qi,{zoom:t.zoom,center:new Gh.maps.LatLng(t.center[0],t.center[1]),mapTypeId:Gh.maps.MapTypeId[t.mapType]}),this.B$.resolve(this.wu),this.qi.firstChild.setAttribute("webix_disable_drag","true"))},center_setter:function(t){return this.wu&&this.wu.setCenter(new Gh.maps.LatLng(t[0],t[1])),t},mapType_setter:function(t){return this.wu&&this.wu.setMapTypeId(Gh.maps.MapTypeId[t]),t},zoom_setter:function(t){return this.wu&&this.wu.setZoom(t),t},layerType_setter:function(t){return"heatmap"==t&&(this.config.libraries="visualization"),this.W$[t]&&(F.extend(this,this.W$[t],!0),this.data.attachEvent("onStoreUpdated",k(function(){this.B$.then(k(function(){this.drawData.call(this,arguments)},this))},this))),t},defaults:{zoom:5,center:[39.5,-98.5],mapType:"ROADMAP",layerType:"marker"},$setSize:function(){Gi.api.$setSize.apply(this,arguments),this.wu&&Gh.maps.event.trigger(this.wu,"resize")},$onLoad:function(t){return!this.wu&&(this.B$.then(k(function(){this.parse(t)},this)),!0)},W$:{marker:{drawData:function(t,i,e){switch(e){case"add":case"update":i.$marker=this.U$(i);break;case"delete":i.$marker.setMap(null);break;default:this.data.each(function(t){t.$marker=this.U$(t)},this)}},clearAll:function(t){this.data.each(function(t){t.$marker.setMap(null)}),this.data.clearAll(t)},showItem:function(t){var i=this.getItem(t);this.wu.setCenter(new Gh.maps.LatLng(i.lat,i.lng))},U$:function(t){var i={};for(var e in t)i[e]=t[e];i.position=new Gh.maps.LatLng(t.lat,t.lng),i.map=t.hidden?null:this.wu;var s=t.$marker;return s?t.$marker.setMap(i.map):(s=new Gh.maps.Marker(i),this.Mt(s)),this.callEvent("onItemRender",[t]),s},Mt:function(t){var i=this;t.addListener("click",function(){i.callEvent("onItemClick",[this.id,this])}),t.getDraggable()&&(t.addListener("dragend",function(){i.q$(this,!0)}),t.addListener("drag",function(){i.q$(this)}))},q$:function(t,i){var e=this.getItem(t.id),s=t.getPosition(),n=i?"onAfterDrop":"onDrag";e.lat=s.lat(),e.lng=s.lng(),this.callEvent(n,[e.id,e])}},heatmap:{heatmapConfig_setter:function(t){return t=t||{}},drawData:function(){this.Y$&&(this.Y$.setMap(null),this.Y$=null);var i=[];if(this.data.each(function(t){
i.push(this.G$(t))},this),i.length){var t=F.extend(this.config.heatmapConfig,{data:i,map:this.wu},!0);this.Y$=new Gh.maps.visualization.HeatmapLayer(t),this.callEvent("onHeatMapRender",[this.Y$])}},getHeatmap:function(){return this.Y$},G$:function(t){var i={};for(var e in t)i[e]=t[e];return i.location=new Gh.maps.LatLng(t.lat,t.lng),i}}}}),Qh=(F.protoUI(Zh,ke,p,Gi.view),{$render_pie:function(t,i,e,s,n,r){this.X$(t,i,e,s,1,r,n)},X$:function(t,i,e,s,n,r,h){if(i.length){var o=this.K$(e,s),a=this.N.radius?this.N.radius:o.radius;if(!(a<0)){var u=this.J$(i),c=this.nf(u),f=this.sf(u,c),l=this.N.x?this.N.x:o.x,d=this.N.y?this.N.y:o.y;1==n&&this.N.shadow&&this.Z$(t,l,d,a),d/=n;var v,_=-Math.PI/2,p=[];if(t.scale(1,n),this.N.gradient){var b=1!=n?l+a/3:l,m=1!=n?d+a/3:d;this.Q$(t,l,d,a,b,m)}for(var g=0;g<i.length;g++)if(u[g]){t.strokeStyle=this.N.lineColor.call(this,i[g]),t.beginPath(),t.moveTo(l,d),p.push(_);var w=-Math.PI/2+f[g]-1e-4;t.arc(l,d,a,_,w,!1),t.lineTo(l,d);var x=this.N.color.call(this,i[g]);t.fillStyle=x,t.fill(),this.N.pieInnerText&&this.tD(l,d,5*a/6,_,w,n,this.N.pieInnerText(i[g],c),!0),this.N.label&&this.tD(l,d,a+this.N.labelOffset,_,w,n,this.N.label(i[g])),1!=n&&(this.iD(t,l,d,_,w,a,!0),t.fillStyle="#000000",t.globalAlpha=.2,this.iD(t,l,d,_,w,a,!1),t.globalAlpha=1,t.fillStyle=x),r.addSector(i[g].id,_,w,l-e.x,d-e.y/n,a,n,h),_=w}for(t.globalAlpha=.8,g=0;g<p.length;g++)v=this.hf(p[g],l,d,a),this.eD(t,l,d,v.x,v.y,this.N.lineColor.call(this,i[g]),2);(t.globalAlpha=1)==n&&this.N.border&&(t.lineWidth=this.N.borderWidth||2,t.strokeStyle=this.N.borderColor?this.N.borderColor.call(this):"#ffffff",t.beginPath(),t.arc(l,d,a+1,0,2*Math.PI,!1),t.stroke()),t.scale(1,1/n)}}},J$:function(t){for(var i=[],e=0;e<t.length;e++)i.push(Math.abs(parseFloat(this.N.value(t[e]))||0));return i},nf:function(t){for(var i=0,e=0;e<t.length;e++)i+=t[e];return i},sf:function(t,i){var e,s=[],n=0;i=i||this.nf(t);for(var r=0;r<t.length;r++)e=t[r],s[r]=2*Math.PI*(i?(e+n)/i:1/t.length),n+=e;return s},K$:function(t,i){var e=i.x-t.x,s=i.y-t.y;return{x:t.x+e/2,y:t.y+s/2,radius:Math.min(e/2,s/2)}},iD:function(t,i,e,s,n,r,h){if(t.lineWidth=1,s<=0&&0<=n||0<=s&&n<=Math.PI||.003<Math.abs(s-Math.PI)&&s<=Math.PI&&n>=Math.PI){s<=0&&0<=n&&(s=0,h=!1,this.sD(t,i,e,r,s,n)),s<=Math.PI&&n>=Math.PI&&(n=Math.PI,h=!1,this.sD(t,i,e,r,s,n));var o=(this.N.pieHeight||Math.floor(r/4))/this.N.cant;t.beginPath(),t.arc(i,e,r,s,n,!1),t.lineTo(i+r*Math.cos(n),e+r*Math.sin(n)+o),t.arc(i,e+o,r,n,s,!0),t.lineTo(i+r*Math.cos(s),e+r*Math.sin(s)),t.fill(),h&&t.stroke()}},sD:function(t,i,e,s,n,r){t.beginPath(),t.arc(i,e,s,n,r,!1),t.stroke()},Z$:function(t,i,e,s){t.globalAlpha=.5;for(var n=["#c4c4c4","#c6c6c6","#cacaca","#dcdcdc","#dddddd","#e0e0e0","#eeeeee","#f5f5f5","#f8f8f8"],r=n.length-1;-1<r;r--)t.beginPath(),t.fillStyle=n[r],t.arc(i+1,e+1,s+r,0,2*Math.PI,!0),t.fill();t.globalAlpha=1},nD:function(t){return t.addColorStop(0,"#ffffff"),t.addColorStop(.7,"#7a7a7a"),t.addColorStop(1,"#000000"),t},Q$:function(t,i,e,s,n,r){var h;t.beginPath(),h="function"!=typeof this.N.gradient?(h=t.createRadialGradient(n,r,s/4,i,e,s),this.nD(h)):this.N.gradient(h),t.fillStyle=h,t.arc(i,e,s,0,2*Math.PI,!0),t.fill(),t.globalAlpha=.7},tD:function(t,i,e,s,n,r,h,o){var a=this.canvases[0].renderText(0,0,h,0,1);if(a){var u=a.scrollWidth;a.style.width=u+"px",t<u&&(u=t);var c=n-s<.2?4:8;o&&(c=u/1.8);var f=s+(n-s)/2;e-=(c-8)/2;var l=-c,d="right";(f>=Math.PI/2&&f<Math.PI||f<=3*Math.PI/2&&f>=Math.PI)&&(l=-u-l+1,d="left");var v=0;!o&&r<1&&0<f&&f<Math.PI&&(v=(this.N.height||Math.floor(e/4))/r);var _=(i+Math.floor((e+v)*Math.sin(f)))*r-8,p=t+Math.floor((e+c/2)*Math.cos(f))+l,b=n<Math.PI/2+.01,m=s<Math.PI/2;m&&b?p=Math.max(p,t+3):m||b?!o&&(f>=Math.PI/2&&f<Math.PI||f<=3*Math.PI/2&&f>=Math.PI)&&(p+=u/3):p=Math.min(p,t-u),a.style.top=_+"px",a.style.left=p+"px",a.style.width=u+"px",a.style.textAlign=d,a.style.whiteSpace="nowrap"}},$render_pie3D:function(t,i,e,s,n,r){this.X$(t,i,e,s,this.N.cant,r)},$render_donut:function(t,i,e,s,n,r){if(i.length){this.X$(t,i,e,s,1,r,n);var h=this.N,o=this.K$(e,s),a=h.radius?h.radius:o.radius;if(
!(a<=0)){var u=h.innerRadius&&h.innerRadius<a?h.innerRadius:a/3,c=h.x?h.x:o.x,f=h.y?h.y:o.y;if(t.fillStyle=te.backColor,t.beginPath(),t.arc(c,f,u,0,2*Math.PI,!0),t.fill(),this.N.donutInnerText){var l=this.J$(i),d=this.nf(l),v=te.dataPadding,_=2*u-2*v,p=this.canvases[0].renderText(c-u+v,f-u+v,'<div class="webix_donut_center_text">'.concat(this.N.donutInnerText(i,d),"</div>"),"webix_donut_center_text_box",_);p.style.height=p.style.lineHeight=_+"px"}}}}}),to={$render_bar:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g=s.y-e.y;m=!!this.N.yAxis,b=!!this.N.xAxis,c=(u=this.rD()).max,f=u.min,o=(s.x-e.x)/i.length,n||"auto"!=this.N.origin&&!m||this.hD(i,e,s,f,c,o),m&&(c=parseFloat(this.N.yAxis.end),f=parseFloat(this.N.yAxis.start)),l=(v=this.oD(f,c))[0],d=v[1],p=l?g/l:l,m||"auto"!=this.N.origin&&b||(_=10,p=l?(g-_)/l:_),!n&&"auto"!=this.N.origin&&!m&&this.N.origin>f&&this.aD(t,i,e,s,o,s.y-p*(this.N.origin-f)),h=parseInt(this.N.barWidth,10);var w=0,x=0;for(a=0;a<this.uD.length;a++)a==n&&(x=w),"bar"==this.uD[a].type&&w++;this.uD&&o<h*w+4&&(h=parseInt(o/w-4,10));var y=(o-h*w)/2,M="undefined"!=typeof this.N.radius?parseInt(this.N.radius,10):Math.round(h/5),S=!1,k=this.N.gradient;for(k&&"function"!=typeof k?(S=k,k=!1):k&&(k=t.createLinearGradient(0,s.y,0,e.y),this.N.gradient(k)),b||this.eD(t,e.x,s.y+.5,s.x,s.y+.5,"#edeff0",1),a=0;a<i.length;a++){var C=parseFloat(this.N.value(i[a])||0);if(this.cD&&(C=this.fD(C)),C&&!isNaN(C)){c<C&&(C=c),C-=f,C*=d;var $=e.x+y+a*o+(h+1)*x,D=s.y,I=k||this.N.color.call(this,i[a]),A=this.N.border?1:0,T=this.N.label(i[a]);m||"auto"!=this.N.origin&&b?C==this.N.origin||"auto"==this.N.origin&&this.N.value(i[a])==f?(A=0,T=""):(C<0||this.N.yAxis&&0===C&&!("auto"!=this.N.origin&&this.N.origin>f))&&(C=A=0,T=""):C+=_/p,t.globalAlpha=this.N.alpha.call(this,i[a]);var F=this.b$(t,e,$,D,h,f,M,p,C,I,k,S,A);S&&this.lD(t,$,D,h,f,M,p,C,I,S,A),A&&this.dD(t,$,D,h,f,M,p,C,I),t.globalAlpha=1,F[0]!=$?this.canvases[n].renderTextAt(!1,!0,$+Math.floor(h/2),F[1],T):this.canvases[n].renderTextAt(!0,!0,$+Math.floor(h/2),F[3],T),r.addRect(i[a].id,[$-e.x,F[3]-e.y,F[2]-e.x,F[1]-e.y],n)}}},vD:function(t,i,e,s,n,r,h){var o=e;return"auto"!=this.N.origin&&this.N.origin>h&&(o=e-=(this.N.origin-h)*n,(s-=this.N.origin-h)<0&&(s*=-1,t.translate(i+r,e),t.rotate(Math.PI),e=i=0),e-=.5),{value:s,x0:i,y0:e,start:o}},b$:function(t,i,e,s,n,r,h,o,a,u,c,f,l){t.save(),t.fillStyle=u;var d=this.vD(t,e,s,a,o,n,r),v=this._D(t,d.x0,d.y0,n,h,o,d.value,l);c&&!f&&t.lineTo(d.x0+l,i.y),t.fill(),t.restore();var _=d.x0,p=d.x0!=e?e+v[0]:v[0];return[_,d.x0!=e?d.start-v[1]-d.y0:d.y0,p,d.x0!=e?d.start-d.y0:v[1]]},pD:function(t,i){var e,s;s=Ze.toRgb(i),(e=Ze.rgbToHsv(s[0],s[1],s[2]))[2]/=1.4;var n="rgb("+Ze.hsvToRgb(e[0],e[1],e[2])+")";t.strokeStyle=n,1==t.globalAlpha&&(t.globalAlpha=.9)},dD:function(t,i,e,s,n,r,h,o,a){var u;t.save(),u=this.vD(t,i,e,o,h,s,n),this.pD(t,a),this._D(t,u.x0,u.y0,s,r,h,u.value,t.lineWidth/2,1),t.stroke(),t.restore()},lD:function(t,i,e,s,n,r,h,o,a,u,c){t.save();var f=this.vD(t,i,e,o,h,s,n),l=this.bD(t,f.x0,f.y0,f.x0+s,f.y0-h*f.value+2,u,a,"y");t.fillStyle=l.gradient,this._D(t,f.x0+l.offset,f.y0,s-2*l.offset,r,h,f.value,l.offset+c),t.fill(),t.restore()},_D:function(t,i,e,s,n,r,h,o,a){t.beginPath();var u=0;if(r*h<n){var c=(n-r*h)/n;c<=1&&-1<=c&&(u=-Math.acos(c)+Math.PI/2)}t.moveTo(i+o,e);var f=e-Math.floor(r*h)+n+(n?0:o);n<r*h&&t.lineTo(i+o,f);var l=i+n;n&&0<n&&t.arc(l,f,Math.max(n-o,0),-Math.PI+u,-Math.PI/2,!1);var d=i+s-n-o,v=f-n+(n?o:0);t.lineTo(d,v),n&&0<n&&t.arc(d+o,f,Math.max(n-o,0),-Math.PI/2,0-u,!1);var _=i+s-o;return t.lineTo(_,e),a||t.lineTo(i+o,e),[_,v]}},io={$render_line:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b;if(u=this.mD(t,i,e,s,n),h=this.N,i.length){for(c=h.offset?e.x+.5*u.cellWidth:e.x,a=[],o=0;o<i.length;o++)if((b=this.gD(i[o],e,s,u))||"0"==b){if(l=o?u.cellWidth*o-.5+c:c,v="object"==M(b)?b.y0:b,o&&this.N.fixOverflow){if((p=this.gD(i[o-1],e,s,u)).out&&p.out==b.out)continue;f=u.cellWidth*(o-1)-.5+c,d="object"==M(p)?p.y0:p,p.out&&(_="min"==p.out?s.y:e.y,a.push({x:this.wD(f,l,d,v,_),y:_})),b.out&&(_="min"==b.out?s.y:e.y,
a.push({x:this.wD(f,l,d,v,_),y:_}))}b.out||a.push({x:l,y:b,index:o})}for(this.xD=e,o=1;o<=a.length;o++)f=a[o-1].x,d=a[o-1].y,o<a.length&&(l=a[o].x,v=a[o].y,this.eD(t,f,d,l,v,h.line.color.call(this,i[o-1]),h.line.width),h.line&&h.line.shadow&&(t.globalAlpha=.3,this.eD(t,f+2,d+h.line.width+8,l+2,v+h.line.width+8,"#eeeeee",h.line.width+3),t.globalAlpha=1)),"undefined"!=typeof a[o-1].index&&this.yD(t,f,d,i[a[o-1].index],h.label(i[a[o-1].index]),n,r,e)}},wD:function(t,i,e,s,n){return t+(n-e)*(i-t)/(s-e)},yD:function(t,i,e,s,n,r,h){var o=this.N.item,a=parseInt(o.radius.call(this,s),10)||0,u=this.xD,c=o.type.call(this,s);if(a){if(t.save(),o.shadow){t.lineWidth=1,t.strokeStyle="#bdbdbd",t.fillStyle="#bdbdbd";for(var f=[.1,.2,.3],l=f.length-1;0<=l;l--)t.globalAlpha=f[l],t.strokeStyle="#d0d0d0",t.beginPath(),this.MD(t,i,e+2*a/3,a+l+1,c),t.stroke();t.beginPath(),t.globalAlpha=.3,t.fillStyle="#bdbdbd",this.MD(t,i,e+2*a/3,a+1,c),t.fill()}t.restore(),t.lineWidth=o.borderWidth,t.fillStyle=o.color.call(this,s),t.strokeStyle=o.borderColor.call(this,s),t.globalAlpha=o.alpha.call(this,s),t.beginPath(),this.MD(t,i,e,a+1,c),t.fill(),t.stroke(),t.globalAlpha=1}if(n&&this.canvases[r].renderTextAt(!1,!0,i,e-a-this.N.labelOffset,this.N.label.call(this,s)),h){var d=this.N.eventRadius||a+1;h.addRect(s.id,[i-d-u.x,e-d-u.y,i+d-u.x,e+d-u.y],r)}},MD:function(t,i,e,s,n){var r=[];if(!n||"square"!=n&&"s"!=n)if(!n||"diamond"!=n&&"d"!=n)r=!n||"triangle"!=n&&"t"!=n?[[i,e,s,0,2*Math.PI,!0]]:[[i,e-s],[i+Math.sqrt(3)*s/2,e+s/2],[i-Math.sqrt(3)*s/2,e+s/2],[i,e-s]];else{var h=1<t.lineWidth?t.lineWidth*Math.sqrt(2)/4:0;r=[[i,e-s],[i+s,e],[i,e+s],[i-s,e],[i+h,e-s-h]]}else r=[[i-(s*=Math.sqrt(2)/2)-t.lineWidth/2,e-s],[i+s,e-s],[i+s,e+s],[i-s,e+s],[i-s,e-s]];this.SD(t,r)},gD:function(t,i,e,s){var n=s.minValue,r=s.maxValue,h=s.unit,o=s.valueFactor,a=this.N.value(t);this.cD&&(a=this.fD(a));var u=(parseFloat(a||0)-n)*o;this.N.yAxis||(u+=s.startValue/h);var c=e.y-h*u;return!this.N.fixOverflow||"line"!=this.N.type&&"area"!=this.N.type?(r<a&&(c=i.y),(u<0||a<n)&&(c=e.y)):r<a?c={y:i.y,y0:c,out:"max"}:(u<0||a<n)&&(c={y:e.y,y0:c,out:"min"}),c},mD:function(t,i,e,s,n){var r,h={};h.totalHeight=s.y-e.y,this.N.cellWidth?h.cellWidth=Math.min(s.x-e.x,this.N.cellWidth):h.cellWidth=(s.x-e.x)/(this.N.offset?i.length:i.length-1);var o=!!this.N.yAxis,a=-1!=this.N.type.indexOf("stacked")?this.kD(i):this.rD();h.maxValue=a.max,h.minValue=a.min,n||this.hD(i,e,s,h.minValue,h.maxValue,h.cellWidth),o&&(h.maxValue=parseFloat(this.N.yAxis.end),h.minValue=parseFloat(this.N.yAxis.start));var u=this.oD(h.minValue,h.maxValue);return r=u[0],h.valueFactor=u[1],h.unit=r?h.totalHeight/r:10,h.startValue=0,o||(h.startValue=10,h.unit!=h.totalHeight&&(h.unit=r?(h.totalHeight-h.startValue)/r:10)),h}},eo={$render_barH:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g,w,x,y,M,S,k,C;for(a=(s.y-e.y)/i.length,d=(l=this.rD("h")).max,v=l.min,x=s.x-e.x,C=!!this.N.xAxis,n||this.CD(t,i,e,s,v,d,a),C&&(d=parseFloat(this.N.xAxis.end),v=parseFloat(this.N.xAxis.start)),b=(g=this.oD(v,d))[0],p=g[1],M=b?x/b:10,C||(w=10,M=b?(x-w)/b:10),(o=parseInt(this.N.barWidth,10))*this.uD.length+4>a&&(o=a/this.uD.length-4),h=Math.floor((a-o*this.uD.length)/2),m="undefined"!=typeof this.N.radius?parseInt(this.N.radius,10):Math.round(o/5),_=!1,(c=this.N.gradient)&&"function"!=typeof c?(_=c,c=!1):c&&(c=t.createLinearGradient(e.x,e.y,s.x,e.y),this.N.gradient(c)),C||this.eD(t,e.x-.5,e.y,e.x-.5,s.y,"#edeff0",1),f=0;f<i.length;f++)if(y=parseFloat(this.N.value(i[f]||0)),this.cD&&(y=this.fD(y)),y&&!isNaN(y))if(d<y&&(y=d),y-=v,y*=p,S=e.x,k=e.y+h+f*a+(o+1)*n,y<0&&"auto"==this.N.origin||this.N.xAxis&&0===y&&!("auto"!=this.N.origin&&this.N.origin>v))this.canvases[n].renderTextAt("middle","right",S+10,k+o/2+h,this.N.label(i[f]));else{y<0&&"auto"!=this.N.origin&&this.N.origin>v&&(y=0),C||(y+=w/M),u=c||this.N.color.call(this,i[f]),this.N.border&&this.$D(t,S,k,o,v,m,M,y,u),t.globalAlpha=this.N.alpha.call(this,i[f]);var $=this.DD(t,s,S,k,o,v,m,M,y,u,c,_);_&&this.ID(t,S,k,o,v,m,M,y,u,_),t.globalAlpha=1,$[3]==k?(this.canvases[n].renderTextAt("middle",
"left",$[0]-5,$[3]+Math.floor(o/2),this.N.label(i[f])),r.addRect(i[f].id,[$[0]-e.x,$[3]-e.y,$[2]-e.x,$[3]+o-e.y],n)):(this.canvases[n].renderTextAt("middle",!1,$[2]+5,$[1]+Math.floor(o/2),this.N.label(i[f])),r.addRect(i[f].id,[$[0]-e.x,k-e.y,$[2]-e.x,$[3]-e.y],n))}},AD:function(t,i,e,s,n,r,h,o,a){var u=0;if(r*h<n){var c=(n-r*h)/n;u=-Math.asin(c)+Math.PI/2}t.moveTo(i,e+o);var f=i+r*h-n-(n?0:o);f=Math.max(i,f),n<r*h&&t.lineTo(f,e+o);var l=e+n;n&&0<n&&t.arc(f,l,n-o,-Math.PI/2+u,0,!1);var d=e+s-n-(n?0:o),v=f+n-(n?o:0);t.lineTo(v,d),n&&0<n&&t.arc(f,d,n-o,0,Math.PI/2-u,!1);var _=e+s-o;return t.lineTo(i,_),a||t.lineTo(i,e+o),[v,_]},CD:function(t,i,e,s,n,r,h){var o=0;this.N.xAxis&&(this.canvases.x||(this.canvases.x=this.TD("axis_x")),o=this.FD(this.canvases.x.getCanvas(),i,e,s,n,r)),this.N.yAxis&&(this.canvases.y||(this.canvases.y=this.TD("axis_y")),this.VD(this.canvases.y.getCanvas(),i,e,s,h,o))},VD:function(t,i,e,s,n,r){if(this.N.yAxis){var h,o=parseInt(r||e.x,10)-.5,a=s.y+.5,u=e.y;this.eD(t,o,a,o,u,this.N.yAxis.color,1);for(var c=0;c<i.length;c++){var f="auto"!=this.N.origin&&"barH"==this.N.type&&parseFloat(this.N.value(i[c]))<this.N.origin;h=u+n/2+c*n,this.canvases.y.renderTextAt("middle",!f&&"left",f?o+5:o-5,h,this.N.yAxis.template(i[c]),"webix_axis_item_y",f?0:o-10),this.N.yAxis.lines.call(this,i[c])&&this.eD(t,e.x,h,s.x,h,this.N.yAxis.lineColor.call(this,i[c]),1)}this.N.yAxis.lines.call(this,{})&&this.eD(t,e.x+.5,u+.5,s.x,u+.5,this.N.yAxis.lineColor.call(this,{}),1),this.zD(e,s)}},FD:function(t,i,e,s,n,r){var h,o={},a=this.N.xAxis;if(a){var u=s.y+.5,c=e.x-.5,f=s.x-.5,l=e.x;if(this.eD(t,c,u,f,u,a.color,1),a.step&&(h=parseFloat(a.step)),"undefined"!=typeof this.BD.step&&"undefined"!=typeof this.BD.start&&"undefined"!=typeof this.BD.end||(n=(o=this.HD(n,r)).start,r=o.end,h=o.step,this.N.xAxis.end=r,this.N.xAxis.start=n,this.N.xAxis.step=h),0!==h){for(var d=(f-c)*h/(r-n),v=0,_=n;_<=r;_+=h){var p=this.cD?Math.pow(10,_):_;o.fixNum&&(p=parseFloat(p).toFixed(o.fixNum));var b=Math.floor(c+v*d)+.5;if(_==n&&"auto"==this.N.origin||!a.lines.call(this,_)||this.eD(t,b,u,b,e.y,this.N.xAxis.lineColor.call(this,_),1),_==this.N.origin&&(l=b+1),h<1&&!this.cD){var m=Math.min(Math.floor(this.fD(h)),n<=0?0:Math.floor(this.fD(n))),g=Math.pow(10,-m);_=p=Math.round(p*g)/g}this.canvases.x.renderTextAt(!1,!0,b,u+2,a.template(p.toString()),"webix_axis_item_x"),v++}return this.canvases.x.renderTextAt(!0,!1,c,s.y+this.N.padding.bottom-3,this.N.xAxis.title,"webix_axis_title_x",s.x-e.x),l}}},RD:function(t,i,e,s,n,r,h){var o=i;return this.N.yAxis&&"auto"!=this.N.origin&&this.N.origin>h&&(o=i+=(this.N.origin-h)*n,(s-=this.N.origin-h)<0&&(s*=-1,t.translate(i,e+r),t.rotate(Math.PI),i=.5,e=0),i+=.5),{value:s,x0:i,y0:e,start:o}},DD:function(t,i,e,s,n,r,h,o,a,u,c,f){t.save();var l=this.RD(t,e,s,a,o,n,r);t.fillStyle=u,t.beginPath();var d=this.AD(t,l.x0,l.y0,n,h,o,l.value,this.N.border?1:0);c&&!f&&t.lineTo(i.x,l.y0+(this.N.border?1:0)),t.fill(),t.restore();var v=l.y0,_=l.y0!=s?s:d[1];return[l.y0!=s?l.start-d[0]:l.start,v,l.y0!=s?l.start:d[0],_]},$D:function(t,i,e,s,n,r,h,o,a){t.save();var u=this.RD(t,i,e,o,h,s,n);t.beginPath(),this.pD(t,a),t.globalAlpha=.9,this.AD(t,u.x0,u.y0,s,r,h,u.value,t.lineWidth/2,1),t.stroke(),t.restore()},ID:function(t,i,e,s,n,r,h,o,a,u){t.save();var c=this.RD(t,i,e,o,h,s,n),f=this.bD(t,c.x0,c.y0+s,c.x0+h*c.value,c.y0,u,a,"x");t.fillStyle=f.gradient,t.beginPath(),this.AD(t,c.x0,c.y0+f.offset,s-2*f.offset,r,h,c.value,f.offset),t.fill(),t.globalAlpha=1,t.restore()}},so={$render_stackedBar:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d=this.N,v=s.y-e.y,_=!!d.yAxis,p=!!d.xAxis,b=this.kD(i),m=0===d.origin;h=b.max,o=b.min;var g=Math.floor((s.x-e.x)/i.length);n||(a=this.hD(i,e,s,o,h,g)),_&&(h=parseFloat(d.yAxis.end),o=parseFloat(d.yAxis.start));var w=this.oD(o,h);l=w[0],f=w[1];var x=l?v/l:10,y=parseInt(d.barWidth,10);g<y+4&&(y=g-4);var M=Math.floor((g-y)/2),S=!!d.gradient&&d.gradient;p||this.eD(t,e.x,s.y+.5,s.x,s.y+.5,"#edeff0",1);for(var k=0;k<i.length;k++){var C=parseFloat(d.value(i[k]||0));this.cD&&(C=this.fD(C)),u=e.x+M+k*g;var $=m&&C<0;if(
n?c=$?i[k].$startYN:i[k].$startY:(c=a-1,i[k].$startY=c,m&&($&&(c=a+1),i[k].$startYN=a+1)),C&&!isNaN(C)){n||m||(C-=o),C*=f;var D=d.border,I=d.label(i[k]);if(!(c<e.y+1)){var A=this.N.color.call(this,i[k]),T=Math.abs(c-(m?s.y+o*x:s.y))<3;t.globalAlpha=d.alpha.call(this,i[k]),t.fillStyle=t.strokeStyle=d.color.call(this,i[k]),t.beginPath();var F=c-x*C+(T?$?-1:1:0);Math.floor(F)>s.y&&(F=s.y,""!=I&&F-c<pt('<div class="webix_canvas_text">'.concat(I,"</div>"),this.$view.className).height&&(I=""));var V=this.ED(t,u-(D?.5:0),c,y+(D?.5:0),F,0,e.y);if(t.fill(),t.stroke(),S){t.save();var z=this.bD(t,u,c,u+y,V[1],S,A,"y");t.fillStyle=z.gradient,t.beginPath(),V=this.ED(t,u+z.offset,c,y-2*z.offset,F,D?1:0,e.y),t.fill(),t.restore()}D&&(t.save(),"string"==typeof D?t.strokeStyle=D:this.pD(t,A),t.beginPath(),this.ED(t,u-.5,parseInt(c,10)+.5,y+1,parseInt(F,10)+.5,0,e.y,T),t.stroke(),t.restore()),t.globalAlpha=1,this.canvases[n].renderTextAt(!1,!0,u+Math.floor(y/2),V[1]+(c-V[1])/2-7,I),r.addRect(i[k].id,[u-e.x,V[1]-e.y,V[0]-e.x,i[k][$?"$startYN":"$startY"]-e.y],n),i[k][$?"$startYN":"$startY"]=V[1]}}}},ED:function(t,i,e,s,n,r,h,o){t.moveTo(i,e),n<h&&(n=h),t.lineTo(i,n);var a=i+s,u=n;t.lineTo(a,u);var c=i+s;return t.lineTo(c,e),o||t.lineTo(i,e),[c,u]}},no={$render_stackedBarH:function(t,i,e,s,n,r){var h,o,a,u,c=s.x-e.x,f=!!this.N.yAxis,l=this.kD(i);h=l.max,o=l.min;var d=Math.floor((s.y-e.y)/i.length);n||this.CD(t,i,e,s,o,h,d),f&&(h=parseFloat(this.N.xAxis.end),o=parseFloat(this.N.xAxis.start));var v=this.oD(o,h);u=v[0],a=v[1];var _=u?c/u:10,p=0;f||(p=10,_=u?(c-p)/u:10);var b=parseInt(this.N.barWidth,10);d<b+4&&(b=d-4);var m=(d-b)/2,g=!1,w=this.N.gradient;w&&(g=!0),f||this.eD(t,e.x-.5,e.y,e.x-.5,s.y,"#edeff0",1);var x=0,y=0;for(M=0;M<this.uD.length;M++)M==n&&(y=x),"stackedBarH"==this.uD[M].type&&x++;for(var M=0;M<i.length;M++){y||(i[M].$startX=e.x);var S=Math.abs(parseFloat(this.N.value(i[M]||0)));h<S&&(S=h),S-=o,S*=a;var k=e.x,C=e.y+m+M*d;if(y?k=i[M].$startX:i[M].$startX=k,S&&!isNaN(S)){f||(S+=p/_);var $=this.N.color.call(this,i[M]);t.globalAlpha=this.N.alpha.call(this,i[M]),t.fillStyle=this.N.color.call(this,i[M]),t.beginPath();var D=this.AD(t,k,C,b,0,_,S,0);if(w&&!g&&t.lineTo(e.x+c,C+(this.N.border?1:0)),t.fill(),g){var I=this.bD(t,k,C+b,k,C,g,$,"x");t.fillStyle=I.gradient,t.beginPath(),D=this.AD(t,k,C,b,0,_,S,0),t.fill()}this.N.border&&this.$D(t,k,C,b,o,0,_,S,$),t.globalAlpha=1,this.canvases[n].renderTextAt("middle",!0,i[M].$startX+(D[0]-i[M].$startX)/2-1,C+(D[1]-C)/2,this.N.label(i[M])),r.addRect(i[M].id,[i[M].$startX-e.x,C-e.y,D[0]-e.x,D[1]-e.y],n),i[M].$startX=D[0]}}}},ro={$render_area:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g,w;if(f=this.mD(t,i,e,s,n),u=(o=this.N).eventRadius||Math.floor(f.cellWidth/2),i.length){for(l=[],_=o.offset?e.x+.5*f.cellWidth:e.x,a=0;a<i.length;a++)if(c=i[a],v=this.gD(c,e,s,f),m=_+f.cellWidth*a,v){if(g="object"==M(v)?v.y0:v,a&&this.N.fixOverflow){if((d=this.gD(i[a-1],e,s,f)).out&&d.out==v.out)continue;p=f.cellWidth*(a-1)-.5+_,b="object"==M(d)?d.y0:d,d.out&&(w="min"==d.out?s.y:e.y,l.push([this.wD(p,m,b,g,w),w])),v.out&&(w="min"==v.out?s.y:e.y,l.push([this.wD(p,m,b,g,w),w]),a==i.length-1&&w==e.y&&l.push([m,e.y]))}v.out||(l.push([m,g]),r.addRect(c.id,[m-u-e.x,g-u-e.y,m+u-e.x,g+u-e.y],n)),o.yAxis||(h=o.offset||a!=i.length-1?"center":"left",this.canvases[n].renderTextAt(!1,h,m,g-o.labelOffset,o.label(c)))}l.length&&(l.push([m,s.y]),l.push([l[0][0],s.y])),t.globalAlpha=this.N.alpha.call(this,i[0]),t.fillStyle=this.N.color.call(this,i[0]),t.beginPath(),this.SD(t,l),t.fill(),t.lineWidth=1,t.globalAlpha=1,o.border&&(t.lineWidth=o.borderWidth||1,o.borderColor?t.strokeStyle=o.borderColor.call(this,i[0]):this.pD(t,t.fillStyle),t.beginPath(),this.SD(t,l),t.stroke())}},$render_stackedArea:function(t,e,i,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g,w,x,y;if(v=this.mD(t,e,i,s,n),l=(u=this.N).eventRadius||Math.floor(v.cellWidth/2),e.length){_=[],m=[],p=u.offset?i.x+.5*v.cellWidth:i.x;var M=function(t,i){return n?e[t].$startY?i-s.y+e[t].$startY:0:i};for(c=0;c<e.length;c++)d=e[c],c?p+=v.cellWidth:(b=M(c,s.y),_.push([p,b])),
b=M(c,this.gD(d,i,s,v)),m.push(isNaN(b)&&!c?e[c].$startY||s.y:b),b&&(_.push([p,b]),r.addRect(d.id,[p-l-i.x,b-l-i.y,p+l-i.x,b+l-i.y],n),u.yAxis||(u.offset,a="center",this.canvases[n].renderTextAt(!1,a,p,b-u.labelOffset,u.label(d))));if(_.push([p,M(c-1,s.y)]),n)for(c=e.length-2;0<c;c--)p-=v.cellWidth,(b=e[c].$startY)&&_.push([p,b]);for(_.push([_[0][0],_[0][1]]),t.globalAlpha=this.N.alpha.call(this,e[0]),t.fillStyle=this.N.color.call(this,e[0]),t.beginPath(),this.SD(t,_),t.fill(),c=0;c<e.length;c++){if(!(b=m[c]))for(c==e.length-1&&(b=e[c].$startY),f=c+1;f<e.length;f++)if(m[f]){h={x:i.x,y:m[0]},o={x:i.x+v.cellWidth*f,y:m[f]},g=i.x+v.cellWidth*c,void 0,b=(y=((x=o).y-(w=h).y)/(x.x-w.x))*g+w.y-y*w.x;break}e[c].$startY=b}}}},ho={$render_radar:function(t,i,e,s,n,r){this.PD(t,i,e,s,n,r)},PD:function(t,i,e,s,n,r){if(i.length){for(var h=this.K$(e,s),o=this.N.radius?this.N.radius:h.radius,a=this.N.x?this.N.x:h.x,u=this.N.y?this.N.y:h.y,c=[],f=0;f<i.length;f++)c.push(1);var l=this.sf(c,i.length);this.xD=e,n||this.jD(l,a,u,o,i),this.ND(t,l,a,u,o,i,n,r)}},ND:function(t,i,e,s,n,r,h,o){var a,u,c,f,l,d,v,_,p,b,m,g,w,x,y,M,S,k,C;for(l=(c=this.N).yAxis.start,d=c.yAxis.end,k=(g=(C=this.oD(l,d))[0])?n/g:n/2,S=C[1],a=u=w=-Math.PI/2,p=[],f=_=0;f<r.length;f++)y=M||(x=c.value(r[f]),this.cD&&(x=this.fD(x)),(parseFloat(x||0)-l)*S),b=Math.floor(k*y),x=c.value(f!=r.length-1?r[f+1]:r[0]),this.cD&&(x=this.fD(x)),M=(parseFloat(x||0)-l)*S,m=Math.floor(k*M),a=u,u=f!=r.length-1?w+i[f]-1e-4:w,v=_||this.hf(a,e,s,b),_=this.hf(u,e,s,m),p.push(v);c.fill&&this.LD(t,p,r),!c.disableLines&&2<r.length&&this.OD(t,p,r),(!c.disableItems||r.length<3)&&this.WD(t,p,r,h,o),p=null},WD:function(t,i,e,s,n){for(var r=0;r<i.length;r++)this.yD(t,i[r].x,i[r].y,e[r],this.N.label.call(this,e),s,n)},LD:function(t,i,e){var s,n;t.globalAlpha=this.N.alpha.call(this,{}),t.beginPath();for(var r=0;r<i.length;r++)t.fillStyle=this.N.fill.call(this,e[r]),s=i[r],n=i[r+1]||i[0],r||t.moveTo(s.x,s.y),t.lineTo(n.x,n.y);t.fill(),t.globalAlpha=1},OD:function(t,i,e){for(var s,n,r=0;r<i.length;r++)s=i[r],n=i[r+1]||i[0],this.eD(t,s.x,s.y,n.x,n.y,this.N.line.color.call(this,e[r]),this.N.line.width)},jD:function(t,i,e,s,n){var r=this.N.yAxis,h=this.N.xAxis,o=r.start,a=r.end,u=r.step,c={},f=this.UD;if("undefined"==typeof f.step||"undefined"==typeof f.start||"undefined"==typeof f.end){var l=this.rD();o=(c=this.HD(l.min,l.max)).start,a=c.end,u=c.step,r.end=a,r.start=o}var d,v,_,p,b,m=[],g=0,w=s*u/(a-o);u<1&&(p=Math.min(this.fD(u),o<=0?0:this.fD(o)),b=Math.pow(10,-p));var x=[];this.canvases.scale||(this.canvases.scale=this.TD("radar_scale"));var y=this.canvases.scale.getCanvas();for(d=a;o<=d;d-=u){var M=this.cD?Math.pow(10,d):d;c.fixNum&&(M=parseFloat(d).toFixed(c.fixNum)),m.push(Math.floor(g*w)+.5),b&&!this.cD&&(d=M=Math.round(M*b)/b);var S=e-s+m[m.length-1];this.canvases.scale.renderTextAt("middle","left",i,S,r.template(M.toString()),"webix_axis_item_y webix_radar");var k,C=-Math.PI/2,$=C;for(v=0;v<t.length;v++)g||x.push($),k=C+t[v]-1e-4,this.qD(y,2<t.length?f.lineShape||"line":"arc",i,e,s-m[m.length-1],$,k,d,v,n[d]),$=k;g++}for(d=0;d<x.length;d++)_=this.hf(x[d],i,e,s),h&&(h.lines.call(this,n[d],d)&&this.eD(y,i,e,_.x,_.y,h.lineColor.call(this,n[d]),1),this.YD(y,i,e,s,x[d],h.template.call(this,n[d])))},qD:function(t,i,e,s,n,r,h,o,a){var u,c;if(n<0)return!1;u=this.hf(r,e,s,n),c=this.hf(h,e,s,n);var f=this.N.yAxis;f.bg&&(t.beginPath(),t.moveTo(e,s),"arc"==i?t.arc(e,s,n,r,h,!1):(t.lineTo(u.x,u.y),t.lineTo(c.x,c.y)),t.fillStyle=f.bg(o,a),t.moveTo(e,s),t.fill(),t.closePath()),f.lines.call(this,o)&&(t.lineWidth=1,t.beginPath(),"arc"==i?t.arc(e,s,n,r,h,!1):(t.moveTo(u.x,u.y),t.lineTo(c.x,c.y)),t.strokeStyle=f.lineColor.call(this,o),t.stroke())},YD:function(t,i,e,s,n,r){if(!r)return!1;var h=this.canvases.scale.renderText(0,0,r,"webix_axis_radar_title",1),o=h.scrollWidth,a=h.offsetHeight,u=this.hf(n,i,e,s+5),c=0,f=0;(n<0||n>Math.PI)&&(f=-a),n>Math.PI/2&&(c=-o),Math.abs(n+Math.PI/2)<.001||Math.abs(n-Math.PI/2)<.001?c=-o/2:(Math.abs(n)<.001||Math.abs(n-Math.PI)<.001)&&(f=-a/2),h.style.top=u.y+f+"px",
h.style.left=u.x+c+"px",h.style.width=o+"px",h.style.whiteSpace="nowrap"}},oo={$render_scatter:function(t,i,e,s,n,r){if(this.N.xValue){var h=this.N,o=!(h.disableLines||"undefined"==typeof h.disableLines),a=this.rD(),u=this.rD("h","xValue");n||(this.canvases.x||(this.canvases.x=this.TD("axis_x")),this.canvases.y||(this.canvases.y=this.TD("axis_y")),this.GD(this.canvases.y.getCanvas(),i,e,s,a.min,a.max),this.FD(this.canvases.x.getCanvas(),i,e,s,u.min,u.max)),a={min:h.yAxis.start,max:h.yAxis.end},u={min:h.xAxis.start,max:h.xAxis.end};var c=this.XD(t,i,e,s,u,a);this.xD=e;for(var f,l,d,v,_,p=[],b=0;b<i.length;b++){var m=this.KD(c,s,e,u,i[b],"X"),g=this.KD(c,e,s,a,i[b],"Y");isNaN(m)||isNaN(g)||p.push({x:m,y:g,index:b})}for(var w=0;w<p.length;w++){if(_=p[w].index,o){var x=h.line.color.call(this,i[_]);f=p[w].x,l=p[w].y,w==p.length-1?h.shape&&2<p.length&&(this.eD(t,d,v,p[0].x,p[0].y,x,h.line.width),h.disableItems||this.JD(t,r,p[0],i[0],n),h.fill&&this.ZD(t,p,i)):(d=p[w+1].x,v=p[w+1].y,this.eD(t,f,l,d,v,x,h.line.width))}!h.disableItems&&p[w]&&this.JD(t,r,p[w],i[_],n)}}},ZD:function(t,i,e){var s,n;t.globalAlpha=this.N.alpha.call(this,{}),t.beginPath();for(var r=0;r<i.length;r++)t.fillStyle=this.N.fill.call(this,e[r]),s=i[r],n=i[r+1]||i[0],r||t.moveTo(s.x,s.y),t.lineTo(n.x,n.y);t.fill(),t.globalAlpha=1},XD:function(t,i,e,s,n,r){var h={};return h.totalHeight=s.y-e.y,h.totalWidth=s.x-e.x,this.QD(h,n.min,n.max,h.totalWidth,"X"),this.QD(h,r.min,r.max,h.totalHeight,"Y"),h},JD:function(t,i,e,s,n){this.yD(t,e.x,e.y,s,this.N.label.call(this,s),n,i)},KD:function(t,i,e,s,n,r){var h=this.N["X"==r?"xValue":"value"].call(this,n),o=t["valueFactor"+r],a=(parseFloat(h||0)-s.min)*o,u=t["unit"+r],c=e[r.toLowerCase()]-("X"==r?-1:1)*Math.floor(u*a);return a<0&&(c=e[r.toLowerCase()]),h>s.max&&(c=i[r.toLowerCase()]),h<s.min&&(c=e[r.toLowerCase()]),c},QD:function(t,i,e,s,n){var r=this.oD(i,e);t["relValue"+(n=n||"")]=r[0],t["valueFactor"+n]=r[1],t["unit"+n]=t["relValue"+n]?s/t["relValue"+n]:10}},ao={$render_splineArea:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m,g=this.N,w=[];if(f=this.mD(t,i,e,s,n),c=g.eventRadius||Math.floor(f.cellWidth/2),a=[],i.length){for(v=e.x,o=0;o<i.length;o++)((b=this.gD(i[o],e,s,f))||"0"==b)&&(d=o?f.cellWidth*o-.5+v:v,a.push({x:d,y:b,index:o}),r.addRect(i[o].id,[d-c-e.x,b-c-e.y,d+c-e.x,b+c-e.y],n));for(l=this.tI(a),o=0;o<a.length;o++)if(_=a[o].x,o<a.length-1){for(p=a[o+1].x,m=a[o+1].y,u=_;u<p;u++){var x=this.iI(u,_,o,l.a,l.b,l.c,l.d);x<e.y&&(x=e.y),x>s.y&&(x=s.y);var y=this.iI(u+1,_,o,l.a,l.b,l.c,l.d);y<e.y&&(y=e.y),y>s.y&&(y=s.y),w.push([u,x]),w.push([u+1,y])}w.push([p,m])}h=this.N.color.call(this,i[0]),w.length&&(w.push([p,s.y]),w.push([w[0][0],s.y])),t.globalAlpha=this.N.alpha.call(this,i[0]),t.fillStyle=h,t.beginPath(),this.SD(t,w),t.fill(),t.lineWidth=1,t.globalAlpha=1,g.border&&(t.lineWidth=g.borderWidth||1,g.borderColor?t.strokeStyle=g.borderColor.call(this,i[0]):this.pD(t,h),t.beginPath(),w.splice(w.length-3),this.SD(t,w),t.stroke())}}},uo={dynamic_setter:function(t){return t&&function i(h){if(h.eI)return;var o=h.N;o.cellWidth||(o.cellWidth=30);o.animateDuration||(o.animateDuration=400);o.offset=!1,h.eI=h.attachEvent("onBeforeRender",function(t,i){var e=h.sI(h.xe,h.Me);!function s(e){fo(e,function(t,i){i.Ne(e.xe+2*e.N.cellWidth,e.Me)})}(h),function r(t,i,e,s){if(s&&t.length){var n=Math.ceil((e.x-i.x)/s);t.length>n+1&&t.splice(0,t.length-n-1)}}(t,e.start,e.end,o.cellWidth),"add"==i&&function n(i){var t=i.N.cellWidth;i.nI!=t&&(i.nI=t,i.render());i.nI=0,i.rI=null,window.requestAnimationFrame&&!document.hidden&&window.requestAnimationFrame(function(t){!function r(i,t){var e,s=i.N.animateDuration,n=i.N.cellWidth;n&&1<i.count()&&(i.rI||(i.rI=t),e=t-i.rI,i.nI=Math.min(Math.max(e/s*n,1),n),i.render(),e<s&&window.requestAnimationFrame(function(t){r(i,t)}))}(i,t)});i.hI||(i.hI=i.attachEvent("onAfterRender",function(t){!function r(t,c){var f=t.count(),e=t.sI(t.xe,t.Me),l=t.N.cellWidth,d=t.nI||0,i=c.length<f||(c.length-1)*l>e.end.x-e.start.x;function s(t,i,e,s){var n=t.getCanvas(),r=t.Pe,h=t.Be,o=t.He;if(d&&(c.length<f||(
c.length-1)*l>e-i)?(r.style.left=-d+"px",1<c.length&&(!function u(t,i,e){if(t.length){rt(t[0]);for(var s=1;s<t.length;s++)co(e,t[s])||(t[s].style.left=t[s].offsetLeft-i+"px")}}(h,d,o),n.clearRect(0,0,i+d,r.offsetHeight),n.clearRect(e+d,0,r.offsetWidth,r.offsetHeight))):(r.style.left="0px",s||d==l||n.clearRect(i+(c.length-1)*l-l+d,0,r.offsetWidth,r.offsetHeight)),1<h.length&&d&&d!=l){var a=h.length-1;co(o,h[a])&&(a-=1),h[a].style.display="none"}}fo(t,function(t,i){s(i,e.start.x,e.end.x,"x"==t)}),function n(t,i,e){t.qi.Oi.style.left=i.start.x-e+"px",t.qi.Oi.style.width=i.end.x-i.start.x+e+"px"}(t,e,i?d:0)}(i,t)}))}(h)}),h.oI=h.attachEvent("onBeforeXAxis",function(t,i,e,s,n,r){return function _(t,i,e,s,n,r,h){var o,a,u,c,f=t.N,l=s.x-.5,d=parseInt(h||n.y,10)+.5,v=n.x;if(!f.dynamic)return!1;for(u=(e.length-1)*r>v-l||e.length<t.count(),a=0;a<e.length;a++)c=l+a*r,o=u?1<a:!!a,c=Math.ceil(c)-.5,t.aI(c,d,e[a],o),a&&f.xAxis.lines.call(t,e[a])&&t.uI(i,c,n.y,s.y,e[a]);t.canvases.x.renderTextAt(!0,!1,l,n.y+f.padding.bottom-3,f.xAxis.title,"webix_axis_title_x",n.x-s.x),t.eD(i,l,d,v+(u?t.nI:0),d,f.xAxis.color,1)}(h,t,i,e,s,n,r),!1})}(this),t}};function co(t,i){return"axis_x"===t&&-1!==i.className.indexOf("webix_axis_title_x")}function fo(t,i){if(t.canvases){for(var e=0;e<t.uD.length;e++)t.canvases[e]&&i(e,t.canvases[e]);t.canvases.x&&i("x",t.canvases.x)}}var lo={name:"chart",$init:function(t){if(this.uD=[this.N],this.cI=[],this.qi.className+=" webix_chart",this.$ready.push(this.vh),t.preset&&this.fI(t),t.series){var i=t.series;delete t.series,t.series=i}this.data.provideApi(this,!0)},vh:function(){this.data.attachEvent("onStoreUpdated",k(function(){this.render.apply(this,arguments)},this))},defaults:{ariaLabel:"chart",color:"default",alpha:"1",radius:0,label:!1,value:"{obj.value}",padding:{},type:"pie",lineColor:"#ffffff",cant:.5,barWidth:30,line:{width:2,color:"#1ca1c1"},item:{radius:3,borderColor:"#1ca1c1",borderWidth:2,color:"#ffffff",alpha:1,type:"r",shadow:!1},shadow:!1,gradient:!1,border:!1,labelOffset:20,origin:"auto",scale:"linear"},_id:"webix_area_id",on_click:{webix_chart_legend_item:function(t,i,e){var s=e.getAttribute("series_id");if(this.callEvent("onLegendClick",[t,s,e])&&void 0!==s&&1<this.uD.length){var n=this.N,r=n.legend.values;(r&&r[s].toggle||n.legend.toggle)&&(-1!=e.className.indexOf("hidden")?this.showSeries(s):this.hideSeries(s))}}},on_dblclick:{},on_mouse_move:{},locate:function(t){return ot(t,this._id)},$setSize:function(t,i){var e=Gi.api.$setSize.call(this,t,i);if(e){for(var s in this.canvases)this.canvases[s].Ne(this.xe,this.Me);this.render()}return e},type_setter:function(t){return this["$render_"+t],"undefined"==typeof this.N.offset&&(this.N.offset=!(-1!=t.toLowerCase().indexOf("area"))),"radar"!=t||this.N.yAxis||this.define("yAxis",{}),"scatter"==t&&(this.N.yAxis||this.define("yAxis",{}),this.N.xAxis||this.define("xAxis",{})),t},destructor:function(){this.removeAllSeries(),Ri.destructor.apply(this,arguments)},removeAllSeries:function(){this.clearCanvas(),this.lI&&(this.lI.innerHTML="",this.lI.parentNode.removeChild(this.lI),this.lI=null),this.canvases&&(this.canvases={}),this.qi.innerHTML="",this.uD=[]},clearCanvas:function(){if(this.canvases&&"object"==M(this.canvases))for(var t in this.canvases)this.canvases[t].clearCanvas()},render:function(t,i,e){var s,n,r,h;if(this.isVisible(this.N.id)&&(n=this.dI(),this.callEvent("onBeforeRender",[n,e]))){if(this.canvases&&"object"==M(this.canvases))for(var o in this.canvases)this.canvases[o].clearCanvas();else this.canvases={};if(this.N.legend&&(this.canvases.legend||(this.canvases.legend=this.TD("legend")),this.vI(this.data.getRange(),this.xe,this.Me)),this.wu=r=new je(this._id),h=this.N,s=this.sI(this.xe,this.Me),this.uD)for(var a=0;a<this.uD.length;a++)this.N=this.uD[a],this.canvases[a]||(this.canvases[a]=this.TD(this.name+" "+a,"z-index:"+(2+a),null,a,this.N.ariaLabel)),this["$render_"+this.N.type](this.canvases[a].getCanvas(),n,s.start,s.end,a,r);if(r.render(this.qi),this.qi.lastChild.style.zIndex=80,this._I(this.qi.lastChild,s),this.callEvent("onAfterRender",[n
]),this.N=h,this.N.legend&&this.N.legend.values)for(var u=this.N.legend.values,c=0;c<u.length;c++)u[c].$hidden&&this.hideSeries(c)}},_I:function(t,i){var e={};for(var s in e.left=i.start.x,e.top=i.start.y,e.width=i.end.x-i.start.x,e.height=i.end.y-i.start.y,e)t.style[s]=e[s]+"px"},dI:function(){var t,i,e,s,n,r,h,o,a,u;if(s=this.data.getRange(),t=-1!=this.N.type.toLowerCase().indexOf("barh")?"yAxis":"xAxis",(i=this.N[t])&&i.units&&"object"==M(i.units)){if(o=[],"undefined"!=typeof(e=i.units).start&&"undefined"!=typeof e.end&&"undefined"!=typeof e.next)for(h=e.start;h<=e.end;)o.push(h),h=e.next.call(this,h);else"[object Array]"===Object.prototype.toString.call(e)&&(o=e);if(r=[],o.length){for(a=i.value,u={},n=0;n<s.length;n++)u[a(s[n])]=n;for(n=0;n<o.length;n++)"undefined"!=typeof u[o[n]]?(s[u[o[n]]].$unit=o[n],r.push(s[u[o[n]]])):r.push({$unit:o[n]})}return r}return s},series_setter:function(t){if(t&&"object"==M(t)){this.Et(t.length?t[0]:t),this.uD=[this.N];for(var i=1;i<t.length;i++)this.addSeries(t[i])}else;return t},value_setter:Lt,xValue_setter:Lt,yValue_setter:function(t){this.define("value",t)},alpha_setter:Lt,label_setter:Lt,lineColor_setter:Lt,borderColor_setter:Lt,pieInnerText_setter:Lt,donutInnerText_setter:Lt,gradient_setter:function(t){return"function"!=typeof t&&t&&!0===t&&(t="light"),t},colormap:{RAINBOW:function(t){var i=Math.floor(this.getIndexById(t.id)/this.count()*1536);return 1536==i&&(i-=1),this.pI[Math.floor(i/256)](i%256)},"default":function(t){var i=this.count(),e=this.tf.length,s=this.getIndexById(t.id);return i<e?(s&&(s=s<e-i?this.Qc+2:this.Qc+1),this.Qc=s):s%=e,this.tf[s]}},color_setter:function(t){return this.colormap[t]||Lt(t)},fill_setter:function(t){return!(!t||"0"==t)&&Lt(t)},fI:function(t){this.define("preset",t.preset),delete t.preset},preset_setter:function(t){var i,e,s;if(this.defaults=F.extend({},this.defaults),"object"!=M(s=this.presets[t]))return!1;for(i in s)if("object"==M(s[i]))if(this.defaults[i]&&"object"==M(this.defaults[i]))for(e in this.defaults[i]=F.extend({},this.defaults[i]),s[i])this.defaults[i][e]=s[i][e];else this.defaults[i]=F.extend({},s[i]);else this.defaults[i]=s[i];return t},legend_setter:function(t){return t?("object"!=M(t)&&(t={template:t}),this.ji(t,{width:150,height:18,layout:"y",align:"left",valign:"bottom",template:"",toggle:-1!=this.N.type.toLowerCase().indexOf("stacked")?"":"hide",marker:{type:"square",width:15,height:15,radius:3},margin:4,padding:3}),t.template=Lt(t.template),t):(this.lI&&(this.lI.innerHTML="",this.lI=null),!1)},item_setter:function(t){"object"!=M(t)&&(t={color:t,borderColor:t}),this.ji(t,F.extend({},this.defaults.item));return this.bI(["alpha","borderColor","color","radius","type"],t),t},line_setter:function(t){return"object"!=M(t)&&(t={color:t}),(t=F.extend(t,this.defaults.line)).color=Lt(t.color),t},padding_setter:function(t){return"object"!=M(t)&&(t={left:t,right:t,top:t,bottom:t}),this.ji(t,{left:50,right:20,top:35,bottom:40}),t},xAxis_setter:function(t){if(!t)return!1;"object"!=M(t)&&(t={template:t}),this.ji(t,{title:"",color:"#edeff0",lineColor:"#edeff0",template:"{obj}",lines:!0});return this.bI(["lineColor","template","lines"],t),this.BD=F.extend({},t),t},yAxis_setter:function(t){this.ji(t,{title:"",color:"#edeff0",lineColor:"#edeff0",template:"{obj}",lines:!0,bg:te.backColor});return this.bI(["lineColor","template","lines","bg"],t),this.UD=F.extend({},t),t},bI:function(t,i){for(var e=0;e<t.length;e++)i[t[e]]=Lt(i[t[e]])},TD:function(t,i,e,s,n){var r={container:e||this.qi,name:t,title:V(n)?t:n||"",series:s,style:i||"",width:this.xe,height:this.Me};return new Zi(r)},hD:function(t,i,e,s,n,r){var h,o=0;return this.N.yAxis&&(this.canvases.y||(this.canvases.y=this.TD("axis_y")),o=this.GD(this.canvases.y.getCanvas(),t,i,e,s,n)),this.N.xAxis&&(this.canvases.x||(this.canvases.x=this.TD("axis_x")),h=this.canvases.x.getCanvas(),this.callEvent("onBeforeXAxis",[h,t,i,e,r,o])&&this.aD(h,t,i,e,r,o)),o},aD:function(t,i,e,s,n,r){var h,o,a=this.N,u=e.x-.5,c=parseInt(r||s.y,10)+.5,f=s.x,l=!0,d="stackedBar"==a.type?s.y+.5:c;for(h=0;h<i.length;h++){
!0===a.offset?o=u+n/2+h*n:(o=h!=i.length-1||a.cellWidth?u+h*n:s.x,l=!!h),o=Math.ceil(o)-.5;var v="auto"!=a.origin&&"bar"==a.type&&parseFloat(a.value(i[h]))<a.origin;this.aI(o,d,i[h],l,v),(a.offset||h||a.cellWidth)&&a.xAxis.lines.call(this,i[h])&&this.uI(t,o,s.y,e.y,i[h])}this.canvases.x.renderTextAt(!0,!1,u,s.y+a.padding.bottom-3,a.xAxis.title,"webix_axis_title_x",s.x-e.x),this.eD(t,u,c,f,c,a.xAxis.color,1),a.xAxis.lines.call(this,{})&&a.offset&&this.eD(t,f+.5,s.y,f+.5,e.y+.5,a.xAxis.lineColor.call(this,{}),1)},GD:function(t,i,e,s,n,r){var h,o={};if(this.N.yAxis){var a=e.x-.5,u=s.y,c=e.y,f=s.y+.5;if(this.N.yAxis.step&&(h=parseFloat(this.N.yAxis.step)),"undefined"==typeof this.UD.step||"undefined"==typeof this.UD.start||"undefined"==typeof this.UD.end?(n=(o=this.HD(n,r)).start,r=o.end,h=o.step,this.N.yAxis.end=r,this.N.yAxis.start=n):"logarithmic"==this.config.scale&&(this.cD=!0),this.zD(e,s),0!==h){if(r==n)return u;for(var l=(u-c)*h/(r-n),d=0,v=this.N.origin,_=n;_<=r;_+=h){var p=this.cD?Math.pow(10,_):_;o.fixNum&&(p=parseFloat(p).toFixed(o.fixNum));var b=Math.floor(u-d*l)+.5;if(_==n&&"auto"==v||!this.N.yAxis.lines.call(this,_)||this.eD(t,a,b,s.x,b,this.N.yAxis.lineColor.call(this,_),1),"auto"!=v&&_<=v&&v<_+h&&(f=b-l*(v-p)/h),h<1&&!this.cD){var m=Math.min(Math.floor(this.fD(h)),n<=0?0:Math.floor(this.fD(n))),g=Math.pow(10,-m);_=p=Math.round(p*g)/g}this.canvases.y.renderText(0,b-5,this.N.yAxis.template(p.toString()),"webix_axis_item_y",e.x-5),d++}return this.eD(t,a,u+1,a,c,this.N.yAxis.color,1),f}}},zD:function(t,i){var e=this.canvases.y.renderTextAt("middle",!1,0,parseInt((i.y-t.y)/2+t.y,10),this.N.yAxis.title,"webix_axis_title_y");e&&(e.style.left=(e.offsetHeight-e.offsetWidth)/2+"px")},mI:function(t,i){return{start:Math.floor(this.fD(t)),step:1,end:Math.ceil(this.fD(i))}},gI:function(t){var i=Math.floor(this.fD(t)),e=Math.pow(10,i),s=t/e;return s=5<s?10:5,parseInt(s,10)*e},HD:function(t,i){if(this.cD=!1,"logarithmic"==this.N.scale){var e=Math.floor(this.fD(t)),s=Math.ceil(this.fD(i));if(0<t&&0<i&&1<s-e)return this.cD=!0,this.mI(t,i)}var n,r;"auto"!=this.N.origin&&this.N.origin<t&&(t=this.N.origin);var h=this.gI((i-t)/8||1),o=Math.floor(this.fD(h));if(h>Math.abs(t))n=t<0?-h:0;else{var a=Math.abs(t),u=Math.floor(this.fD(a)),c=a/Math.pow(10,u);for(n=0!=u||.1<=h?Math.ceil(10*c)/10*Math.pow(10,u)-h:a,1<a&&.1<h&&(n=Math.ceil(n));t<0?n<=t:t<=n;)n-=h;t<0&&(n=-n-2*h),n-=n%h,n=parseFloat((1*n).toFixed(Math.abs(o)))}for(10<i-n&&(h=this.gI((i-n)/8||1)),r=n,0==i&&i==t&&(i=h);r<i;)r+=h,r=parseFloat((1*r).toFixed(Math.abs(o)));return{start:n,end:r,step:h,fixNum:o<0?Math.abs(o):0}},rD:function(t,i){var e,s,n=this.data.uo(),r=arguments.length&&"h"==t?this.BD:this.UD;if(i=i||"value",r&&"undefined"!=typeof r.end&&"undefined"!=typeof r.start&&r.step)e=parseFloat(r.end),s=parseFloat(r.start);else if(e=He.max(this.uD[0][i],n),s=r&&"undefined"!=typeof r.start?parseFloat(r.start):He.min(this.uD[0][i],n),1<this.uD.length)for(var h=1;h<this.uD.length;h++){var o=He.max(this.uD[h][i],n),a=He.min(this.uD[h][i],n);e<o&&(e=o),a<s&&(s=a)}return{max:e,min:s}},fD:function(t){return Math.log(t)/Math.LN10},aI:function(t,i,e,s,n){if(this.N.xAxis){var r=this.canvases.x.renderTextAt(n,s,t,i-(n?2:0),this.N.xAxis.template(e));r&&(r.className+=" webix_axis_item_x")}},uI:function(t,i,e,s,n){this.N.xAxis&&this.N.xAxis.lines&&this.eD(t,i,e,i,s,this.N.xAxis.lineColor.call(this,n),1)},eD:function(t,i,e,s,n,r,h){t.strokeStyle=r,t.lineWidth=h,t.beginPath(),t.moveTo(i,e),t.lineTo(s,n),t.stroke(),t.lineWidth=1},oD:function(t,i){return[i!=t?i-t:t,1]},pI:[function(t){return"#FF"+Ze.toHex(t/2,2)+"00"},function(t){return"#FF"+Ze.toHex(t/2+128,2)+"00"},function(t){return"#"+Ze.toHex(255-t,2)+"FF00"},function(t){return"#00FF"+Ze.toHex(t,2)},function(t){return"#00"+Ze.toHex(255-t,2)+"FF"},function(t){return"#"+Ze.toHex(t,2)+"00FF"}],tf:["#f55b50","#ff6d3f","#ffa521","#ffc927","#ffee54","#d3e153","#9acb61","#63b967","#21a497","#21c5da","#3ea4f5","#5868bf","#7b53c0","#a943ba","#ec3b77","#9eb0b8"],Qc:0,addSeries:function(t){var i=this.N;this.N=F.extend({},i),this.Et(t),
this.uD.push(this.N),this.N=i},$tooltipIn:function(t){return t},ze:function(t,i){var e=this.locate(i);if(!e)return null;var s=this.wI(i),n=F.extend({dx:20,dy:0,template:"{obj.value}",css:""},this.uD[s].tooltip||{template:""},!0);return ni.Lt.define(n),this.getItem(e)},wI:function(t){var i,e,s,n,r,h,o,a;for(e=this.wu.xu,n=at(this.qi.Oi),o=(r=ct(t)).x-n.x,a=r.y-n.y,s=0;s<e.length;s++)o<=(i=e[s].points)[2]&&o>=i[0]&&a<=i[3]&&a>=i[1]&&(h?e[s].index>h.index&&(h=e[s]):h=e[s]);return h?h.index:0},hideSeries:function(t){this.canvases[t].hideCanvas();var i=this.N.legend;i&&i.values&&i.values[t]&&(i.values[t].$hidden=!0,this.vI()),this.wu.hide(this.qi,t,!0)},showSeries:function(t){this.canvases[t].showCanvas();var i=this.N.legend;i&&i.values&&i.values[t]&&(delete i.values[t].$hidden,this.vI()),this.wu.hide(this.qi,t,!1)},vI:function(t,i){var e,s,n,r,h,o,a,u,c,f,l,d=0,v=0;if(t=t||[],i=i||this.xe,u=this.canvases.legend.getCanvas(),s=this.N.legend,a="x"!=this.N.legend.layout?"width:"+s.width+"px":"",this.lI&&(this.lI.innerHTML="",this.lI.parentNode.removeChild(this.lI)),this.canvases.legend.clearCanvas(!0),n=st("DIV",{"class":"webix_chart_legend",style:"left:"+d+"px; top:"+v+"px;"+a},""),s.padding&&(n.style.padding=s.padding+"px"),this.lI=n,this.qi.appendChild(n),h=[],s.values)for(e=0;e<s.values.length;e++)h.push(this.xI(n,s.values[e].text,"undefined"!=typeof s.values[e].id?M(s.values[e].id):e,s.values[e].$hidden));else for(e=0;e<t.length;e++)h.push(this.xI(n,s.template(t[e]),t[e].id));var _,p,b=document.body.contains(this.qi);for(b||(p=st("DIV",{style:"visibility:hidden; position:absolute; top:0px; left:0px;"},""),_=this.qi.parentNode,document.body.appendChild(p),p.appendChild(this.qi)),o=n.offsetWidth,r=n.offsetHeight,o<i&&("x"==s.layout&&"center"==s.align&&(d=(i-o)/2),"right"==s.align&&(d=i-o),s.margin&&"center"!=s.align&&(d+=("left"==s.align?1:-1)*s.margin)),r<this.Me&&("middle"==s.valign&&"center"!=s.align&&"x"!=s.layout?v=(this.Me-r)/2:"bottom"==s.valign&&(v=this.Me-r),s.margin&&"middle"!=s.valign&&(v+=("top"==s.valign?1:-1)*s.margin)),n.style.left=d+"px",n.style.top=v+"px",u.save(),e=0;e<h.length;e++)l=h[e],c=s.values&&s.values[e].$hidden?(f=!0,s.values[e].disableColor?s.values[e].disableColor:"#edeff0"):(f=!1,s.values?s.values[e].color:this.N.color.call(this,t[e])),this.yI(u,l.offsetLeft+d,l.offsetTop+v,c,l.offsetHeight,f,e);u.restore(),b||(_.appendChild(this.qi),rt(p)),h=null},xI:function(t,i,e,s){var n="";"x"==this.N.legend.layout&&(n="float:left;");var r=st("DIV",{style:n+"padding-left:"+(10+this.N.legend.marker.width)+"px","class":"webix_chart_legend_item"+(s?" hidden":""),role:"button",tabindex:"0","aria-label":B.aria[(s?"show":"hide")+"Chart"]+" "+i},i);return 2<arguments.length&&r.setAttribute("series_id",e),t.appendChild(r),r},yI:function(t,i,e,s,n,r,h){var o=[],a=this.N.legend.marker,u=this.N.legend.values,c=u&&u[h].markerType?u[h].markerType:a.type;if(s&&(t.strokeStyle=t.fillStyle=s),"round"!=c&&a.radius)if("item"==c){if(this.N.line&&"scatter"!=this.N.type&&!this.N.disableLines){t.beginPath(),t.lineWidth=this.uD[h].line.width,t.strokeStyle=r?s:this.uD[h].line.color.call(this,{});var f=i+5,l=e+n/2;t.moveTo(f,l);var d=f+a.width;t.lineTo(d,l),t.stroke()}var v=this.uD[h].item,_=parseInt(v.radius.call(this,{}),10)||0,p=v.type.call(this,{});_&&(t.beginPath(),r?(t.lineWidth=v.borderWidth,t.strokeStyle=s,t.fillStyle=s):(t.lineWidth=v.borderWidth,t.fillStyle=v.color.call(this,{}),t.strokeStyle=v.borderColor.call(this,{}),t.globalAlpha=v.alpha.call(this,{})),t.beginPath(),i+=a.width/2+5,e+=n/2,this.MD(t,i,e,_+1,p),t.fill(),t.stroke()),t.globalAlpha=1}else t.beginPath(),t.lineWidth=1,i+=5,e+=n/2-a.height/2,o=[[i+a.radius,e+a.radius,a.radius,Math.PI,3*Math.PI/2,!1],[i+a.width-a.radius,e],[i+a.width-a.radius,e+a.radius,a.radius,-Math.PI/2,0,!1],[i+a.width,e+a.height-a.radius],[i+a.width-a.radius,e+a.height-a.radius,a.radius,0,Math.PI/2,!1],[i+a.radius,e+a.height],[i+a.radius,e+a.height-a.radius,a.radius,Math.PI/2,Math.PI,!1],[i,e+a.radius]],this.SD(t,o),t.stroke(),t.fill();else{t.beginPath();var b=a.height/2;t.arc(i+b+5,e+n/2,b,
0,2*Math.PI),t.fill()}},sI:function(t,i){var e,s,n,r;if(e=this.N.padding.left,s=this.N.padding.top,n=t-this.N.padding.right,r=i-this.N.padding.bottom,this.N.legend){var h=this.N.legend,o=this.N.legend.width,a=this.N.legend.height;"x"==h.layout?"center"==h.valign?"right"==h.align?n-=o:"left"==h.align&&(e+=o):"bottom"==h.valign?r-=a:s+=a:"right"==h.align?n-=o:"left"==h.align&&(e+=o)}return{start:{x:e,y:s},end:{x:n,y:r}}},kD:function(t){var i,e,s,n,r;if(this.N.yAxis&&"undefined"!=typeof this.N.yAxis.end&&"undefined"!=typeof this.N.yAxis.start&&this.N.yAxis.step)s=parseFloat(this.N.yAxis.end),n=parseFloat(this.N.yAxis.start);else{for(i=0;i<t.length;i++)for(t[i].$sum=0,t[i].$min=Infinity,e=0;e<this.uD.length;e++)r=Math.abs(parseFloat(this.uD[e].value(t[i])||0)),isNaN(r)||(-1!=this.uD[e].type.toLowerCase().indexOf("stacked")&&(t[i].$sum+=r),r<t[i].$min&&(t[i].$min=r));for(s=-Infinity,n=Infinity,i=0;i<t.length;i++)t[i].$sum>s&&(s=t[i].$sum),t[i].$min<n&&(n=t[i].$min);0<n&&(n=0)}return{max:s,min:n}},bD:function(t,i,e,s,n,r,h,o){var a,u,c,f,l,d;return"light"==r?(a="x"==o?t.createLinearGradient(i,e,s,e):t.createLinearGradient(i,e,i,n),d=[[0,"#FFFFFF"],[.9,h],[1,h]],u=2):"falling"==r||"rising"==r?(a="x"==o?t.createLinearGradient(i,e,s,e):t.createLinearGradient(i,e,i,n),c=Ze.toRgb(h),(f=Ze.rgbToHsv(c[0],c[1],c[2]))[1]*=.5,l="rgb("+Ze.hsvToRgb(f[0],f[1],f[2])+")","falling"==r?d=[[0,l],[.7,h],[1,h]]:"rising"==r&&(d=[[0,h],[.3,h],[1,l]]),u=0):(t.globalAlpha=.37,u=0,a="x"==o?t.createLinearGradient(i,n,i,e):t.createLinearGradient(i,e,s,e),d=[[0,"#9d9d9d"],[.3,"#e8e8e8"],[.45,"#ffffff"],[.55,"#ffffff"],[.7,"#e8e8e8"],[1,"#9d9d9d"]]),this.MI(a,d),{gradient:a,offset:u}},hf:function(t,i,e,s){return t*=-1,{x:i+=Math.cos(t)*s,y:e-=Math.sin(t)*s}},MI:function(t,i){for(var e=0;e<i.length;e++)t.addColorStop(i[e][0],i[e][1])},SD:function(t,i){var e,s;for(e=0;e<i.length;e++)s=e?"lineTo":"moveTo",2<i[e].length&&(s="arc"),t[s].apply(t,i[e])},SI:function(t,i,e,s,n){t.addRect(i,[e[0].x-s.x,e[0].y-s.y,e[1].x-s.x,e[1].y-s.y],n)}},vo={api:lo,view:F.protoUI(lo,Qh,to,io,eo,so,no,{$render_spline:function(t,i,e,s,n,r){var h,o,a,u,c,f,l,d,v,_,p,b,m;if(c=this.mD(t,i,e,s,n),h=this.N,this.xD=e,a=[],i.length){for(d=h.offset?e.x+.5*c.cellWidth:e.x,o=0;o<i.length;o++)((p=this.gD(i[o],e,s,c))||"0"==p)&&(l=o?c.cellWidth*o-.5+d:d,a.push({x:l,y:p,v:this.N.value(i[o]),index:o}));for(f=this.tI(a),o=0;o<a.length;o++){if(v=a[o].x,b=a[o].y,o<a.length-1){for(_=a[o+1].x,m=a[o+1].y,u=v;u<_;u++){var g=this.iI(u,v,o,f.a,f.b,f.c,f.d);g<e.y&&(g=e.y),g>s.y&&(g=s.y);var w=this.iI(u+1,v,o,f.a,f.b,f.c,f.d);w<e.y&&(w=e.y),w>s.y&&(w=s.y),this.eD(t,u,g,u+1,w,h.line.color(i[o]),h.line.width)}this.eD(t,_-1,this.iI(u,v,o,f.a,f.b,f.c,f.d),_,m,h.line.color(i[o]),h.line.width)}this.yD(t,v,b,i[a[o].index],h.label(i[a[o].index]),n,r)}}},tI:function(t){var i,e,s,n,r,h,o,a,u=[],c=[],f=t.length;for(r=0;r<f-1;r++)u[r]=t[r+1].x-t[r].x,c[r]=(t[r+1].y-t[r].y)/u[r];for(a=[],(o=[])[0]=0,o[1]=2*(u[0]+u[1]),a[0]=0,a[1]=6*(c[1]-c[0]),r=2;r<f-1;r++)o[r]=2*(u[r-1]+u[r])-u[r-1]*u[r-1]/o[r-1],a[r]=6*(c[r]-c[r-1])-u[r-1]*a[r-1]/o[r-1];for((h=[])[f-1]=h[0]=0,r=f-2;1<=r;r--)h[r]=(a[r]-u[r]*h[r+1])/o[r];for(i=[],e=[],s=[],n=[],r=0;r<f-1;r++)i[r]=t[r].y,e[r]=-u[r]*h[r+1]/6-u[r]*h[r]/3+(t[r+1].y-t[r].y)/u[r],s[r]=h[r]/2,n[r]=(h[r+1]-h[r])/(6*u[r]);for(r=0;r<t.length-1;r++)0===t[r].v&&0===t[r+1].v&&(i[r]=t[r].y,n[r]=s[r]=e[r]=0);return{a:i,b:e,c:s,d:n}},iI:function(t,i,e,s,n,r,h){return s[e]+(t-i)*(n[e]+(t-i)*(r[e]+(t-i)*h[e]))}},ro,ho,oo,{presets:{simple:{item:{borderColor:"#ffffff",color:"#2b7100",shadow:!1,borderWidth:2},line:{color:"#8ecf03",width:2}},plot:{color:"#8664C6",item:{borderColor:"#8664C6",borderWidth:1,color:"#ffffff",type:"r",shadow:!1},line:{color:"#8664C6",width:2}},diamond:{color:"#FF5C4C",item:{borderColor:"#FF5C4C",color:"#FF5C4C",type:"d",radius:3,shadow:!0},line:{color:"#FF5C4C",width:2}},point:{color:"#1ca1c1",disableLines:!0,fill:!1,disableItems:!1,item:{color:"#1ca1c1",borderColor:"#1ca1c1",radius:2,borderWidth:2,type:"r"},alpha:1},line:{line:{color:"#1ca1c1",width:2},item:{color:"#ffffff",
borderColor:"#1ca1c1",radius:2,borderWidth:2,type:"d"},fill:!1,disableItems:!1,disableLines:!1,alpha:1},area:{fill:"#1ca1c1",line:{color:"#1ca1c1",width:1},disableItems:!0,alpha:.2,disableLines:!1},round:{item:{radius:3,borderColor:"#1ca1c1",borderWidth:1,color:"#1ca1c1",type:"r",shadow:!1,alpha:.6}},square:{item:{radius:3,borderColor:"#00a497",borderWidth:2,color:"#ffffff",type:"s",shadow:!1,alpha:1},line:{color:"#00a497"}},column:{color:"RAINBOW",gradient:!1,barWidth:45,radius:0,alpha:1,border:!0},stick:{barWidth:5,gradient:!1,color:"#1ca1c1",radius:2,alpha:1,border:!1},alpha:{color:"#b9a8f9",barWidth:70,gradient:"falling",radius:0,alpha:.5,border:!0}}},ao,uo,Ee,Ji,ke,We,p,Gi.view)},_o={name:"rangechart",$init:function(){this.attachEvent("onAfterRender",this.kI),this.CI()},kI:function(){var i=this;if(-1===this.N.type.indexOf("pie")&&"radar"!==this.N.type&&this.N.type,this.wu.xu.length&&!this.$I){this.DI(),this.II=(this.wu.xu[0].points[2]-this.wu.xu[0].points[0])/2;var t={webix_disable_drag:"true",tabindex:"0",role:"button","aria-label":B.aria.resizeChart};this.AI=st("div",F.extend({"class":"webix_chart_resizer right"},t)),this.TI=st("div",F.extend({"class":"webix_chart_resizer left"},t)),this.$I=st("div",{"class":"webix_chart_frame",webix_disable_drag:"true"}),this.zt.appendChild(this.TI),this.zt.appendChild(this.$I),this.zt.appendChild(this.AI),this.FI(),Yt(this.AI,St.mouse.down,function(t){return i.VI(t,"mouse")}),Yt(this.TI,St.mouse.down,function(t){return i.VI(t,"mouse")}),Yt(this.$I,St.mouse.down,function(t){return i.VI(t,"mouse")}),St.touch&&(Yt(this.AI,St.touch.down,function(t){return i.VI(t,"touch")}),Yt(this.TI,St.touch.down,function(t){return i.VI(t,"touch")}),Yt(this.$I,St.touch.down,function(t){return i.VI(t,"touch")})),Yt(D(this.AI),"keydown",this.zI,{bind:this}),Yt(D(this.TI),"keydown",this.zI,{bind:this}),this.f$&&(this.N.range=this.CI(this.f$)),this.BI(),this.callEvent("onAfterRangeChange",[this.f$]),this.data.attachEvent("onStoreUpdated",k(this.BI,this))}else this.FI(!0)},$setSize:function(t,i){vo.api.$setSize.call(this,t,i)&&(this.DI(),this.BI())},FI:function(t){this.AI&&!this.HI&&(this.HI=this.AI.clientWidth/2,t&&this.BI())},DI:function(){var t=this.sI(this.xe,this.Me);this.xD=t.start,this.RI=t.end},removeAllSeries:function(){this.$I=this.AI=this.TI=null,vo.api.removeAllSeries.apply(this,arguments)},zI:function(t){var i=t.which||t.keyCode;if(37===i||39===i){ft(t);var e=-1!==t.target.className.indexOf("right")?"eindex":"sindex",s=-1!==t.target.className.indexOf("right")?"end":"start",n=this.f$;n[e]=n[e]+(37===i?-1:1),this.wu.xu[n[e]]&&(n[s]=this.EI(n[e]),this.setFrameRange(n))}},VI:function(t,i){var e=this;if(-1!==t.target.className.indexOf("webix_chart_resizer"))this.jI=t.target;else if(this.wu.xu.length){var s=this.wu.xu[this.f$.sindex].points[2]-this.II,n=this.wu.xu[this.f$.eindex].points[2]-this.II;this.NI={ex:ct(t).x,fx:s+this.xD.x,fw:n-s}}vt(this.zt,"webix_noselect webix_wresize_cursor"),this.LI();var r="touch"===i?{passive:!1}:null;this.OI=Gt(document.body,St[i].move,function(t){return e.WI(t,i)},r),this.UI=Gt(document,St[i].up,function(t){return e.qI(t,i)})},LI:function(){this.OI&&(Xt(this.OI),Xt(this.UI),this.UI=this.OI=null)},WI:function(t,i){if(this.jI){var e=ct(t).x-at(this.$view).x;e>=this.xD.x&&e<=this.RI.x&&(-1!==this.jI.className.indexOf("left")?e<this.AI.offsetLeft&&(this.jI.style.left=e-this.HI+"px",this.$I.style.left=e+"px",this.$I.style.width=this.AI.offsetLeft-this.TI.offsetLeft-1+"px"):e>this.TI.offsetLeft+this.HI&&(this.jI.style.left=e-this.HI+"px",this.$I.style.width=this.AI.offsetLeft-this.TI.offsetLeft-1+"px"))}else if(this.NI){var s=ct(t).x-this.NI.ex,n=this.NI.fx+s,r=n+this.NI.fw;this.xD.x<=n&&this.RI.x>=r&&(F.extend(this.NI,{lx:n,rx:r},!0),this.TI.style.left=n-this.HI+"px",this.AI.style.left=r-this.HI+"px",this.$I.style.left=n+"px")}"touch"===i&&ft(t)},qI:function(t,i){if(this.LI(),_t(this.zt,"webix_noselect"),_t(this.zt,"webix_wresize_cursor"),this.count()){if(this.jI){var e="touch"===i?t.changedTouches[0].pageX:ct(t).x;e-=at(this.$view).x+this.xD.x;var s=this.YI(e),
n=this.EI(s);this.jI===this.TI?(s>=this.f$.eindex&&(s=this.f$.eindex,n=this.EI(s)),this.f$.start=n,this.f$.sindex=s):(s<=this.f$.sindex&&(s=this.f$.sindex,n=this.EI(s)),this.f$.end=n,this.f$.eindex=s),this.jI=null}else if(this.NI&&this.NI.lx){var r=this.f$.sindex=this.YI(this.NI.lx-this.xD.x),h=this.f$.eindex=this.YI(this.NI.rx-this.xD.x);this.f$.start=this.EI(r),this.f$.end=this.EI(h),this.NI=null}this.BI(),this.callEvent("onAfterRangeChange",[this.f$.start,this.f$.end])}},EI:function(t){return t>=this.data.order.length&&(t=this.data.order.length-1),this.getItem(this.data.order[t])[this.N.frameId||"id"]},YI:function(t){for(var i=this.wu.xu,e=0;e<i.length;e++)if(t<=i[e].points[2]-this.II)return e;return i.length-1},GI:function(t){for(var i=this.N.frameId||"id",e=0;e<this.data.order.length;e++)if(this.getItem(this.data.order[e])[i]==t)return e;return-1},CI:function(t){t?(t.start&&(t.sindex=this.GI(t.start)),t.end&&(t.eindex=this.GI(t.end)),t.start=t.start||this.EI(t.sindex),t.end=t.end||this.EI(t.eindex)):t={start:0,end:0,sindex:0,eindex:0},this.f$=t},range_setter:function(t){return this.CI(t),this.f$},getFrameData:function(){for(var t=[],i=this.f$.sindex;i<=this.f$.eindex;i++){var e=this.getItem(this.data.order[i]);e&&t.push(e)}return t},setFrameRange:function(t){this.CI(t),this.BI(),this.callEvent("onAfterRangeChange",[t])},BI:function(){if(this.wu){var t=this.wu.xu;if(t.length){var i=t[this.f$.sindex].points[0]+this.xD.x+this.II-1,e=t[this.f$.eindex].points[0]+this.xD.x+this.II-1;this.TI.style.left=i-this.HI+"px",this.AI.style.left=e-this.HI+"px",this.$I.style.left=i+"px",this.$I.style.width=e-i+"px",this.N.range=this.f$}}},getFrameRange:function(){return this.N.range}},po=(F.protoUI(_o,vo.view),{name:"grouplist",defaults:{animate:{}},Wm:"webix_grouplist",$init:function(){F.extend(this.data,Ms,!0),this.data.count=function(){return this.order.length},this.data.provideApi(this,!0),this.data.attachEvent("onClearAll",k(this.XI,this)),this.XI()},XI:function(){this.KI=[],this.JI=[]},$setSize:function(){Gi.api.$setSize.apply(this,arguments)&&(this.it.style.width=this.xe)},on_click:{webix_list_item:function(t,i){return!this.t_&&(this.hh(i)||this.Tu(i)?this.render():void(this.N.select&&(this.qm=!0,"multiselect"==this.N.select||this.N.multiselect?this.select(i,!1,"touch"==this.N.multiselect||t.ctrlKey||t.metaKey,t.shiftKey):this.select(i),this.qm=!1)))}},hh:function(t){for(var i=0;i<this.JI.length;i++)if(this.JI[i]==t){for(var e=i;e<this.JI.length;e++)this.data.getItem(this.JI[e]).$template="";return i?(this.KI=this.data.branch[this.JI[i-1]],this.JI.splice(i)):(this.KI=this.data.branch[0],this.JI=[]),!(this.ZI=!1)}},Tu:function(t){var i=this.getItem(t);if(i.$count&&-1===x.find.call(this.JI,t))return i.$template="Back",this.KI=this.data.branch[i.id],this.JI.push(t),this.ZI=!0},getOpenState:function(){return{parents:this.JI,branch:this.KI}},setOpenState:function(t){var i=0;if(t){var e=this.getItem(t);i=e.$count?e.id:e.$parent}for(this.KI=this.data.branch[i],this.JI=[];i;)this.getItem(i).$template="Back",this.JI.unshift(i),i=this.getItem(i).$parent;this.qm=!0,this.render(),this.qm=!1},render:function(t,i,e){var s,n,r=this,h=arguments;if(this.JI=S(this.JI),this.KI=S(this.KI),this.JI.length)for(s=0;s<this.JI.length;s++)this.data.branch[this.JI[s]]||(this.JI.splice(s,1),s--);if(n=this.JI.length?this.JI[this.JI.length-1]:0,this.KI=S(this.data.branch[n]),!this.KI.length&&this.JI.length&&(this.KI=[n],this.JI.pop()),this.t_)return this.t_.then(function(){return r.render.apply(r,h)});for(s=0;s<this.KI.length;s++)this.data.getItem(this.KI[s]).$template="";if(this.KI.length||(this.KI=this.data.branch[0]),this.data.order=T([].concat(this.JI).concat(this.KI)),this.callEvent("onBeforeRender",[this.data])){if(!this.qm&&this.it.innerHTML&&this.N.animate&&this.QI!=this.JI.length){if(this.callEvent("onBeforeRender",[this.data])){this.tA||(this.tA=[]);var o=this.it.cloneNode(!1);o.innerHTML=this.data.getRange().map(this.tt,this).join("");var a=F.extend({},this.N.animate);a.direction=this.ZI?"left":"right";var u,c=[l(a),l(a)];this.ZI?this.tA.push(
this.getScrollState()):u=this.tA.pop();var f=Qi.formLine(o,this.it,a);a.master=this,a.callback=function(){this.it=o,this.ZI?this.scrollTo(0,0):u&&this.scrollTo(0,u.y),Qi.breakLine(f),a.master=a.callback=null,this.Oi=this.t_=null,a.wait_animation.resolve(),this.callEvent("onAfterRender",[])},Qi(f,c),this.t_=a.wait_animation=b.defer()}}else{if(t&&"delete"!==e&&-1===this.data.getIndexById(t))return;Xe.render.apply(this,arguments)}this.QI=this.JI.length}},templateBack_setter:function(t){this.type.templateBack=Lt(t)},templateItem_setter:function(t){this.type.templateItem=Lt(t)},templateGroup_setter:function(t){this.type.templateGroup=Lt(t)},type:{template:function(t,i){return t.$count?i.templateGroup(t,i):i.templateItem(t,i)},css:"group",classname:function(t,i,e){return"webix_list_item webix_"+(t.$count?"group":"item")+(t.$template?"_back":"")+(e&&e.webix_selected?" webix_selected":"")+(i.css?" "+i.css:"")+(t.$css?" "+t.$css:"")},templateStart:Lt('<div webix_l_id="#id#" class="{common.classname()}" style="width:{common.widthSize()}; height:{common.heightSize()};  overflow:hidden;" {common.aria()}>'),templateBack:Lt("#value#"),templateItem:Lt("#value#"),templateGroup:Lt("#value#"),templateEnd:function(t){var i="";return t.$count&&(i+="<div class='webix_arrow_icon'></div>"),i+="</div>"}},showItem:function(t){-1===this.data.getIndexById(t)&&this.setOpenState(t),Xe.showItem.call(this,t)}});Kt(F.protoUI(po,Ee,Kr.view),{});var bo={name:"unitlist",_id:"webix_item_id",uniteBy_setter:Lt,render:function(t,i,e){var s=this.N;if(this.isVisible(s.id)&&s.uniteBy){if(t){var n=this.getItemNode(t);if(n&&"update"==e&&this.N.uniteBy.call(this,i)==this.getItem(t).$unitValue)return ht(this.Oi[t]=this.Dc(i),n),void rt(n)}this.callEvent("onBeforeRender",[this.data])&&(this.units=null,this.iA(),this.units&&(this.callEvent("onUnits",[]),this.it.innerHTML=this.eA().map(this.tt,this).join(""),this.Oi=null),this.callEvent("onAfterRender",[]))}},getUnits:function(){var t=[];if(this.units)for(var i in this.units)t.push(i);return t},getUnitList:function(t){return this.units?this.units[t]:null},tt:function(t){var i=this.data.Vh[t.id];return!t.$template||this.type["template"+t.$template],t.$template,this.callEvent("onItemRender",[t]),t.$unit?this.type.templateStartHeader(t,this.type)+this.type.templateHeader.call(this,t.$unit)+this.type.templateEnd(t,this.type):this.type.templateStart(t,this.type,i)+(t.$template?this.type["template"+t.$template]:this.type.template)(t,this.type)+this.type.templateEnd(t,this.type)},eA:function(){var t=[],i=this.data.$min||0,e=this.data.$max||Infinity,s=0;for(var n in this.units){t.push({$unit:n});for(var r=this.units[n],h=0;h<r.length;h++){if(s==i&&(t=[{$unit:n}]),t.push(this.getItem(r[h])),s==e)return T(t);s++}}return T(t)},iA:function(){var e=this;this.units={},this.data.each(function(t){var i=e.N.uniteBy.call(this,t);t.$unitValue=i,e.units[i]||(e.units[i]=[]),e.units[i].push(t.id)})},type:{headerHeight:20,classname:function(t,i,e){var s="webix_list_item";return i.css&&(s+=" webix_list_"+i.css+"_item"),e&&e.$css&&(s+=" "+e.$css),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),s},templateHeader:function(t){return"<span class='webix_unit_header_inner'>"+t+"</span>"},templateStart:function(t,i,e){if(t.$unit)return i.templateStartHeader.apply(this,arguments);var s="width:"+i.widthSize(t,i,e)+"; height:"+i.heightSize(t,i,e)+"; overflow:hidden;"+(i.layout&&"x"==i.layout?"float:left;":"");return'<div webix_item_id="'+t.id+'" class="'+i.classname(t,i,e)+'" style="'+s+'" '+i.aria(t,i,e)+">"},templateStartHeader:function(t,i,e){var s="webix_unit_header"+(i.css?" webix_unit_header_"+i.css+"_item":""),n="width:"+i.widthSize(t,i,e)+"; height:"+i.headerHeight+"px; overflow:hidden;";return'<div webix_unit_id="'+t.$unit+'" class="'+s+'" style="'+n+'">'}},$skin:function(){Kr.api.$skin.call(this),this.type.headerHeight=te.unitHeaderHeight}};F.protoUI(bo,Kr.view);B.dbllist={selectAll:"<span class='webix_icon wxi-angle-double-right'></span>",selectOne:"<span class='webix_icon wxi-angle-right'></span>",
deselectAll:"<span class='webix_icon wxi-angle-double-left'></span>",deselectOne:"<span class='webix_icon wxi-angle-left'></span>"};var mo={name:"dbllist",defaults:{borderless:!0},$init:function(){this.sA={},this.nA=k(function(t){return this.sA[t.id]},this),this.rA=k(function(t){return!this.sA[t.id]},this),this.$view.className+=" webix_dbllist",this.$ready.unshift(this.Yg)},$onLoad:function(t,i){var e=this.$$("left"),s=this.$$("right");return this.hA(function(){e.data.driver=i,e.parse(t),s.data.driver=i,s.parse(t)}),this.oA=!0,this.c$(),!0},aA:function(){if(!1===this.N.buttons)return{width:10};var t=B.dbllist,i=[this.uA("deselect_all",t.deselectAll),this.uA("select_all",t.selectAll),this.uA("deselect_one",t.deselectOne),this.uA("select_one",t.selectOne)];return i={width:120,template:i.join(""),onClick:{dbllist_button:function(t,i,e){this.getTopParentView().cA(e.getAttribute("action"))}}},this.N.buttons&&(i.template=this.N.buttons),i},uA:function(t,i){return"<button class='dbllist_button' action='"+t+"'>"+i+"</button>"},fA:function(t,i,e,s){var n={view:"list",select:"multiselect",multiselect:"touch",id:t,action:i,drag:!0,type:{margin:3,id:t},on:{onBeforeDrop:function(t){var i=t.from,e=t.to,s=i.getTopParentView();if(s===this.getTopParentView()){var n="select_one"!=e.N.action;s.select(t.source,n)}return!1},onItemDblClick:function(){return this.getTopParentView().cA(this.config.action)}}};return this.N.list&&F.extend(n,this.N.list,!0),e&&(n={rows:[{view:"label",label:e,css:"webix_inp_top_label"},n]}),s?{rows:[n,{view:"label",height:20,label:s,css:"bottom_label"}]}:n},Yg:function(){var t=[{margin:10,type:"clean",cols:[this.fA("left","select_one",this.N.labelLeft,this.N.labelBottomLeft),this.aA(),this.fA("right","deselect_one",this.N.labelRight,this.N.labelBottomRight)]}];this.cols_setter(t)},cA:function(t){var i=null,e=!1;"select_all"===t?(i=this.$$("left").data.order,e=!0):"select_one"===t?(i=this.$$("left").getSelectedId(!0),e=!0):"deselect_all"===t?(i=this.$$("right").data.order,e=!1):"deselect_one"===t&&(i=this.$$("right").getSelectedId(!0),e=!1),this.select(i,e)},select:function(t,i){var e;if("object"!==M(t)&&(t=[t]),i)for(e=0;e<t.length;e++)this.sA[t[e]]=!0;else for(e=0;e<t.length;e++)delete this.sA[t[e]];this.c$(),this.callEvent("onChange",[])},hA:function(t,i){ai(k(t,this),!1),i&&(this.$$("left").N.autoheight||this.$$("right").N.autoheight)&&this.resize()},c$:function(){var t=this.$$("left"),i=this.$$("right");t&&this.hA(function(){t.filter(this.rA),i.filter(this.nA)},!0)},focus:function(){if(!Bi.canFocus(this))return!1;Bi.setFocus(this)},value_setter:function(t){this.setValue(t)},setValue:function(t){if(this.sA={},t){"object"!==M(t)&&(t=t.toString().split(","));for(var i=0;i<t.length;i++)this.sA[t[i]]=!0}this.c$()},getValue:function(){var t=[],i=this.$$("left");for(var e in this.sA)this.oA&&!i.data.pull[e]||t.push(e);return t.join(",")}},go=(F.protoUI(mo,Ft,Ne,$n.view),{name:"tree",defaults:{scroll:"auto",navigation:!0},$init:function(){this.zt.className+=" webix_tree",F.extend(this.data,Ms,!0),F.extend(this.on_click,ms),this.data.provideApi(this,!0),this.zt.setAttribute("role","tree")},_id:"webix_tm_id",on_context:{},on_dblclick:{webix_tree_checkbox:function(){if(this.on_click.webix_tree_checkbox)return this.on_click.webix_tree_checkbox.apply(this,arguments)}},$fixEditor:function(t){var i=this.getItemNode(t.id).querySelector("span");if(i){""===i.innerHTML&&(i.innerHTML="&nbsp;");var e=i.offsetLeft;t.node.style.width=this.$view.scrollWidth-e-10+"px",t.node.style.marginLeft=e+"px",t.node.style.left="0px"}},on_click:{webix_tree_item:function(t,i){this.N.activeTitle&&(this.getItem(i).open?this.close(i):this.open(i));if(this.N.select)if("multiselect"==this.N.select||this.N.multiselect){var e=t.ctrlKey||t.metaKey||"touch"==this.N.multiselect;if("level"==this.N.multiselect&&(e||t.shiftKey)){var s=this.getSelectedId(!0)[0];if(s&&this.getParentId(i)!=this.getParentId(s))return}this.select(i,!1,e,t.shiftKey)}else this.select(i)}},Zn:{insert:function(t){var i=this.getSelectedId()||"0";this.add({value:t},null,i)},
modify:function(t){for(var i=this.getSelectedId(!0),e=0;e<i.length;e++)this.getItem(i[e]).value=t,this.refresh(i[e])},custom:function(){}},ea:!0,$dragHTML:function(t,i,e){var s="<div class='webix_tree_item'>"+this.type.template(t,this.type)+"</div>";return I(e.source)&&1<e.source.length&&(s=this.Xo(s,e.source.length)),s},ta:function(t){for(var i=t.source,e=0;e<i.length;e++)this.close(i[e])},Qo:function(t,i){var e=this.getItemNode(t);e?e.parentNode.insertBefore(re.dn[0],e):i.children[0].children[0].appendChild(re.dn[0])},type:F.extend({template:function(t,i){return(i["template"+t.level]||i.templateCommon).apply(this,arguments)},classname:function(t,i,e){var s="webix_tree_item";return t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),e&&e.$css&&(s+=" "+e.$css),i.css&&(s+=" "+i.css),s},aria:function(t,i,e){return'role="treeitem"'+(e&&e.webix_selected?' aria-selected="true" tabindex="0"':' tabindex="-1"')+(t.$count?'aria-expanded="'+(t.open?"true":"false")+'"':"")+'aria-level="'+t.$level+'"'},templateCommon:Lt("{common.icon()}{common.folder()}<span>#value#</span>"),templateStart:Lt('<div webix_tm_id="#id#" class="{common.classname()}" {common.aria()}>'),templateEnd:Lt("</div>"),templateCopy:Lt("#value#")},ks)}),wo=F.protoUI(go,ys,Ee,bs,$e,ws,Je,Le,We,Ke,gs,Gr.view,xs,_e,p),xo={api:go,view:wo};Kt(wo,{name:"lineTree",css:"webix_line_tree",icon:function(t,i){for(var e="",s="",n=1;n<=t.$level;n++){n==t.$level&&(s=t.$count?t.open?"webix_tree_open ":"webix_tree_close ":"webix_tree_none ");var r=i.lA(t,i,n);r&&(e+="<div class='"+s+"webix_tree_img webix_tree_"+r+"'></div>")}return e},lA:function(t,i,e){var s=i.Mf,n=xs.Re;if(0===s&&n){var r=t.$level,h=t.id;for(s=[];r;){var o=n.getParentId(h),a=n.data.branch[o];a[a.length-1]==h&&(s[r]=!0),h=o,r--}i.Mf=s}if(!s)return 0;if(e!=t.$level)return s[e]?"blank":"line1";var u=3;return t.$parent||0===t.$index&&(u=4),s[t.$level]&&(u=2),t.$count?t.open?"minus"+u:"plus"+u:"line"+u}});var yo={name:"treemap",defaults:{activeItem:!1,subRender:!0,header:!0,headerHeight:35,value:Lt("#value#"),headerTemplate:"",navigation:!0},value_setter:Lt,headerTemplate_setter:Lt,header_setter:function(t){return t&&!0!==t&&(this.type.header=t),t},$init:function(){this.$view.className+=" webix_treemap",this.zt.setAttribute("role","tree"),this.dA=document.createElement("DIV"),F.extend(this.data,Ms,!0),this.data.provideApi(this,!0),this.data.attachEvent("onClearAll",k(function(){this.Ui="",this.$values={},this.$xy={}},this)),this.attachEvent("onKeyPress",this.De)},wf:function(t){var i=this.data.Vh[t.id];this.callEvent("onItemRender",[t]);var e=t.$template?this.type["template"+t.$template].call(this,t,this.type,i):this.type.template.call(this,t,this.type,i);return this.type.templateStart.call(this,t,this.type,i)+e+this.type.templateEnd.call(this)},vA:function(t){var i=this.getItem(t),e=this.N.headerHeight,s="<div class='webix_treemap_header' style='height:"+e+"px;line-height:"+e+"px;'>";return s+=this.type.header.call(this,i,this.type),s+="</div>"},_A:function(t){var i,e,s,n,r=[];if(!this.$width||!this.count())return this.Ui="",!1;if(t||(t=this.config.branch||0,this.Ui="",this.$values={},this.$xy={},this.$xy[t]={width:this.$width,height:this.$height,top:0,left:0},t&&this.N.header&&(this.$xy[t].height-=this.N.headerHeight,this.$xy[t].top=this.N.headerHeight,this.Ui+=this.vA(t)),n=0,this.data.each(function(t){var i=this.getParentId(t.id);if(!this.data.branch[t.id]&&(s=1*this.config.value.call(this,t),!isNaN(s)&&s))for(this.$values[t.id]=s,n+=s;i;)this.$values[i]||(this.$values[i]=0),this.$values[i]+=s,i=this.getParentId(i)},this,!1,t)),this.data.eachChild(t,function(t){this.$values[t.id]&&r.push(S(t))},this),n=n||this.$values[t],r.length&&n){(e={top:(i=this.$xy[t]).top,left:i.left,dx:i.width,dy:i.height,set:[],sum:0}).dim=Math.min(e.dx,e.dy);for(var h=e.dx*e.dy/n,o=0;o<r.length;o++)r[o].$value=this.$values[r[o].id]*h;r.sort(function(t,i){return t.$value>i.$value?-1:1});for(var a=Infinity,u=0;r[u];){var c=this.pA(e,r[u]);if(c<a)e.sum+=r[u].$value,e.set.push(r[u]),a=c,u++;else{this.ab(e);var f={top:e.top,
left:e.left,dx:e.dx,dy:e.dy,set:[],sum:0},l=e.sum/e.dim;e.dx>e.dy?(f.left+=l,f.dx-=l):(f.top+=l,f.dy-=l),(e=f).dim=Math.min(e.dx,e.dy),a=Infinity}}}e&&this.ab(e)},ab:function(t){var i,e,s,n,r=t.top,h=t.left;for(t.mode=t.dy<t.dx,t.contra=t.sum/t.dim,i=0;i<t.set.length;i++)e=t.set[i].id,n=t.mode?(s=t.contra,t.set[i].$value/t.contra):(s=t.set[i].$value/t.contra,t.contra),this.$xy[e]={},this.$xy[e].top=r,this.$xy[e].left=h,t.mode?r+=n:h+=s,this.$xy[e].width=s,this.$xy[e].height=n,this.Ui+=this.wf(this.getItem(e)),this.N.subRender&&this.data.branch[e]&&this._A(e)},pA:function(t,i){var e=t.sum+i.$value,s=e*e/(t.dim*t.dim*i.$value);return t.set.length&&(s=Math.max(t.dim*t.dim*t.set[0].$value/(e*e),s)),1<s?s:1/s},Dc:function(t){return this.dA.innerHTML=this.wf(t),this.dA.firstChild},showBranch:function(t){this.N.branch=t,this.refresh()},render:function(t,i,e){if(this.isVisible(this.N.id)&&!this.$blockRender){if("update"==e){var s=this.getItemNode(t);if(s)ht(this.Oi[t]=this.Dc(i),s),rt(s)}else!this.data.branch||this.N.branch&&!this.data.branch[this.N.branch]||(this.Oi=null,this.callEvent("onBeforeRender",[]),this._A(),this.it.innerHTML=this.Ui,this.callEvent("onAfterRender",[]));return!0}},_id:"webix_dm_id",on_click:{webix_treemap_item:function(t,i){this.N.select&&("multiselect"==this.N.select||this.N.multiselect?this.select(i,!1,t.ctrlKey||t.metaKey||"touch"==this.N.multiselect,t.shiftKey):this.select(i)),this.N.activeItem&&this.isBranch(i)&&this.showBranch(i)},webix_treemap_header_item:function(t){var i=ot(t,"webix_dm_header_id");this.define("branch",i),this.refresh()},webix_treemap_reset:function(){this.define("branch",0),this.refresh()}},on_dblclick:{},on_mouse_move:{},bA:function(t){var i="";for(var e in t)i+=e+":"+t[e]+";";return i},type:{template:Lt("#value#"),header:function(t,i){for(var e=t.id,s="<div role='button' tabindex='0' aria-label='"+B.aria.resetTreeMap+"' class='webix_treemap_reset'></div>",n=[];e;)t=this.getItem(e),n.push(i.headerItem.call(this,t,i)),e=this.getParentId(e);return n.reverse(),s+n.join("<span class='webix_icon wxi-angle-right webix_treemap_path_icon'></span>")},headerItem:function(t){var i=this.config.headerTemplate(t),e='<a role="button" tabindex="0" aria-label="'+i+'" webix_dm_header_id="'+t.id+'" class="webix_treemap_header_item">';return e+=i,e+="</a>"},classname:function(t,i,e){var s="webix_treemap_item";i.css&&(s+=" "+i.css),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css);var n=this.$xy[t.id];e&&e.$css&&(s+=" "+e.$css),s+=" webix_treemap_level_"+this.getItem(t.id).$level;var r=this.getParentId(t.id);if(r&&r!=this.N.branch||(s+=" webix_treemap_level_top"),this.$height-n.top-n.height<1&&(s+=" webix_treemap_item_bottom"),this.$width-n.left-n.width<1&&(s+=" webix_treemap_item_right"),i.cssClass){var h=i.cssClass.call(this,t,i,e);h&&("object"==M(h)?s+=" "+tt(h):s+=" "+h)}return s},templateStart:function(t,i,e){var s="";if(this.$xy){var n=this.$xy[t.id];s+="width: "+n.width+"px; height: "+n.height+"px;",s+="top: "+n.top+"px; left: "+n.left+"px;"}return'<div role="treeitem" aria-level="'+t.$level+'" '+(e&&e.webix_selected?'aria-selected="true" tabindex="0"':"")+' webix_dm_id="'+t.id+'" class="'+i.classname.call(this,t,i,e)+'" style="'+s+'">'},templateEnd:Lt("</div>")}},Mo=(F.protoUI(yo,Ee,bs,Je,Le,We,Ke,gs,Gr.view,xs,_e,p),{name:"dataview",$init:function(t){t.sizeToContent&&this.$ready.unshift(this.vh);var i=t.type||t.item;t.prerender||this.defaults.prerender||i&&"auto"==i.width||"move"==t.drag||"order"==t.drag||t.autoheight||F.extend(this,Is,!0),t.autoheight&&(t.scroll=!1),i&&"tiles"==i.type&&(this.ul=i.padding||this.type.padding,this.zt.firstChild.style["float"]="left",this.zt.firstChild.style.padding=this.ul/2+"px"),this.qi.className+=" webix_dataview",this.zt.setAttribute("role","listbox")},vh:function(){var t=st("DIV",0,this.type.template({}));t.className="webix_dataview_item",t.style.position="absolute",document.body.appendChild(t),this.type.width=t.offsetWidth+this.ul,this.type.height=t.offsetHeight+this.ul,rt(t)},defaults:{scroll:!0,datafetch:50,navigation:!0},
_id:"webix_l_id",lr:"webix_dataview_item",ul:0,na:"x",on_click:{webix_dataview_item:function(t,i){this.N.select&&("multiselect"==this.N.select||this.N.multiselect?this.select(i,!1,"touch"==this.N.multiselect||t.ctrlKey||t.metaKey,t.shiftKey):this.select(i))}},on_dblclick:{},on_mouse_move:{},type:{template:Lt("#value#"),templateLoading:Lt("Loading..."),width:160,height:50,padding:8,classname:function(t,i,e){var s="webix_dataview_item";return i.css&&(s+=" "+i.css),i.type&&(s+=" "+i.type),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),e&&e.$css&&(s+=" "+e.$css),s},aria:function(t,i,e){return'role="option"'+(e&&e.webix_selected?' aria-selected="true" tabindex="0"':' tabindex="-1"')},templateStart:function(t,i,e){var s=i.width,n=i.height,r=0;return"tiles"==i.type&&(s-=i.padding,n-=i.padding,r=i.padding/2),'<div webix_l_id="'+t.id+'" class="'+i.classname(t,i,e)+'" '+i.aria(t,i,e)+' style="margin:'+r+"px; width:"+s+"px; height:"+n+'px; float:left; overflow:hidden;">'},templateEnd:Lt("</div>")},$dropHTML:function(){var t=this.ul;return'<div class="webix_drop_area_inner" style="width:'.concat(this.type.width-t,"px; height:").concat(this.type.height-t,"px; margin:").concat(t/2,'px"></div>')},mA:function(t){return this.N.height=this.type.height*Math.ceil(this.data.count()/Math.floor(t/this.type.width))},autoheight_setter:function(t){var s=this;return t&&(this.data.attachEvent("onStoreLoad",function(){return s.resize()}),this.data.attachEvent("onStoreUpdated",function(t,i,e){t&&"add"!==e&&"delete"!==e||s.Um()}),this.data.attachEvent("onSyncApply",function(){return s.Um()}),this.qi.style.overflowY="hidden"),t},Um:function(){this.N.autoheight&&this.resize()},$getSize:function(t,i){this.N.xCount&&"auto"!=this.type.width&&!this.gA&&(this.N.width=this.type.width*this.N.xCount+this.ul+(this.ye?St.scrollSize:0)),this.N.yCount&&"auto"!=this.type.height&&!this.wA&&(this.N.height=this.type.height*this.N.yCount+this.ul);var e=this.N.width||this.xe;return this.N.autoheight&&e&&(this.xA(),this.mA(e),this.scroll_setter(!1)),Gi.api.$getSize.call(this,t,i)},xA:function(){return this.N.yCount&&(this.wA||"auto"==this.type.height)&&(this.type.height=Math.floor((this.Me-this.ul)/this.N.yCount),this.wA=this.N.yCount),this.N.xCount&&(this.gA||"auto"==this.type.width)&&(this.type.width=Math.floor((this.xe-this.ul)/this.N.xCount),this.gA=this.N.xCount),this.wA||this.gA},$setSize:function(t,i){var e=this.N;if(Gi.api.$setSize.call(this,t,i)){if(e.autoheight&&this.mA()!=this.Me)return C(this.resize,this);(this.xA()||this.tl)&&this.render()}else(e.yCount&&e.yCount!=this.wA||e.xCount&&e.xCount!=this.gA)&&this.xA()&&this.render()}});F.protoUI(Mo,ge,$e,We,Le,Je,Ke,pe,Gr.view);B.pager={first:"<span class='webix_icon wxi-angle-double-left'></span>",last:"<span class='webix_icon wxi-angle-double-right'></span>",next:"<span class='webix_icon wxi-angle-right'></span>",prev:"<span class='webix_icon wxi-angle-left'></span>"};var So={defaults:{size:10,page:0,group:5,template:"{common.pages()}",maxWidth:1e5,height:30,borderless:!0},name:"pager",on_click:{webix_pager_item:function(t,i){this.select(i)}},$init:function(t){this.data=this.N,this.it=this.zt,this.zt.className+=" webix_pager"+(t.autowidth?" webix_pager_auto":""),!1!==t.master&&0!==t.master||this.$ready.push(this.yA)},yA:function(){this.refresh(),this.$master={refresh:function(){},select:function(){}}},select:function(t){if(this.$master&&"pager"==this.$master.name)return this.$master.select(t);switch(t){case"next":t=this.N.page+1;break;case"prev":t=this.N.page-1;break;case"first":t=0;break;case"last":t=this.N.limit-1}t<0&&(t=0),t>=this.data.limit&&(t=this.data.limit-1);var i=this.data.page;this.callEvent("onBeforePageChange",[t,i])&&(this.data.page=1*t,this.$master.wr=0,this.refresh()&&(this.N.animate&&this.d$(i,1*t,this.N.animate)||this.$master.refresh()),this.callEvent("onAfterPageChange",[t]))},_id:"webix_p_id",template_setter:Lt,type:{template:function(t,i){return t.template.call(this,t,i)},pages:function(t){var i="";if(-1==t.page)return"";t.$min=t.page-Math.round((t.group-1)/2),
t.$max=t.$min+1*t.group-1,t.$min<0&&(t.$max+=-1*t.$min,t.$min=0),t.$max>=t.limit&&(t.$min-=Math.min(t.$min,t.$max-t.limit+1),t.$max=t.limit-1);for(var e=t.$min||0;e<=t.$max;e++)i+=this.button({id:e,index:e+1,selected:e==t.page?"_selected":"",label:B.aria.page+" "+(e+1)});return i},page:function(t){return t.page+1},first:function(){return this.button({id:"first",index:B.pager.first,selected:"",label:B.aria.pages[0]})},last:function(){return this.button({id:"last",index:B.pager.last,selected:"",label:B.aria.pages[3]})},prev:function(){return this.button({id:"prev",index:B.pager.prev,selected:"",label:B.aria.pages[1]})},next:function(){return this.button({id:"next",index:B.pager.next,selected:"",label:B.aria.pages[2]})},button:Lt("<button type='button' webix_p_id='{obj.id}' class='webix_pager_item{obj.selected}' aria-label='{obj.label}'>{obj.index}</button>")},clone:function(t){t.$view||(t.view="pager",t=Qt(t)),((this.SA=t).$master=this).MA()},refresh:function(){var t=this.N;t.limit=Math.ceil(t.count/t.size)||1;var i=Math.min(t.limit-1,t.page);return i!=t.page?this.$master.setPage(i):0<=(t.page=i)&&i!=t.old_page||t.limit!=t.old_limit||t.old_count!=t.count?(this.render(),this.MA(),t.old_limit=t.limit,t.old_page=t.page,t.old_count=t.count,!0):void 0},apiOnly_setter:function(t){return this.$apiOnly=t},MA:function(){this.SA&&(this.SA.N.count=this.N.count,this.SA.N.page=this.N.page,this.SA.refresh())},d$:function(t,i,e){if(t==i)return!1;if(this.kA)return this.CA&&window.clearTimeout(this.CA),this.CA=C(this.d$,this,[t,i,e],100);var s=t<i?"left":"right";"top"!=e.direction&&"bottom"!=e.direction||(s=t<i?"top":"bottom"),e.flip&&(s="");var n=0,r=this.$master.it,h=!!this.$master.nt;h&&(n=(r=this.$master.nt).offsetTop,vt(this.$master.$view,"webix_animation"));var o,a=r.cloneNode(!0);a.style.width=r.style.width="100%",this.$master.refresh(),ht(a,r.nextSibling,r.parentNode),h&&(a.childNodes[1].scrollLeft=r.childNodes[1].scrollLeft);var u=!0!==e?e:{},c=F.extend({direction:s,callback:k(function(){c.callback=null,Qi.breakLine(o),this.kA=!1,this.$master.nt&&_t(this.$master.$view,"webix_animation")},this),top:n,keepViews:h},u);o=Qi.formLine(r,a,c),Qi([r,a],c),this.kA=!0}},ko=(F.protoUI(So,We,Xi,Gi.view,p),{name:"comments",defaults:{sendAction:"click",mode:"comments",highlight:!0,maxInputHeight:84},$init:function(t){this.$view.className+=" webix_comments",this.Ht=[],t.rows=[this.$configList(t)],t.moreButton||(t.moreButton=Lt(B.comments.moreComments)),t.readonly||(t.rows.push(this.$configForm(t)),this.$A()),St.mobile&&(t.keepButtonVisible=!0),this.DA(t.users),this.$ready.push(this.IA)},$exportView:function(){return this.AA},IA:function(){var e=this;this.AA=this.queryView("list"),this.cw=this.queryView("form"),this.TA=this.queryView("button"),this.FA=this.queryView({localId:"textarea"}),this.config.mentions&&this.VA(this.config.mentions),this.AA.data.provideApi(this,!0),this.serialize=function(){var t=e.AA.serialize(),i=e.getIndexById("$more");return 0<=i&&t.splice(i,1),t},this.N.readonly||(this.ic=w("onClick",function(t){var i=si(t);i==e.FA?e.focus():i===e.TA||i===e.zA||e.BA&&i===e.BA.getList()||t&&-1!==(t.target.className||"").toString().indexOf("webix_comments_menu")||e.HA(!1)}),this.attachEvent("onDestruct",function(){y(this.ic)}),this.AA.attachEvent("onAfterScroll",function(){e.zA.hide()}))},$onLoad:function(t,i){return this.RA(t,i)},RA:function(t,i){var e=this,s=this.AA||this.queryView({view:"list"});s.data.driver=i;var n=!1;if(t="function"==typeof t.serialize?t.serialize():(n=t.more,i.getRecords(t)),this.EA){if(this.EA=!1,t.length){var r=s.data.order,h=1;if("chat"==this.N.mode)s.data.order=T([r[0]].concat(new Array(t.length),r.slice(1)));else{var o=s.getIndexById("$more");s.data.order=T(r.slice(0,o).concat(new Array(t.length),r.slice(o))),h=o}s.parse({data:t,pos:h}),n&&ye(this.AA).ignore(function(){e.AA.updateItem("$more",{value:n})}),"chat"==this.N.mode&&s.showItem(s.getIdByIndex(t.length))}t.length&&n||ye(this.AA).ignore(function(){e.AA.remove("$more")})}else n&&!s.exists("$more")&&(n={id:"$more",value:n,$css:"webix_comments_more_item"}
,"chat"==this.N.mode?t.unshift(n):t.push(n)),s.parse(t),"chat"==this.N.mode&&s.waitData.then(function(){return s.showItem(s.getLastId())});return!0},$skin:function(){$n.api.$skin.call(this),this.Yb=te.inputHeight+6},getUsers:function(){return this.PA},getMenu:function(){return this.zA},setCurrentUser:function(t,i){this.config.currentUser=t,this.cw.clear(i),this.AA.refresh()},edit:function(t,i){if(!this.config.readonly&&this.callEvent("onBeforeEditStart",[t])){this.HA(!0);var e=this.AA.getItem(t);this.cw.setValues(e,!1,i),this.cw.focus();var s=this.cw.elements.text.getInputNode();s.scrollTop=s.scrollHeight,gt(s,e.text.length),this.callEvent("onAfterEditStart",[t])}},jA:function(t){var i=this.cw.getValues();i.text&&(i.id?this.updateItem(i.id,i):(this.config.currentUser&&(i.user_id=this.config.currentUser),i.date=new Date,this.add(i),this.AA.showItem(i.id)),this.cw.clear("user"),t&&(this.FA.getInputNode().value=""))},NA:function(t){this.cw.getValues().id==t&&this.cw.clear("user"),this.remove(t)},HA:function(t){if(t!==this.LA){var i=this.N;t?(this.TA.getParentView().show(),this.FA.define({height:i.maxInputHeight})):(Bi.hasFocus(this.TA)&&Bi.setFocus(this.AA),i.keepButtonVisible||this.TA.getParentView().hide(),this.FA.define({height:i.minInputHeight||this.Yb})),this.FA.resize(),this.LA=t}},focus:function(){var t=this;this.HA(!0),C(function(){t.FA.focus()})},OA:function(t){t||(t=this.FA.getValue()),t&&!this.TA.isEnabled()?this.TA.enable():!t&&this.TA.isEnabled()&&this.TA.disable()},$A:function(){var e=this;this.zA=Qt({view:"contextmenu",autowidth:!0,point:!1,data:[{id:"edit",icon:"wxi-pencil",value:B.comments.edit},{id:"remove",icon:"wxi-trash",value:B.comments.remove}],on:{onShow:function(){var t=e.zA.getContext();e.AA.addCss(t.id,"active_menu")},onHide:function(){var t=e.zA.getContext();e.AA.removeCss(t.id,"active_menu")},onItemClick:function(t){var i=e.zA.getContext();e.callEvent("onBeforeMenuAction",[t,i.id])&&("edit"==t?e.edit(i.id,"user"):"remove"==t&&(B.comments.confirmMessage?Ai({text:B.comments.confirmMessage,callback:function(t){t&&e.NA(i.id)}}):e.NA(i.id)))}}}),this.Ht.push(this.zA)},$configForm:function(t){var n=this,i=B.comments,e={view:"textarea",localId:"textarea",css:"webix_comments_textarea",height:t.minInputHeight||this.Yb,name:"text",placeholder:i.placeholder,keyPressTimeout:100,on:{onTimedKeyPress:function(){n.OA()},onChange:function(t){n.OA(t)},onKeyPress:function(t,i){if(13==t){var e=n.N.sendAction,s=i.shiftKey;("enter"==e&&!s||"enter"!==e&&s)&&(ft(i),n.jA(!0))}}}};return!1!==t.highlight&&F.extend(e,{view:"texthighlight",type:"textarea",highlight:function(t){return n.WA(Lt.escape(t),!0)}},!0),{view:"form",minHeight:50,paddingX:10,elements:[e,{hidden:!t.keepButtonVisible,cols:[{},{view:"button",disabled:!0,css:"webix_comments_send webix_primary",value:i.send,autowidth:!0,click:function(){n.jA()}}]}]}},WA:function(t,n){var r,h=this;if(-1===t.indexOf("@"))return t;"users"===this.N.highlight&&(r=this.BA&&this.BA.N.textValue||"value");var i=n?this.UA:this.qA;return t.replace(i,function(t,i,e,s){return h.YA(t,s||i,r,n)})},YA:function(t,i,e,s){return e&&!this.PA.find(function(t){return t[e]==i},!0)?t:'<span class="webix_comments_mention">'.concat(s?t:"@"+i,"</span>")},$configList:function(i){var o=this,h="webix_comments_",e={height:"auto",templateStatus:function(t){return"<span class = '"+h+"status "+t.status+"'></span>"},templateUser:function(t){var i=o.getUsers(),e=i&&i.exists(t.user_id)?i.getItem(t.user_id):{};return"<span class = '"+h+"name'>"+(e.value||"")+"</span>"},templateMenu:function(){return o.config.readonly?"":"<span class='webix_icon wxi-dots "+h+"menu'></span>"},templateDate:function(t){var i=en.dateToStr("%d %M, %H:%i");return t.date?"<span class='"+h+"date'>"+i(t.date)+"</span>":""},templateLinks:function(t){return t.text.replace(/(https?:\/\/[^\s]+)/g,function(t){var i="<a target='_blank' href='"+(t=Lt.escape(t))+"'>";return t.match(/.(jpg|jpeg|png|gif)$/)?i+="<img class='webix_comments_image' src='"+t+"'/>":i+=t,i+"</a>"})},templateMentioned:function(t){var i=t.text
;return o.N.mentions&&o.N.highlight&&(i=o.WA(t.text)),i},templateText:function(t){return"<div class = '"+h+"message'>"+t.text+"</div>"},templateAvatar:function(t,i){var e="<div class='"+h+"avatar'>",s=o.getUsers(),n=s&&s.exists(t.user_id)?s.getItem(t.user_id):{};if(n.status&&(e+=i.templateStatus(n)),e+="<div class='"+h+"avatar_image ",n.image)e+="'><img src = '"+n.image+"' class='"+h+"photo'>";else{var r=n.value?n.value[0].toUpperCase():"<span class='webix_icon wxi-user'></span>";e+=h+"avatar_text'>"+r}return e+="</div></div>"},template:function(t,i){var e;if("$more"==t.id)e="<div class='webix_comments_more'>"+o.N.moreButton(t)+"</div>";else{t=S(t);var s=i.templateAvatar(t,i),n=i.templateUser(t,i),r=i.templateDate(t,i),h=i.templateMenu(t,i);t.text=i.templateMentioned(t),t.text=i.templateLinks(t),e=s+n+h+r+i.templateText(t,i)}return e},classname:function(t,i,e){var s=Kr.api.type.classname(t,i,e);return(t.user_id&&t.user_id==o.N.currentUser||!o.PA.count())&&(s+=" webix_comments_current"),s}};e=F.extend(e,i.listItem||{},!0);var s={$init:function(t){t.date&&(t.date=B.parseFormatDate(t.date))}};i.scheme&&Object.keys(i.scheme).forEach(function(t){s[t]=i.scheme[t]});var t={view:"list",navigation:!1,type:e,scheme:s,onClick:{webix_comments_menu:function(t,i){o.zA.isVisible()?o.zA.hide():(o.zA.setContext({obj:o,id:i}),o.zA.show(t.target,e.menuPosition||{pos:"left",y:30,x:10}))},webix_comments_more:function(){if(o.config.url&&o.callEvent("onDataRequest",[])){o.EA=!0;var t=o.AA.getItem("$more").value,i="chat"==o.N.mode?t:o.AA.getIndexById("$more"),e=U.$parse(o.config.url),s={error:function(){o.EA=!1}};"string"==typeof e&&(e=e+(e.indexOf("?")<0?"?":"&")+"pos="+i+"&more="+t),o.load(e,s,{pos:i,more:t})}}}};return i.save&&(t.save=i.save),t},DA:function(t){var i=this;t&&t.getItem?this.PA=t:(this.PA=new $r,this.Ht.push(this.PA),t&&"string"==typeof t?this.PA.load(t):this.PA.parse(t||[])),this.PA.data.attachEvent("onStoreUpdated",function(){return i.AA.refresh()})},VA:function(t){var s=this,i=this.config.readonly;i||this.GA(t),this.config.highlight&&(i||(this.UA=new RegExp("@((&quot;(.*?)&quot;)|([^\\s]{1,}))","g")),this.qA=new RegExp('@(("(.*?)")|([^\\s]{1,}))',"g")),b.all([this.AA.waitData,this.PA.waitData]).then(function(){s.AA.refresh()}),this.AA.data.attachEvent("onStoreUpdated",function(t,i,e){!t||"add"!==e&&"update"!==e||s.XA(i)})},GA:function(t){var i="object"!=M(t)?{}:t;"object"!==M(i.body)?i.body={data:this.PA}:i.body.data=this.PA,F.extend(i,{view:"mentionsuggest"},!0);var e=this.FA.define("suggest",i);this.FA.setValueHere=function(t,i,e){return-1!=t.indexOf(" ")&&(t='"'.concat(t,'"')),Cr.api.setValueHere.apply(this,[t,i,e])},this.BA=si(e)},XA:function(h){var o=this;if(-1!=h.text.indexOf("@")){var a=this.BA&&this.BA.N.textValue||"value",u={};h.text.replace(this.qA,function(t,i,e,s){var n=s||i,r=o.PA.find(function(t){return t[a]==n},!0);return r&&!u[n]&&(o.callEvent("onUserMentioned",[r.id,h.id]),u[n]=!0),t})}}}),Co=(F.protoUI(ko,Ft,$n.view),{name:"timeline",defaults:{scroll:"auto"},$init:function(t){var s=this,i="x"===t.layout;if(i){var e=t.type;this.type.type=e&&e.type||"top",V(t.scroll)&&(t.scroll="x")}this.zt.className+=i?" webix_timeline_horizontal":" webix_timeline",this.$blockRender=!0,this.data.provideApi(this,!0),this.data.attachEvent("onStoreUpdated",function(t,i,e){return s.render(t,i,e)})},_id:"webix_tl_id",on_click:{},$setSize:function(t,i){this.$blockRender=!1,Ui.api.$setSize.call(this,t,i)&&this.refresh()},render:function(t,i,e){if(this.isVisible(this.N.id)&&!this.$blockRender){if("update"!=e)return this.callEvent("onBeforeRender",[this.data])&&(this.Oi=null,this.it.innerHTML=this.data.getRange().map(this.tt,this).join(""),this.callEvent("onAfterRender",[])),!0;var s=this.getItemNode(t);return ht(this.Oi[t]=this.Dc(i),s),rt(s),!0}},tt:function(t){this.callEvent("onItemRender",[t]);var i=this.getIndexById(t.id);return this.type.templateStart.call(this,t,this.type,i)+this.type.template.call(this,t,this.type,i)+this.type.templateEnd.call(this)},type:{type:"left",classname:function(t,i,e){var s="webix_timeline_item"
;return"alternate"!==i.type?s+="  webix_timeline_"+i.type:"x"==this.N.layout?s+=" webix_timeline_"+(e%2?"bottom":"top"):s+=" webix_timeline_"+(e%2?"right":"left"),i.css&&(s+=" "+i.css),t.$css&&("object"==M(t.$css)&&(t.$css=tt(t.$css)),s+=" "+t.$css),s},lineColor:function(t){return t.color},templateValue:Lt("#value#"),templateDetails:function(t){return t.details||""},templateDate:function(t){return en.dateToStr("%d %M, %Y")(t.date)},template:function(t,i,e){var s,n,r,h,o,a,u,c,f=te.dataPadding,l="string"==typeof i.lineColor?i.lineColor:i.lineColor(t,i),d="stroke-width:".concat(2,"px; stroke:").concat(l||te.timelineColor,";"),v=i.type,_=e+1==this.count(),p="position:relative;",b="",m="",g=i.templateDate(t,i),w=i.templateDetails(t,i),x='<div class="webix_timeline_value">'.concat(i.templateValue(t,i),"</div>\n\t\t\t\t").concat(w?'<div class="webix_timeline_details">'.concat(w,"</div>"):"");if("x"==this.N.layout){var y=this.$height-2*f,M=te.listItemHeight,S=f,k=y-M-14,C=M+14+f,$="top";"bottom"==v?(S=(M=y-M)+14+f,C=y-M+f+14,$="bottom"):"alternate"==v&&(S=(k=(M=Math.round(.5*y))-14)+f-20,C=M+14+f,e%2&&(S=C,$="bottom"));var D=t.$width||i.width;"auto"==D&&(D=this.KA([{text:x,css:"webix_timeline_event",height:k},{text:g,css:"webix_timeline_date"}]).width+f),b="top:".concat(S,"px;"),m="".concat($,":").concat(C,"px; height:auto; max-height:").concat(k,"px; width:inherit;"),s=D,n=M+14,p+="left:1px;",r=13,o="100%",c=a=h=M,u=7}else{var I=this.N.scroll?St.scrollSize:0,A=this.$width-2*f-I,T=Math.floor(.35*A),F=f,V=Math.floor(.65*A)-14,z=T+14+f,B=T-14;"right"==v?(F=(T=A-z+14+f)+14+f,z=f):"alternate"==v&&(z=(T=Math.floor(.5*A))+14+f,B=V=T-14,e%2&&(F=z,z=f));var H=t.$height||i.height;"auto"==H&&(H=this.KA([{text:x,css:"webix_timeline_event",width:V},{text:g,css:"webix_timeline_date",width:B}]).height+f),b="left:".concat(F,"px; width:").concat(B,"px;"),m="left:".concat(z,"px; width:").concat(V,"px; height:").concat(H-f,"px;"),s=T+14,n=H,p+="top:3px;",h=13,a="100%",u=o=r=T,c=7}return'<div style="'.concat(b,'" class="webix_timeline_date">').concat(g,'</div>\n\t\t\t\t\t<svg xmlns="http://www.w3.org/2000/svg" width="').concat(s,'px" height="').concat(n,'px" style="').concat(p,'">\n\t\t\t\t\t\t').concat(_?"":'<line x1="'.concat(r,'" y1="').concat(h,'" x2="').concat(o,'" y2="').concat(a,'" class="webix_timeline_node" style="').concat(d,'"/>'),'\n\t\t\t\t\t\t<circle cx="').concat(u,'" cy="').concat(c,'" r="').concat(6,'" class="webix_timeline_node webix_timeline_point" style="').concat(d,' fill:transparent;" />\n\t\t\t\t\t</svg>\n\t\t\t\t\t<div class="webix_timeline_event" style="').concat(m,'">\n\t\t\t\t\t\t').concat(x,"\n\t\t\t\t\t</div>")},widthSize:function(t,i){var e=t.$width||i.width;return e+(-1<e?"px":"")},heightSize:function(t,i){var e=t.$height||i.height;return e+(-1<e?"px":"")},templateStart:function(t,i,e){return"x"==this.N.layout?"<div ".concat("webix_tl_id",'="',t.id,'" class="').concat(i.classname.call(this,t,i,e),'" style="width:').concat(i.widthSize(t,i),';">'):"<div ".concat("webix_tl_id",'="',t.id,'" class="').concat(i.classname.call(this,t,i,e),'" style="height:').concat(i.heightSize(t,i),';">')},templateEnd:Lt("</div>")},KA:function(t){var i=st("DIV");i.style.cssText="visibility:hidden;position:absolute;top:0px;left:0px;overflow:hidden;",document.body.appendChild(i);for(var e=0,s=0,n=0;n<t.length;n++){i.className="webix_measure_size "+t[n].css,i.style.width=t[n].width?t[n].width+"px":"auto",i.style.height=t[n].height?t[n].height+"px":"auto",i.innerHTML=t[n].text;var r=i.getBoundingClientRect();e=Math.max(e,Math.ceil(r.width)),s=Math.max(s,Math.ceil(r.height))}return rt(i),{width:e,height:s}},templateValue_setter:function(t){this.type.templateValue=Lt(t)},templateDetails_setter:function(t){this.type.templateDetails=Lt(t)},templateDate_setter:function(t){this.type.templateDate=Lt(t)},$skin:function(){this.type.height=te.timelineItemHeight,this.type.width=3*te.timelineItemHeight}}),$o=(F.protoUI(Co,Ke,Xe,ke,We,p,Ji,Ui.view),{name:"menu",Wm:"webix_menu",$init:function(t){t.autowidth&&(this.JA=!0,delete t.autowidth),this.ZA(),
this.data.attachEvent("onStoreUpdated",k(function(){this.Au()},this)),this.attachEvent("onItemClick",function(t,i,e){var s=this.getItem(t);if(s){if(s.$template)return;var n=this.getTopMenu();if(!n.callEvent("onMenuItemClick",[t,i,e]))return void(i.showpopup=n.N.id);if(this!=n&&n.Cc(t,i,e),this.type.QA(s)||n.tT)(i.pointerType&&"mouse"!==i.pointerType||this===n&&"click"==n.N.openAction)&&this.Vu(t,e),i.showpopup=n.N.id;else n.Au(!0),n.iT&&n.hide()}}),this.attachEvent("onKeyPress",function(t){if(9===t)this.getTopMenu().Au();else if(13===t||32===t){var i,e=this.getSelectedId();e&&(i=this.getItemNode(e)),i&&dt(i,"MouseEvent","click")}}),this.data.attachEvent("onClearAll",function(){this.eT=[]}),this.data.eT=[],this.zt.setAttribute("role","menubar"),this.Ht=[]},ZA:function(){this.attachEvent("onMouseMove",function(t,i,e){this.sT()&&this.Vu(t,e)}),this.attachEvent("onMouseOut",function(t){this.sT()&&"click"==this.N.openAction||this.nT||t.relatedTarget&&this.$view.contains(t.relatedTarget)||this.Au()})},sizeToContent:function(){if("y"==this.N.layout){var i=[],e=!1;this.data.each(function(t){i.push(this.tt(t)),t.submenu&&(e=!0)},this),this.config.width=pt(i,this.$view.className).width+16+2+(e?15:0),this.resize()}},getTopMenu:function(){for(var t=this;t.Iu;)t=si(t.Iu);return t},Gm:function(t){this.N.autoheight&&(t=this.count());for(var i=this.count(),e=0,s=0;s<t;s++){var n=this.data.pull[this.data.order[s]];n&&"Separator"==n.$template?(e+=4,this.N.autoheight||t++):e+=this.type.height}return this.Fc(t&&t<i,"y"),e},on_mouse_move:{},type:{QA:function(t){return t.submenu||t.data||t.item},css:"menu",width:"auto",aria:function(t,i,e){return'role="menuitem"'+(e&&e.webix_selected?' aria-selected="true" tabindex="0"':'tabindex="-1"')+(i.QA(t)?'aria-haspopup="true"':"")+(t.disabled?' aria-disabled="true"  webix_disabled="true"':"")},templateStart:function(t,i,e){if("Separator"===t.$template||"Spacer"===t.$template)return'<div webix_l_id="#id#" role="separator" tabindex="-1" class="webix_context_'+t.$template.toLowerCase()+'">';var s=(t.href?" href='"+t.href+"' ":"")+(t.target?" target='"+t.target+"' ":"");return Kr.api.type.templateStart(t,i,e).replace(/^<div/,"<a "+s)+(i.QA(t)&&i.subsign?"<div class='webix_submenu_icon'></div>":"")},templateEnd:function(t){return"Separator"===t.$template||"Spacer"===t.$template?"</div>":"</a>"},templateSeparator:Lt("<div class='sep_line'></div>"),templateSpacer:Lt("<div></div>")},getMenu:function(t){if(this.data.pull[t])return this;for(var i in this.data.pull){var e=this.getItem(i);if(e.submenu){var s=this.rT(e).getMenu(t);if(s)return s}}},getSubMenu:function(t){var i=this.getMenu(t),e=i.getItem(t);return e.submenu?i.rT(e):null},getMenuItem:function(t){return this.getMenu(t).getItem(t)},rT:function(t){var i=si(t.submenu);return i||(t.submenu=this.hT(t),i=si(t.submenu)),i},sT:function(){var t=this.getTopMenu();if("click"!=t.N.openAction)return!0;var i=t.oT;return!(!i||!si(i).isVisible())},Vu:function(t,i){var e=this.getItem(t);if(e&&(this.nT=null,this.oT&&e.submenu!=this.oT&&this.Au(!0),this.type.QA(e)&&!this.config.hidden)){var s=this.rT(e);if(!this.isItemEnabled(t))return;s.show(i,{pos:this.N.subMenuPos}),s.Iu=this.N.id,this.oT=e.submenu}},disableItem:function(t){var i=this.getMenu(t);i&&i.Km(t,!0)},enableItem:function(t){var i=this.getMenu(t);i&&i.Km(t,!1)},isItemEnabled:function(t){var i=this.getMenu(t);if(i)return Kr.api.isItemEnabled.apply(i,arguments)},aT:function(t,i){var e=this.data;e.eT[t]!=i&&(e.eT[t]=i,e.filter(function(t){return!e.eT[t.id]}),this.resize())},hideItem:function(t){var i=this.getMenu(t);i&&i.aT(t,!0)},showItem:function(t){var i=this.getMenu(t);if(i)return i.aT(t,!1),Kr.api.showItem.call(i,t)},Au:function(t){if(this.oT){var i=si(this.oT);i.Au&&i.Au(t),!t&&i.Xn||(i.hide(),this.oT=null)}},hT:function(t){var i={view:"submenu",data:this.type.QA(t)},e=this.getTopMenu().N.submenuConfig;e&&F.extend(i,e,!0);var s=this.getMenuItem(t.id);s&&s.config&&F.extend(i,s.config,!0);var n=Qt(i);return this.Ht.push(n),n.Iu=this,n.N.id},Fu:function(t,i,e){var s=this.getItem(t)
;return"Separator"!=s.$template&&"Spacer"!=s.$template&&this.isItemEnabled(t)?t:(t=this.getNextId(t,e)||null)&&t!=i?this.Fu(t,i,e):i},$skin:function(){Kr.api.$skin.call(this),this.type.height=te.menuHeight},defaults:{scroll:"",layout:"x",mouseEventDelay:100,subMenuPos:"bottom"}}),Do={api:$o,view:F.protoUI($o,Kr.view)},Io={name:"submenu",$init:function(){this.Dt=l(this.uT),(this.Dt.Rt=this).attachEvent("onBeforeShow",function(){this.getTopMenu().JA&&this.sizeToContent&&!this.isVisible()&&this.sizeToContent()}),this.it.setAttribute("role","menu")},$skin:function(){Do.api.$skin.call(this),er.api.$skin.call(this),this.type.height=te.menuHeight},ZA:function(){this.attachEvent("onMouseMove",function(t,i,e){this.sT()&&this.Vu(t,e)}),this.attachEvent("onMouseOut",function(t){"click"!=this.getTopMenu().N.openAction&&(this.nT||this.Xn||!t.relatedTarget||this.$view.contains(t.relatedTarget)||this.hide())}),this.attachEvent("onMouseMoving",function(){this.Iu&&(si(this.Iu).nT=!0)})},uT:{$getSize:function(t,i){var e=1*this.Rt.N.height,s=1*this.Rt.N.width,n=Do.api.$getSize.call(this.Rt,t,i);return this.Rt.N.height=e,this.Rt.N.width=s,n},$setSize:function(t,i){this.Rt.N.scroll&&(this.Rt.Tn.style.height=i+"px")},destructor:function(){this.Rt=null}},body_setter:function(){},getChildViews:function(){return[]},defaults:{width:150,subMenuPos:"right",layout:"y",autoheight:!0},type:{height:te.menuHeight,subsign:!0}},Ao={api:Io,view:F.protoUI(Io,Do.view,er.view)},To={name:"sidemenu",defaults:{animate:!0,position:"left",width:200,borderless:!0},$init:function(){this.$view.className+=" webix_sidemenu"},$skin:function(){er.api.$skin.call(this),this.defaults.padding=0},position_setter:function(t){var i=this.N.position;return i&&_t(this.$view," webix_sidemenu_"+i),vt(this.$view," webix_sidemenu_"+t),t},$getSize:function(){var t=fe.api.$getSize.apply(this,arguments);return this.cT=t},$setSize:function(t,i){Gi.api.$setSize.call(this,t,i),t=this.xe-2*this.N.padding,i=this.Me-2*this.N.padding,this.qi.style.padding=this.N.padding+"px",this._n.style.display="none",this.Tn.style.height=i+"px",this.Dt.$setSize(t,i)},show:function(){if(!this.callEvent("onBeforeShow",arguments))return!1;this.N.hidden=!1,this.zt.style.zIndex=fi(this.N.zIndex),(this.N.modal||this.Vn)&&(this.pn(!0),this.Vn=null),this.zt.style.display="block",this.Ce(),this.N.position&&this.ei(),this.Rn=1,C(function(){this.Rn=0},this,[],St.fastClick?100:400),this.config.autofocus&&(this.En=Bi.getFocus(),Bi.setFocus(this)),-1==Jt.Ct.find(this)&&Jt.Ct.push(this),this.callEvent("onShow",[])},ei:function(t){var i,e,s,n,r,h=0,o=0,a={};this.$view.style.position="fixed",s=document.documentElement.offsetWidth,n=document.documentElement.offsetHeight,i=this.cT[0]||s,e=this.cT[2]||n,"top"==(r=this.N.position)?i=s:"right"==r?(e=n,h=s-i):"bottom"==r?(i=s,o=n-e):e=n,a={left:h,top:o,width:i,height:e,maxWidth:s,maxHeight:n},"function"==typeof this.N.state&&this.N.state.call(this,a),this.fT=a,this.$setSize(a.width,a.height),void 0===t&&this.N.animate?(_t(this.$view,"webix_animate"),this.d$[this.N.position].beforeShow.call(this,a),C(function(){vt(this.$view,"webix_animate",!0)},this,null,1),C(function(){this.d$[this.N.position].show.call(this,a)},this,null,10)):("right"===this.N.position&&(a.left=a.right?s-a.width-a.right:s-a.width),this.setPosition(a.left,a.top))},fT:{},hidden_setter:function(t){return t?this.hide():this.show(),!!t},d$:{left:{beforeShow:function(t){this.$view.style.left=-t.width+"px",this.$view.style.top=t.top+"px"},show:function(t){this.$view.style.left=t.left?t.left+"px":"0px"},hide:function(t){this.$view.style.left=-t.width+"px"}},right:{beforeShow:function(t){this.$view.style.left="auto",this.$view.style.right=-t.width+"px",this.$view.style.top=t.top+"px"},show:function(t){this.$view.style.right=t.right?t.right+"px":"0px"},hide:function(t){this.$view.style.right=-t.width+"px"}},top:{beforeShow:function(t){this.setPosition(t.left,t.top),this.$view.style.height="0px",this.Tn.style.height="0px"},show:function(t){this.$view.style.height=t.height+"px",this.Tn.style.height=t.height+"px"},
hide:function(){this.$view.style.height="0px",this.Tn.style.height="0px"}},bottom:{beforeShow:function(t){this.$view.style.left=t.left+"px",this.$view.style.top="auto";var i=t.bottom!=undefined?t.bottom:t.maxHeight-t.top-t.height;this.$view.style.bottom=i+"px",this.$view.style.height="0px"},show:function(t){this.$view.style.height=t.height+"px"},hide:function(){this.$view.style.height="0px"}}},Nn:function(){var t=document.documentElement.offsetWidth,i=document.documentElement.offsetHeight;if(this.N.animate&&t==this.fT.maxWidth&&i==this.fT.maxHeight){this.d$[this.N.position].hide.call(this,this.fT);var e=Gt(this.$view,St.transitionEnd,k(function(){this.Ln(),Xt(e)},this))}else this.Ln()}},Fo=(F.protoUI(To,er.view),{name:"sidebar",defaults:{type:"sideBar",activeTitle:!0,select:!0,scroll:!1,collapsed:!1,collapsedWidth:44,position:"left",width:250,mouseEventDelay:10},$skin:function(){this.defaults.titleHeight=te.sidebarTitleHeight},$init:function(t){this.lT=V(t.width)?this.defaults.width:t.width,this.N.width=t.width=t.collapsed?t.collapsedWidth||this.defaults.collapsedWidth:this.lT,this.$view.className+=" webix_sidebar",this.$ready.push(this.dT),this.$ready.push(this.vT),this.data.Lh=function(t){t.data?t.menu=S(t.data):t.item&&(t.menu=S(t.item.length?t.item:[t.item]))},t.multiselect=!1},on_context:{},on_mouse_move:{},dT:function(){this.attachEvent("onBeforeOpen",function(t){if(!this.config.multipleOpen)for(var i=this.getOpenItems(),e=0;e<i.length;e++)this.getParentId(t)==this.getParentId(i[e])&&this.close(i[e]);return!this.config.collapsed}),this.attachEvent("onItemClick",function(t,i,e){var s=this.getPopup();s&&!s.config.hidden&&(i.showpopup=s.config.id),i.pointerType&&"mouse"!==i.pointerType&&this._T(t,e)}),this.attachEvent("onBeforeSelect",function(t){return!this.getItem(t).$count&&(this.clearCss("webix_sidebar_selected"),!0)}),this.attachEvent("onAfterSelect",function(t){this.pT(this,t,!te.sidebarMarkAll),this.getPopup().bT(t)}),this.attachEvent("onAfterUnSelect",function(){this.clearCss("webix_sidebar_selected")}),this.attachEvent("onMouseMove",function(t,i,e){this._T(t,e)}),this.attachEvent("onMouseOut",function(){this.config.collapsed&&(this.getPopup().masterId=null)})},_T:function(t,i){if(this.config.collapsed){var e=this.getPopup();e&&(this.mT(t,e),this.gT(t,e),e.masterId=t,e.show(i,{x:"left"==this.config.position?this.config.collapsedWidth:-e.config.width,y:-1}))}},mT:function(t,i){var e=i.getBody().getChildViews()[0];e&&i.masterId!=t&&(e.parse(this.getItem(t)),this.getSelectedId()==t?vt(e.$view,"webix_selected",!0):_t(e.$view,"webix_selected"))},gT:function(t,i){var e=i.getBody().getChildViews()[1];if(e&&i.masterId!=t){this.exists(i.masterId)&&this.getItem(i.masterId).menu&&this.updateItem(i.masterId,{menu:e.data.serialize()}),e.clearCss("webix_sidebar_selected"),e.unselectAll();var s=S(this.getItem(t).menu||[]);if(s.length){e.show(),e.data.importData(s);var n=this.getSelectedId();e.exists(n)?e.select(n):n&&this.pT(e,n)}else e.hide(),e.data.clearAll()}},vT:function(){var e,n=this,s=n.config;if(s.popup&&(e=si(s.popup)),!e){var t="left"==s.position?"webix_sidebar_popup_left":"webix_sidebar_popup_right",i="left"==s.position?"right":"left",r=function(t){var i="wxi-angle-"+("left"==s.position?"right":"left");return(t.submenu||t.data||t.item?'<div class="webix_icon '+i+'"></div>':"")+t.value},h=s.css?" "+s.css:"",o={view:"popup",css:"webix_sidebar_popup "+t+h,autofit:!1,width:this.lT-this.config.collapsedWidth,borderless:!0,padding:0,body:{rows:[{view:"template",borderless:!0,css:"webix_sidebar_popup_title",template:"#value#",height:this.config.titleHeight+2,onClick:{webix_template:function(){var t=this.getValues().id;n.getItem(t).$count||n.select(t)}}},{view:"menu",submenu:"data",layout:"y",subMenuPos:i,select:!0,borderless:!0,autoheight:!0,css:"webix_sidebar_popup_list "+t+h,template:r,type:{subsign:!1},submenuConfig:{padding:0,subMenuPos:i,template:r,select:!0,type:{subsign:!1},css:"webix_sidebar_popup_list "+t+h,on:{onShow:function(){this.clearCss("webix_sidebar_selected"),this.unselectAll();var t=n.getSelectedId()
;t&&this.exists(t)?this.select(t):t&&n.pT(this,t)},onBeforeSelect:function(t){if(this.getSubMenu(t))return!1},onAfterSelect:function(t){for(var i=n.getPopup().queryView({view:"menu"}),e=n.getParentId(t);e;){var s=i.getMenu(e);s&&(s.unselectAll(),n.pT(s,t)),e=n.getParentId(e)}n.pT(this,t)}}},on:{onBeforeSelect:function(t){if(this.getSubMenu(t))return!1},onMenuItemClick:function(t){this.getSubMenu(t)||n.select(t)}}}]}};F.extend(o,s.popup||{},!0),(e=Qt(o)).bT=function(t){if(n.config.collapsed&&1==n.getItem(t).$level){var i=e.getBody().getChildViews()[0];i&&vt(i.$view,"webix_selected",!0)}},e.queryView({view:"menu"}).tT=!0}e.attachEvent("onBeforeShow",function(){return s.collapsed}),this.Ht=[e],s.popupId=e.config.id,Yt(document.body,"pointermove",function(t){var i=t.target;e.config.hidden||e.$view.contains(i)||this.$view.firstChild.contains(i)||e.queryView({view:"menu"}).oT||e.hide()},{bind:this})},pT:function(i,e,s){var n="webix_sidebar_selected";i.data.each(function(t){!this.wT(e,t.id)||s&&"0"!=this.getParentId(t.id)?i.hasCss(t.id,n)&&i.removeCss(t.id,n):i.addCss(t.id,n)},this)},wT:function(t,i){var e=this.getParentId(t);return i==e||!!e&&this.wT(e,i)},getPopup:function(){return si(this.config.popupId)},position_setter:function(t){var i=t,e="left"==t?"right":"left";_t(this.$view,"webix_sidebar_"+e),vt(this.$view,"webix_sidebar_"+i,!0);var s=this.getPopup();if(s){var n=s.$view;_t(n,"webix_sidebar_popup_"+e),vt(n,"webix_sidebar_popup_"+i,!0)}return t},select:function(t){t&&(I(t)&&(t=t.pop()),xo.api.select.call(this,t))},selectAll:function(){},collapse:function(){this.define("collapsed",!0)},expand:function(){this.define("collapsed",!1)},toggle:function(){var t=!this.config.collapsed;this.define("collapsed",t)},collapsed_setter:function(t){var i;return t?(i=this.config.collapsedWidth,this.closeAll(),this.type.collapsed=!0,_t(this.$view,"webix_sidebar_expanded")):(i=this.lT,this.type.collapsed=!1,vt(this.$view,"webix_sidebar_expanded",!0)),V(i)||i===this.config.width||(this.define("width",i),this.resize()),t},getState:function(){var t={collapsed:this.config.collapsed};return F.extend(t,bs.getState.call(this)),t},setState:function(t){bs.setState.call(this,t),this.define("collapsed",t.collapsed)}});Kt(xo.view,{name:"sideBar",height:"auto",template:function(t,i){return i.collapsed?i.icon(t,i):i.arrow(t,i)+i.icon(t,i)+"<span>"+t.value+"</span>"},arrow:function(t){for(var i="",e=1;e<=t.$level;e++){if(e==t.$level&&t.$count)i+="<span class='"+("webix_sidebar_dir_icon webix_icon "+("wxi-angle-"+(t.open?"down":"left")))+"'></span>"}return i},icon:function(t){var i="";return 2<t.$level&&(i='style="padding-left:'+40*(t.$level-2)+'px"'),t.icon?"<span class='webix_icon webix_sidebar_icon "+t.icon+"' "+i+"></span>":"<span "+i+"></span>"}});F.protoUI(Fo,xo.view),F.protoUI({name:"context"},le,er.view);var Vo={name:"contextmenu",iT:!0,$init:function(t){t.submenuConfig&&F.extend(t,t.submenuConfig)}},zo=(F.protoUI(Vo,le,Ao.view),{name:"treetable",$init:function(){for(var t in F.extend(this.data,Ms,!0),F.extend(this.type,ks),F.extend(this,ws,!0),ms)this.on_click[t]||(this.on_click[t]=this.xT(ms[t]));this.type.treetable=Lt("{common.space()}{common.icon()} {common.folder()}"),this.type.treecheckbox=function(t){return t.indeterminate&&!t.nocheckbox?"<div class='webix_tree_checkbox webix_indeterminate'></div>":ks.checkbox.apply(this,arguments)},this.data.provideApi(this,!0),this.zt.setAttribute("role","treegrid")},ea:!1,xT:function(e){return function(t,i){return i=i.row,e.call(this,t,i)}},ta:function(t){for(var i=this.N.prerender?t.source:[t.start],e=0;e<i.length;e++)this.close(i[e])},getState:function(){var t=Ce.getState.call(this);return F.extend(t,bs.getState.call(this)),t},setState:function(t){bs.setState.call(this,t)&&Ce.setState.call(this,t)},clipboard_setter:function(t){return F.extend(this.Zn,Ss),ps.clipboard_setter.call(this,t)},fl:function(t,i){for(var e=t.start,s=0;s<e;s++){var n=this.data.order[s];n&&1!=this.getItem(n).$level&&t.start--}return Rh.api.fl.call(this,t,i)}}),Bo=(F.protoUI(zo,bs,ys,gs,Rh.view),{name:"filter",$init:function(t){
t.mode=t.mode||"number",this.N.conditions=t.conditions,this.N.mode=this.mode_setter(t.mode),delete t.mode,t.rows=this.yT(t),this.$ready.push(this.IA)},$onLoad:function(t,i){return this.RA(t,i)},RA:function(t,i){var e=this,s=this.AA||this.queryView("list");s.data.driver=i;var n=[],r={};if("function"==typeof t.serialize?(t.data&&"DataStore"==t.data.name&&(t=t.data),t.each(function(t){return e.MT(t,n,r)})):i.getRecords(t).forEach(function(t){return e.MT(t,n,r)}),s.clearAll(),s.parse(n),this.AA){var h=this.N.value.includes;this.ST(),this.kT(h)}return!0},MT:function(t,i,e){var s=t[this.N.field];V(s)||e[s]||(e[s]=!0,i.push(S(t)))},IA:function(){var t=this;this.CT=!0,this.AA=this.queryView("list"),this.fv=this.queryView("toggle"),this.jo=this.queryView("richselect"),this.FA=this.queryView({batch:this.$T}),this.AA.data.provideApi(this,!0),this.AA.data.attachEvent("onSyncApply",function(){return t.RA(t.AA,t.AA.data.driver)}),this.setValue(this.N.value,"auto"),delete this.CT},mode_setter:function(t){if(this.DT[t],this.IT=this.AT(this.N.conditions,t),this.FA){var i=this.jo.getList();i.clearAll(),i.parse(this.IT),this.jo.config.value="",this.jo.setValue(this.IT[0].id,"auto")}else this.$T=this.IT[0].batch;return t},yT:function(t){var s=this,i=this.TT(t.inputs);return[{visibleBatch:this.$T,cols:[{view:"richselect",value:this.IT[0].id,width:160,options:this.IT,on:{onChange:function(t,i,e){s.FT(t),s.applyFilter(e)}}}].concat($(i))},{view:"toggle",batch:"includes",onLabel:B.combo.unselectAll,offLabel:B.combo.selectAll,value:!0,on:{onItemClick:function(){s.VT(s.fv.getValue()),s.callEvent("onChange",["user"])}}},{view:"list",batch:"includes",css:"webix_multilist",autoheight:!0,borderless:!0,yCount:5,type:"checklist",template:t.template||"#".concat(t.field,"#"),on:{onItemClick:function(t){var i=s.AA.getItem(t);s.AA.updateItem(t,{$checked:!i.$checked}),s.N.value.includes=s.zT(),s.BT(s.fv,s.Tw()),s.callEvent("onChange",["user"])}}}]},TT:function(t){var i=this;t=t||Object.keys(this.vi);for(var e=0;e<t.length;e++)if(this.vi[t[e]]){if(t[e]=S(this.vi[t[e]]),t[e].on){var s=t[e].on;for(var n in s)s[n]=function(){return i.applyFilter("user")}}}else t[e]&&t[e].batch;return t},vi:{text:{view:"text",batch:"text",on:{onTimedKeyPress:!0}},datepicker:{view:"datepicker",batch:"datepicker",on:{onChange:!0}},daterangepicker:{view:"daterangepicker",batch:"daterangepicker",on:{onChange:!0}},none:{view:"spacer",batch:"none"}},HT:{number:vn.number,text:vn.text,date:{greater:{batch:"datepicker",handler:vn.date.greater},less:{batch:"datepicker",handler:vn.date.less},greaterOrEqual:{batch:"datepicker",handler:vn.date.greaterOrEqual},lessOrEqual:{batch:"datepicker",handler:vn.date.lessOrEqual},equal:{batch:"datepicker",handler:vn.date.equal},notEqual:{batch:"datepicker",handler:vn.date.notEqual},between:{batch:"daterangepicker",handler:vn.date.between},notBetween:{batch:"daterangepicker",handler:vn.date.notBetween}}},DT:{number:["greater","less","greaterOrEqual","lessOrEqual","equal","notEqual","contains","notContains"],text:["contains","notContains","equal","notEqual","beginsWith","notBeginsWith","endsWith","notEndsWith"],date:["greater","less","greaterOrEqual","lessOrEqual","equal","notEqual","between","notBetween"]},AT:function(t,i){t=t||this.DT[i];for(var e=[],s=0;s<t.length;s++){var n=this.RT(t[s],i);e.push(n)}return e},RT:function(t,i){if(t&&"function"==typeof t.handler)return t;if(this.HT[i][t]){var e={id:t,value:B.filter[t]},s="function"==typeof this.HT[i][t]?{batch:"text",handler:this.HT[i][t]}:this.HT[i][t];return F.extend(e,s,!0)}return null},ET:function(t){for(var i=0;i<this.IT.length;i++)if(this.IT[i].id==t)return this.IT[i]},zT:function(){var i=this,e=[];return this.AA.data.each(function(t){t.$checked&&e.push(t[i.N.field])}),e.length==this.AA.count()?null:e},getValue:function(){return{condition:{filter:this.FA.getValue?this.FA.getValue()||"":null,type:this.jo.getValue()},includes:this.zT()}},Tw:function(){for(var t=this.AA.data.order,i=0;i<t.length;i++)if(!this.getItem(t[i]).$checked)return!1;return!0},$compareValue:function(t,i){if(
!t||t.condition.type!==i.condition.type||t.condition.filter!==i.condition.filter)return!1;if(t.includes&&i.includes){if(t.includes.length!==i.includes.length)return!1;for(var e={},s=0;s<t.includes.length;s++)e[t.includes[s]]=!0;for(var n=0;n<i.includes.length;n++)if(!e[i.includes[n]])return!1;return!0}return t.includes===i.includes},setValue:function(t,i){if(t=this.$prepareValue(t),!this.$compareValue(this.N.value,t)){var e=t.condition,s=t.includes;this.FT(e.type),this.BT(this.FA,e.filter),this.BT(this.jo,e.type),this.ST(),this.kT(s),this.BT(this.fv,this.Tw()),this.N.value=t,this.CT||this.callEvent("onChange",[i])}},kT:function(e){var s=this.N.field,n="date"==this.N.mode;e&&n&&(e=e.map(function(t){return t&&t.valueOf()})),this.AA.data.each(function(t){var i=t[s];t.$checked=!e||-1!=e.indexOf(n?i&&i.valueOf():i)}),this.AA.refresh()},BT:function(t,i){t.setValue&&(t.blockEvent(),t.setValue(i),t.unblockEvent())},$prepareValue:function(t){return(t=t||{}).condition=t.condition||{filter:"",type:this.IT[0].id},t.includes=t.includes||null,t},ST:function(){var i=this.FA.getValue?this.FA.getValue()||"":null;if(""===i)this.AA.filter();else{var e=this.N.field,s=this.ET(this.jo.getValue()).handler;this.AA.filter(function(t){return s(t[e],i)})}this.showBatch("includes",!!this.AA.count())},FT:function(t){var i=this.ET(t).batch;i!=this.$T&&(this.$T=i,this.FA=this.queryView({batch:i}),this.FA.setValue&&this.FA.setValue("","auto"),this.FA.getParentView().showBatch(i))},applyFilter:function(t){this.ST(),this.BT(this.fv,!0),this.VT(!0),this.callEvent("onChange",[t])},VT:function(i){this.AA.data.each(function(t){t.$checked=i}),this.AA.refresh(),this.N.value=this.getValue()},getFilterFunction:function(){var e=this.N.field,s="date"==this.N.mode,t=this.getValue(),n=t.includes,r=t.condition,h=this.ET(r.type).handler;return n&&s&&(n=n.map(function(t){return t&&t.valueOf()})),function(t){var i=t[e];return n?-1!=n.indexOf(s?i&&i.valueOf():i):""===r.filter||h(i,r.filter)}}}),Ho=(F.protoUI(Bo,Ft,$n.view),F.proto({name:"DataRecord",isVisible:function(){return!0},$init:function(t){this.data=t||{};var i=t&&t.id?t.id:z();this.N={id:i},Qt.views[i]=this},getValues:function(){return this.data},setValues:function(t,i,e){this.data=i?F.extend(this.data,t,!0):t,this.callEvent("onChange",[t,e])},refresh:function(){this.callEvent("onBindRequest")}},p,Li,Ft,Hi)),Ro=F.proto({name:"DataValue",isVisible:function(){return!0},$init:function(t){t&&!V(t.value)||(this.data=t||"");var i=t&&t.id?t.id:z();this.N={id:i},Qt.views[i]=this},setValue:function(t,i){this.data=t,this.callEvent("onChange",[t,i])},getValue:function(){return this.data},refresh:function(){this.callEvent("onBindRequest")}},p,Li),Eo=F.proto({name:"TreeCollection",$init:function(){F.extend(this.data,Ms,!0),this.data.provideApi(this,!0),F.extend(this,ws,!0)}},gs,$r);F.Date=en,F.Number=sn,F.promise=b,F.DataCollection=$r,F.DataRecord=Ho,F.DataValue=Ro,F.TreeCollection=Eo,F.AtomDataLoader=Ft,F.AtomRender=Ot,F.AutoScroll=Wt,F.AutoTooltip=Ji,F.BaseBind=Li,F.BindSource=Ni,F.Canvas=Zi,F.CodeParser=Vt,F.CollectionBind=Ei,F.ContextHelper=le,F.CopyPaste=_e,F.CustomPrint=pe,F.CustomScroll=be,F.DataMarks=me,F.DataMove=ge,F.DataLoader=ke,F.DataState=Ce,F.DataStore=Se,F.Destruction=Ri,F.DragControl=re,F.DragItem=$e,F.DragOrder=De,F.EditAbility=ze,F.EventSystem=p,F.FlexLayout=Be,F.Group=Ee,F.GroupMethods=He,F.GroupStore=Re,F.HTMLOptions=Pe,F.HtmlMap=je,F.IdSpace=Ne,F.KeysNavigation=Le,F.MapCollection=Oe,F.Modality=ae,F.MouseEvents=We,F.Movable=he,F.NavigationButtons=Ue,F.OverlayBox=qe,F.PagingAbility=Ye,F.ProgressBar=Ge,F.RecordBind=ji,F.RenderStack=Xe,F.ResizeArea=ue,F.SingleRender=Xi,F.Scrollable=Ke,F.SelectionModel=Je,F.Settings=Hi,F.Sparklines=_s,F.TablePaste=ps,F.TooltipControl=ni,F.Touch=ne,F.TreeAPI=bs,F.TreeClick=ms,F.TreeDataLoader=gs,F.TreeDataMove=ws,F.TreeRenderStack=xs,F.TreeStateCheckbox=ys,F.TreeStore=Ms,F.TreeTablePaste=Ss,F.TreeType=ks,F.UIManager=Bi,F.Undo=Ie,F.UploadDriver=Cs,F.ValidateCollection=$s,F.ValidateData=we,F.ValueBind=Pi,F.Values=Ds,F.VirtualRenderStack=Is,F.VRenderStack=As,F.html=yt,F.skin=se,
F.debug=function Uo(t){if(t)if("object"!==M(t))h={events:!0};else for(var i in t)h[i]=t[i];else h={}},F.i18n=B,F.ready=li,F.env=St,F.color=Ze,F.csv=ve,F.clipbuffer=de,F.storage=hn,F.template=Lt,F.type=Kt,F.editors=Ve,F.animate=Qi,F.print=function(t,i){var e=si(t);if(e&&e.$printView&&(e=e.$printView()),e){var s;if(e.callEvent&&e.callEvent("onBeforePrint",[i]),function n(t){vt(document.body,"webix_print"),t.docHeader&&dn("Header",t),t.docFooter&&dn("Footer",t),it("@media print { @page{ size:"+t.paper+" "+t.mode+";margin-top:"+t.margin.top+"px;margin-bottom:"+t.margin.bottom+"px;margin-right:"+t.margin.right+"px;margin-left:"+t.margin.left+"px;}}","print")}(i=function r(t){(t=t||{}).paper=on[(t.paper||"").toLowerCase()]||"A4",t.mode=un[t.mode]?t.mode:"portrait",t.fit=an[t.fit]?t.fit:"page",t.scroll=t.scroll||!1,t.size=cn[t.paper],t.margin=t.margin||0===t.margin?t.margin:{};var i=isNaN(1*t.margin)?St.printMargin:t.margin;return t.margin={top:t.margin.top||0===t.margin.top?t.margin.top:i,bottom:t.margin.bottom||0===t.margin.bottom?t.margin.bottom:i,right:t.margin.right||0===t.margin.right?t.margin.right:i,left:t.margin.left||0===t.margin.left?t.margin.left:i},t}(i)),e.$customPrint){if(s=e.$customPrint(i)){if(s.then)return s.then(function(){return fn(i)});ln(e,i)}}else ln(e,i);fn(i)}},F.rules=mi,F.filters=vn,F.patterns=_n,F.fullscreen=zi,F.version="9.3.2",F.name="core",F.level_in=function qo(){0},F.level_out=function Yo(){0},F.clone=l,F.copy=S,F.single=function Go(t){var i=null;return function(){return i||(i=new t({})),i.PT&&i.PT.apply(i,arguments),i}},F.bind=k,F.exec=_,F.wrap=function Xo(i,e){return i?function(){var t=i.apply(this,arguments);return e.apply(this,arguments),t}:e},F.isUndefined=V,F.delay=C,F.once=o,F.uid=z,F.toNode=D,F.toFunctor=c,F.isArray=I,F.isDate=A,F.jT=T,F.NT=x,F.LT=qt,F.OT=Yt,F.event=Gt,F.eventRemove=Xt,F.callEvent=g,F.attachEvent=w,F.detachEvent=y,F.blockEvent=function(){return m.blockEvent()},F.unblockEvent=function(){return m.unblockEvent()},F.mapEvent=function(t){return m.mapEvent(t)},F.hasEvent=function(t){return m.hasEvent(t)},F.stringify=v,F.toPNG=function(s,n){var r=b.defer();return Dt(St.cdn+"/extras/html2canvas-1.0.min.js").then(function(){"string"==typeof n&&(n={filename:n}),(n=n||{}).export_mode="png";var t=si(s);if(t&&t.$exportView&&(t=t.$exportView(n)),!t)return r.reject(Ts);var i=t?t.$view:D(s),e=Hs(n.filename,"png");return window.html2canvas(i,{background:"#fff",logging:!1,useCORS:!0}).then(function(t){var i=function(t){!1!==n.download&&bt(t,e),r.resolve(t)};t.msToBlob?i(t.msToBlob()):t.toBlob(i,"image/png")}),r})},F.toCSV=function(t,i){i=i||{};var e=si(t);if(e&&e.$exportView&&(e=e.$exportView(i)),!e)return b.reject(Ts);i.export_mode="csv",F.extend(i,{filterHTML:!0});var s=Bs(e,i),n=function o(t){return ve.stringify(t)}(Rs(e,i,s)),r=Hs(i.filename,"csv"),h=new Blob(["\ufeff"+n],{type:"text/csv"});return!1!==i.download&&bt(h,r),b.resolve(h)},F.toPDF=Ps,F.toExcel=Gs,F.alert=function Ko(){var t=Ii.apply(this,arguments);return t.type=t.type||"alert",ki(t)},F.confirm=Ai,F.modalbox=Ti,F.prompt=function Jo(){var t=Ii.apply(this,arguments);return t.type=t.type||"prompt",t.input=t.input||{},Di(t)},F.message=Fi,F.editStop=function Zo(){g("onEditEnd",[])},F.ajax=E,F.DataDriver=At,F.dp=ye,F.DataProcessor=Me,F.remote=gn,F.require=Dt,F.proxy=U,F.send=function Qo(t,i,e,s){var n=st("FORM",{target:s||"_self",action:t,method:e||"POST"},"");for(var r in i){var h=st("INPUT",{type:"hidden",name:r,value:i[r]},"");n.appendChild(h)}n.style.display="none",document.body.appendChild(n),n.submit(),document.body.removeChild(n)},F.ui=Qt,F.$$=si,Object.defineProperty(F,"WT",{value:!0})});
